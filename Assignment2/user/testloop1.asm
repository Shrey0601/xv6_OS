  ...
  2e:	4481                	li	s1,0
{
  ...
  40:	85ca8a93          	addi	s5,s5,-1956 # 898 <malloc+0xe8>
  ...
  64:	664080e7          	jalr	1636(ra) # 6c4 <fprintf>
       sleep(1);
  68:	4505                	li	a0,1
  ...
  74:	000a0463          	beqz	s4,7c <main+0x7c>
{
  ...
  8e:	81650513          	addi	a0,a0,-2026 # 8a0 <malloc+0xf0>
  92:	00000097          	auipc	ra,0x0
  96:	660080e7          	jalr	1632(ra) # 6f2 <printf>
    printf("Start time: %d, End time: %d, Total time: %d\n", start_time, end_time, end_time-start_time);
  9a:	413906bb          	subw	a3,s2,s3
  9e:	864a                	mv	a2,s2
  a0:	85ce                	mv	a1,s3
  a2:	00001517          	auipc	a0,0x1
  a6:	80e50513          	addi	a0,a0,-2034 # 8b0 <malloc+0x100>
  aa:	00000097          	auipc	ra,0x0
  ae:	648080e7          	jalr	1608(ra) # 6f2 <printf>
    exit(0);
  b2:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 430:	f26080e7          	jalr	-218(ra) # 352 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	48a50513          	addi	a0,a0,1162 # 8e8 <digits>
 466:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52e:	3beb8b93          	addi	s7,s7,958 # 8e8 <digits>
 ...
 66e:	27690913          	addi	s2,s2,630 # 8e0 <malloc+0x130>
        while(*s != 0){
...
free(void *ap)
{
 ...
 736:	1ce7b783          	ld	a5,462(a5) # 900 <freep>
 ...
 764:	00e6ea63          	bltu	a3,a4,778 <free+0x50>
{
 ...
 7a6:	14f73f23          	sd	a5,350(a4) # 900 <freep>
}
 7aa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d8:	12c53503          	ld	a0,300(a0) # 900 <freep>
 ...
 800:	10490913          	addi	s2,s2,260 # 900 <freep>
  if(p == (char*)-1)
 804:	5afd                	li	s5,-1
 806:	a88d                	j	878 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 808:	00000797          	auipc	a5,0x0
 80c:	10078793          	addi	a5,a5,256 # 908 <base>
 810:	00000717          	auipc	a4,0x0
 814:	0ef73823          	sd	a5,240(a4) # 900 <freep>
 818:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 888:	b36080e7          	jalr	-1226(ra) # 3ba <sbrk>
  if(p == (char*)-1)
