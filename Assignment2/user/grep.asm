...
000000000000011a <grep>:
{
 ...
 144:	9a8b0b13          	addi	s6,s6,-1624 # ae8 <buf>
    p = buf;
 148:	8d5a                	mv	s10,s6
        *q = '\n';
 14a:	4aa9                	li	s5,10
...
00000000000001ee <main>:
{
 ...
 262:	82a58593          	addi	a1,a1,-2006 # a88 <malloc+0xe6>
 266:	4509                	li	a0,2
 268:	00000097          	auipc	ra,0x0
 26c:	64e080e7          	jalr	1614(ra) # 8b6 <fprintf>
    exit(1);
 270:	4505                	li	a0,1
 ...
 298:	81450513          	addi	a0,a0,-2028 # aa8 <malloc+0x106>
 29c:	00000097          	auipc	ra,0x0
 2a0:	648080e7          	jalr	1608(ra) # 8e4 <printf>
      exit(1);
 2a4:	4505                	li	a0,1
...
putc(int fd, char c)
{
 ...
 622:	f26080e7          	jalr	-218(ra) # 544 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 640:	0805c863          	bltz	a1,6d0 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 654:	47850513          	addi	a0,a0,1144 # ac8 <digits>
 658:	883a                	mv	a6,a4
 ...
 678:	fec7f0e3          	bgeu	a5,a2,658 <printint+0x2a>
  if(neg)
 67c:	00088b63          	beqz	a7,692 <printint+0x64>
    buf[i++] = '-';
 680:	fd040793          	addi	a5,s0,-48
 ...
 68e:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 692:	02e05863          	blez	a4,6c2 <printint+0x94>
 ...
 6b8:	f58080e7          	jalr	-168(ra) # 60c <putc>
  while(--i >= 0)
 6bc:	197d                	addi	s2,s2,-1
 6be:	ff3918e3          	bne	s2,s3,6ae <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 720:	3acb8b93          	addi	s7,s7,940 # ac8 <digits>
 724:	a839                	j	742 <vprintf+0x6a>
        putc(fd, c);
 726:	85ca                	mv	a1,s2
 728:	8556                	mv	a0,s5
 72a:	00000097          	auipc	ra,0x0
 72e:	ee2080e7          	jalr	-286(ra) # 60c <putc>
 ...
 766:	0ce78663          	beq	a5,a4,832 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 76e:	0ee78e63          	beq	a5,a4,86a <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
 772:	11478863          	beq	a5,s4,882 <vprintf+0x1aa>
        putc(fd, c);
      } else {
 ...
 77e:	e92080e7          	jalr	-366(ra) # 60c <putc>
        putc(fd, c);
 782:	85ca                	mv	a1,s2
 784:	8556                	mv	a0,s5
 786:	00000097          	auipc	ra,0x0
 78a:	e86080e7          	jalr	-378(ra) # 60c <putc>
      }
      state = 0;
 78e:	4981                	li	s3,0
 ...
 7a4:	e8e080e7          	jalr	-370(ra) # 62e <printint>
 7a8:	8b4a                	mv	s6,s2
      state = 0;
 7aa:	4981                	li	s3,0
 ...
 7c0:	e72080e7          	jalr	-398(ra) # 62e <printint>
 7c4:	8b4a                	mv	s6,s2
      state = 0;
 7c6:	4981                	li	s3,0
 ...
 7dc:	e56080e7          	jalr	-426(ra) # 62e <printint>
 7e0:	8b4a                	mv	s6,s2
      state = 0;
 7e2:	4981                	li	s3,0
 ...
 7fc:	e14080e7          	jalr	-492(ra) # 60c <putc>
  putc(fd, 'x');
 800:	85ea                	mv	a1,s10
 802:	8556                	mv	a0,s5
 804:	00000097          	auipc	ra,0x0
 808:	e08080e7          	jalr	-504(ra) # 60c <putc>
 80c:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 81e:	df2080e7          	jalr	-526(ra) # 60c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 822:	0992                	slli	s3,s3,0x4
 824:	397d                	addiw	s2,s2,-1
 826:	fe0914e3          	bnez	s2,80e <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
 82a:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 82e:	4981                	li	s3,0
 830:	b721                	j	738 <vprintf+0x60>
        s = va_arg(ap, char*);
 832:	008b0993          	addi	s3,s6,8
 836:	000b3903          	ld	s2,0(s6)
        if(s == 0)
 83a:	02090163          	beqz	s2,85c <vprintf+0x184>
        while(*s != 0){
 83e:	00094583          	lbu	a1,0(s2)
 842:	c9a1                	beqz	a1,892 <vprintf+0x1ba>
          putc(fd, *s);
 844:	8556                	mv	a0,s5
 ...
 854:	f9e5                	bnez	a1,844 <vprintf+0x16c>
        s = va_arg(ap, char*);
 856:	8b4e                	mv	s6,s3
      state = 0;
 858:	4981                	li	s3,0
 85a:	bdf9                	j	738 <vprintf+0x60>
          s = "(null)";
 85c:	00000917          	auipc	s2,0x0
 860:	26490913          	addi	s2,s2,612 # ac0 <malloc+0x11e>
        while(*s != 0){
 864:	02800593          	li	a1,40
 868:	bff1                	j	844 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
...
free(void *ap)
{
 ...
 928:	1bc7b783          	ld	a5,444(a5) # ae0 <freep>
 92c:	a805                	j	95c <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
 92e:	4618                	lw	a4,8(a2)
 930:	9db9                	addw	a1,a1,a4
 932:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
 936:	6398                	ld	a4,0(a5)
 938:	6318                	ld	a4,0(a4)
 93a:	fee53823          	sd	a4,-16(a0)
 93e:	a091                	j	982 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
 940:	ff852703          	lw	a4,-8(a0)
 944:	9e39                	addw	a2,a2,a4
 946:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
 948:	ff053703          	ld	a4,-16(a0)
 94c:	e398                	sd	a4,0(a5)
 94e:	a099                	j	994 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 950:	6398                	ld	a4,0(a5)
 952:	00e7e463          	bltu	a5,a4,95a <free+0x40>
 956:	00e6ea63          	bltu	a3,a4,96a <free+0x50>
{
 95a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 95c:	fed7fae3          	bgeu	a5,a3,950 <free+0x36>
 960:	6398                	ld	a4,0(a5)
 962:	00e6e463          	bltu	a3,a4,96a <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 966:	fee7eae3          	bltu	a5,a4,95a <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
 96a:	ff852583          	lw	a1,-8(a0)
 96e:	6390                	ld	a2,0(a5)
 970:	02059713          	slli	a4,a1,0x20
 974:	9301                	srli	a4,a4,0x20
 976:	0712                	slli	a4,a4,0x4
 978:	9736                	add	a4,a4,a3
 97a:	fae60ae3          	beq	a2,a4,92e <free+0x14>
    bp->s.ptr = p->s.ptr;
 ...
 98e:	fae689e3          	beq	a3,a4,940 <free+0x26>
  } else
    p->s.ptr = bp;
 992:	e394                	sd	a3,0(a5)
  freep = p;
 994:	00000717          	auipc	a4,0x0
 998:	14f73623          	sd	a5,332(a4) # ae0 <freep>
}
 99c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9ca:	11a53503          	ld	a0,282(a0) # ae0 <freep>
 9ce:	c515                	beqz	a0,9fa <malloc+0x58>
 ...
 9d0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 9d2:	4798                	lw	a4,8(a5)
 9d4:	02977f63          	bgeu	a4,s1,a12 <malloc+0x70>
 9d8:	8a4e                	mv	s4,s3
 ...
 9f2:	0f290913          	addi	s2,s2,242 # ae0 <freep>
  if(p == (char*)-1)
 9f6:	5afd                	li	s5,-1
 9f8:	a88d                	j	a6a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9fa:	00000797          	auipc	a5,0x0
 9fe:	4ee78793          	addi	a5,a5,1262 # ee8 <base>
 a02:	00000717          	auipc	a4,0x0
 a06:	0cf73f23          	sd	a5,222(a4) # ae0 <freep>
 a0a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 a0c:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 a10:	b7e1                	j	9d8 <malloc+0x36>
      if(p->s.size == nunits)
 a12:	02e48b63          	beq	s1,a4,a48 <malloc+0xa6>
        p->s.size -= nunits;
 ...
 a2c:	0aa73c23          	sd	a0,184(a4) # ae0 <freep>
      return (void*)(p + 1);
 ...
 a48:	6398                	ld	a4,0(a5)
 a4a:	e118                	sd	a4,0(a0)
 a4c:	bff1                	j	a28 <malloc+0x86>
  hp->s.size = nu;
 a4e:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 a52:	0541                	addi	a0,a0,16
 a54:	00000097          	auipc	ra,0x0
 a58:	ec6080e7          	jalr	-314(ra) # 91a <free>
  return freep;
 a5c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 a60:	d971                	beqz	a0,a34 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a62:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 a64:	4798                	lw	a4,8(a5)
 a66:	fa9776e3          	bgeu	a4,s1,a12 <malloc+0x70>
    if(p == freep)
 a6a:	00093703          	ld	a4,0(s2)
 a6e:	853e                	mv	a0,a5
 a70:	fef719e3          	bne	a4,a5,a62 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
 a74:	8552                	mv	a0,s4
 a76:	00000097          	auipc	ra,0x0
 a7a:	b36080e7          	jalr	-1226(ra) # 5ac <sbrk>
  if(p == (char*)-1)
 a7e:	fd5518e3          	bne	a0,s5,a4e <malloc+0xac>
        return 0;
 a82:	4501                	li	a0,0
 a84:	bf45                	j	a34 <malloc+0x92>
