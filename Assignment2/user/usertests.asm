...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0da50513          	addi	a0,a0,218 # 6118 <malloc+0x448>
      46:	00006097          	auipc	ra,0x6
      4a:	bcc080e7          	jalr	-1076(ra) # 5c12 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	0b850513          	addi	a0,a0,184 # 6138 <malloc+0x468>
      88:	00006097          	auipc	ra,0x6
      8c:	b8a080e7          	jalr	-1142(ra) # 5c12 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0a850513          	addi	a0,a0,168 # 6150 <malloc+0x480>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0aa50513          	addi	a0,a0,170 # 6170 <malloc+0x4a0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	07250513          	addi	a0,a0,114 # 6158 <malloc+0x488>
      ee:	00006097          	auipc	ra,0x6
      f2:	b24080e7          	jalr	-1244(ra) # 5c12 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	07e50513          	addi	a0,a0,126 # 6180 <malloc+0x4b0>
     10a:	00006097          	auipc	ra,0x6
     10e:	b08080e7          	jalr	-1272(ra) # 5c12 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	07c50513          	addi	a0,a0,124 # 61a8 <malloc+0x4d8>
     134:	00005097          	auipc	ra,0x5
     138:	76e080e7          	jalr	1902(ra) # 58a2 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	06850513          	addi	a0,a0,104 # 61a8 <malloc+0x4d8>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	06458593          	addi	a1,a1,100 # 61b8 <malloc+0x4e8>
     15c:	00005097          	auipc	ra,0x5
     160:	716080e7          	jalr	1814(ra) # 5872 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	04050513          	addi	a0,a0,64 # 61a8 <malloc+0x4d8>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	04458593          	addi	a1,a1,68 # 61c0 <malloc+0x4f0>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	01450513          	addi	a0,a0,20 # 61a8 <malloc+0x4d8>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	ffe50513          	addi	a0,a0,-2 # 61c8 <malloc+0x4f8>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a40080e7          	jalr	-1472(ra) # 5c12 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	d1c50513          	addi	a0,a0,-740 # 5f98 <malloc+0x2c8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	d08a8a93          	addi	s5,s5,-760 # 5f98 <malloc+0x2c8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ede50513          	addi	a0,a0,-290 # 61f0 <malloc+0x520>
     31a:	00006097          	auipc	ra,0x6
     31e:	8f8080e7          	jalr	-1800(ra) # 5c12 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	eda50513          	addi	a0,a0,-294 # 6210 <malloc+0x540>
     33e:	00006097          	auipc	ra,0x6
     342:	8d4080e7          	jalr	-1836(ra) # 5c12 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	eb6a0a13          	addi	s4,s4,-330 # 6228 <malloc+0x558>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	e1250513          	addi	a0,a0,-494 # 6230 <malloc+0x560>
     426:	00005097          	auipc	ra,0x5
     42a:	7ec080e7          	jalr	2028(ra) # 5c12 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	e0c50513          	addi	a0,a0,-500 # 6248 <malloc+0x578>
     444:	00005097          	auipc	ra,0x5
     448:	7ce080e7          	jalr	1998(ra) # 5c12 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	e1e50513          	addi	a0,a0,-482 # 6278 <malloc+0x5a8>
     462:	00005097          	auipc	ra,0x5
     466:	7b0080e7          	jalr	1968(ra) # 5c12 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	e3450513          	addi	a0,a0,-460 # 62a8 <malloc+0x5d8>
     47c:	00005097          	auipc	ra,0x5
     480:	796080e7          	jalr	1942(ra) # 5c12 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	e2650513          	addi	a0,a0,-474 # 62b8 <malloc+0x5e8>
     49a:	00005097          	auipc	ra,0x5
     49e:	778080e7          	jalr	1912(ra) # 5c12 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	e18a0a13          	addi	s4,s4,-488 # 62e8 <malloc+0x618>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	ce8a8a93          	addi	s5,s5,-792 # 61c0 <malloc+0x4f0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d7250513          	addi	a0,a0,-654 # 62f0 <malloc+0x620>
     586:	00005097          	auipc	ra,0x5
     58a:	68c080e7          	jalr	1676(ra) # 5c12 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d6c50513          	addi	a0,a0,-660 # 6308 <malloc+0x638>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	66e080e7          	jalr	1646(ra) # 5c12 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	cf250513          	addi	a0,a0,-782 # 62a8 <malloc+0x5d8>
     5be:	00005097          	auipc	ra,0x5
     5c2:	654080e7          	jalr	1620(ra) # 5c12 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d6850513          	addi	a0,a0,-664 # 6338 <malloc+0x668>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	63a080e7          	jalr	1594(ra) # 5c12 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d6250513          	addi	a0,a0,-670 # 6350 <malloc+0x680>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	61c080e7          	jalr	1564(ra) # 5c12 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b7458593          	addi	a1,a1,-1164 # 61b8 <malloc+0x4e8>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b4850513          	addi	a0,a0,-1208 # 61a8 <malloc+0x4d8>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	b1c50513          	addi	a0,a0,-1252 # 61a8 <malloc+0x4d8>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	b0850513          	addi	a0,a0,-1272 # 61a8 <malloc+0x4d8>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	d0258593          	addi	a1,a1,-766 # 63e0 <malloc+0x710>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	a8850513          	addi	a0,a0,-1400 # 61a8 <malloc+0x4d8>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	c1c50513          	addi	a0,a0,-996 # 6380 <malloc+0x6b0>
     76c:	00005097          	auipc	ra,0x5
     770:	4a6080e7          	jalr	1190(ra) # 5c12 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	c2050513          	addi	a0,a0,-992 # 63a0 <malloc+0x6d0>
     788:	00005097          	auipc	ra,0x5
     78c:	48a080e7          	jalr	1162(ra) # 5c12 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	c1c50513          	addi	a0,a0,-996 # 63b0 <malloc+0x6e0>
     79c:	00005097          	auipc	ra,0x5
     7a0:	476080e7          	jalr	1142(ra) # 5c12 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	c2050513          	addi	a0,a0,-992 # 63d0 <malloc+0x700>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	45a080e7          	jalr	1114(ra) # 5c12 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	bec50513          	addi	a0,a0,-1044 # 63b0 <malloc+0x6e0>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	446080e7          	jalr	1094(ra) # 5c12 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	c0650513          	addi	a0,a0,-1018 # 63e8 <malloc+0x718>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	428080e7          	jalr	1064(ra) # 5c12 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	c0850513          	addi	a0,a0,-1016 # 6408 <malloc+0x738>
     808:	00005097          	auipc	ra,0x5
     80c:	40a080e7          	jalr	1034(ra) # 5c12 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	bf450513          	addi	a0,a0,-1036 # 6428 <malloc+0x758>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	c0498993          	addi	s3,s3,-1020 # 6450 <malloc+0x780>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	c34a8a93          	addi	s5,s5,-972 # 6488 <malloc+0x7b8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	b8e50513          	addi	a0,a0,-1138 # 6428 <malloc+0x758>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	52458593          	addi	a1,a1,1316 # bdd8 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b5250513          	addi	a0,a0,-1198 # 6428 <malloc+0x758>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	b3050513          	addi	a0,a0,-1232 # 6430 <malloc+0x760>
     908:	00005097          	auipc	ra,0x5
     90c:	30a080e7          	jalr	778(ra) # 5c12 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	b4250513          	addi	a0,a0,-1214 # 6460 <malloc+0x790>
     926:	00005097          	auipc	ra,0x5
     92a:	2ec080e7          	jalr	748(ra) # 5c12 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b5c50513          	addi	a0,a0,-1188 # 6498 <malloc+0x7c8>
     944:	00005097          	auipc	ra,0x5
     948:	2ce080e7          	jalr	718(ra) # 5c12 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b6850513          	addi	a0,a0,-1176 # 64c0 <malloc+0x7f0>
     960:	00005097          	auipc	ra,0x5
     964:	2b2080e7          	jalr	690(ra) # 5c12 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b6c50513          	addi	a0,a0,-1172 # 64e0 <malloc+0x810>
     97c:	00005097          	auipc	ra,0x5
     980:	296080e7          	jalr	662(ra) # 5c12 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b6850513          	addi	a0,a0,-1176 # 64f8 <malloc+0x828>
     998:	00005097          	auipc	ra,0x5
     99c:	27a080e7          	jalr	634(ra) # 5c12 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b5650513          	addi	a0,a0,-1194 # 6518 <malloc+0x848>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	40290913          	addi	s2,s2,1026 # bdd8 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	b0450513          	addi	a0,a0,-1276 # 6518 <malloc+0x848>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	3b090913          	addi	s2,s2,944 # bdd8 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	ac450513          	addi	a0,a0,-1340 # 6520 <malloc+0x850>
     a64:	00005097          	auipc	ra,0x5
     a68:	1ae080e7          	jalr	430(ra) # 5c12 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	ac650513          	addi	a0,a0,-1338 # 6540 <malloc+0x870>
     a82:	00005097          	auipc	ra,0x5
     a86:	190080e7          	jalr	400(ra) # 5c12 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	ad250513          	addi	a0,a0,-1326 # 6568 <malloc+0x898>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	174080e7          	jalr	372(ra) # 5c12 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a5650513          	addi	a0,a0,-1450 # 6518 <malloc+0x848>
     ...
     af2:	a9a50513          	addi	a0,a0,-1382 # 6588 <malloc+0x8b8>
     af6:	00005097          	auipc	ra,0x5
     afa:	11c080e7          	jalr	284(ra) # 5c12 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	aa450513          	addi	a0,a0,-1372 # 65b0 <malloc+0x8e0>
     b14:	00005097          	auipc	ra,0x5
     b18:	0fe080e7          	jalr	254(ra) # 5c12 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	a9e50513          	addi	a0,a0,-1378 # 65c8 <malloc+0x8f8>
     b32:	00005097          	auipc	ra,0x5
     b36:	0e0080e7          	jalr	224(ra) # 5c12 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	aaa50513          	addi	a0,a0,-1366 # 65f0 <malloc+0x920>
     b4e:	00005097          	auipc	ra,0x5
     b52:	0c4080e7          	jalr	196(ra) # 5c12 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	3b450513          	addi	a0,a0,948 # 5f28 <malloc+0x258>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	a9c58593          	addi	a1,a1,-1380 # 6628 <malloc+0x958>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	38050513          	addi	a0,a0,896 # 5f28 <malloc+0x258>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	36a50513          	addi	a0,a0,874 # 5f28 <malloc+0x258>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	35450513          	addi	a0,a0,852 # 5f28 <malloc+0x258>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	a8858593          	addi	a1,a1,-1400 # 6670 <malloc+0x9a0>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	1d458593          	addi	a1,a1,468 # bdd8 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	2d850513          	addi	a0,a0,728 # 5f28 <malloc+0x258>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	99850513          	addi	a0,a0,-1640 # 6608 <malloc+0x938>
     c78:	00005097          	auipc	ra,0x5
     c7c:	f9a080e7          	jalr	-102(ra) # 5c12 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	9a450513          	addi	a0,a0,-1628 # 6630 <malloc+0x960>
     c94:	00005097          	auipc	ra,0x5
     c98:	f7e080e7          	jalr	-130(ra) # 5c12 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	9a850513          	addi	a0,a0,-1624 # 6650 <malloc+0x980>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	f62080e7          	jalr	-158(ra) # 5c12 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	9b450513          	addi	a0,a0,-1612 # 6678 <malloc+0x9a8>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	f46080e7          	jalr	-186(ra) # 5c12 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	9b850513          	addi	a0,a0,-1608 # 6698 <malloc+0x9c8>
     ce8:	00005097          	auipc	ra,0x5
     cec:	f2a080e7          	jalr	-214(ra) # 5c12 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	9bc50513          	addi	a0,a0,-1604 # 66b8 <malloc+0x9e8>
     d04:	00005097          	auipc	ra,0x5
     d08:	f0e080e7          	jalr	-242(ra) # 5c12 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	8c858593          	addi	a1,a1,-1848 # 6628 <malloc+0x958>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	96058593          	addi	a1,a1,-1696 # 66e0 <malloc+0xa10>
     d88:	00006517          	auipc	a0,0x6
     d8c:	95050513          	addi	a0,a0,-1712 # 66d8 <malloc+0xa08>
  ...
  unlink("lf1");
     ...
     da0:	93c50513          	addi	a0,a0,-1732 # 66d8 <malloc+0xa08>
     da4:	00005097          	auipc	ra,0x5
     da8:	afe080e7          	jalr	-1282(ra) # 58a2 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	92a50513          	addi	a0,a0,-1750 # 66d8 <malloc+0xa08>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	91c50513          	addi	a0,a0,-1764 # 66e0 <malloc+0xa10>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	ffc58593          	addi	a1,a1,-4 # bdd8 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	8e458593          	addi	a1,a1,-1820 # 66e0 <malloc+0xa10>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	8ce50513          	addi	a0,a0,-1842 # 66e0 <malloc+0xa10>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a88080e7          	jalr	-1400(ra) # 58a2 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	8b658593          	addi	a1,a1,-1866 # 66d8 <malloc+0xa08>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	8b650513          	addi	a0,a0,-1866 # 66e0 <malloc+0xa10>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	89a58593          	addi	a1,a1,-1894 # 66d8 <malloc+0xa08>
     e46:	00006517          	auipc	a0,0x6
     e4a:	9a250513          	addi	a0,a0,-1630 # 67e8 <malloc+0xb18>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	88050513          	addi	a0,a0,-1920 # 66e8 <malloc+0xa18>
     e70:	00005097          	auipc	ra,0x5
     e74:	da2080e7          	jalr	-606(ra) # 5c12 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	87c50513          	addi	a0,a0,-1924 # 6700 <malloc+0xa30>
     e8c:	00005097          	auipc	ra,0x5
     e90:	d86080e7          	jalr	-634(ra) # 5c12 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	87850513          	addi	a0,a0,-1928 # 6718 <malloc+0xa48>
     ea8:	00005097          	auipc	ra,0x5
     eac:	d6a080e7          	jalr	-662(ra) # 5c12 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	87c50513          	addi	a0,a0,-1924 # 6738 <malloc+0xa68>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	d4e080e7          	jalr	-690(ra) # 5c12 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	89050513          	addi	a0,a0,-1904 # 6768 <malloc+0xa98>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	d32080e7          	jalr	-718(ra) # 5c12 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	88c50513          	addi	a0,a0,-1908 # 6780 <malloc+0xab0>
     efc:	00005097          	auipc	ra,0x5
     f00:	d16080e7          	jalr	-746(ra) # 5c12 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	88850513          	addi	a0,a0,-1912 # 6798 <malloc+0xac8>
     f18:	00005097          	auipc	ra,0x5
     f1c:	cfa080e7          	jalr	-774(ra) # 5c12 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	89450513          	addi	a0,a0,-1900 # 67c0 <malloc+0xaf0>
     f34:	00005097          	auipc	ra,0x5
     f38:	cde080e7          	jalr	-802(ra) # 5c12 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	8a850513          	addi	a0,a0,-1880 # 67f0 <malloc+0xb20>
     f50:	00005097          	auipc	ra,0x5
     f54:	cc2080e7          	jalr	-830(ra) # 5c12 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	862a0a13          	addi	s4,s4,-1950 # 6810 <malloc+0xb40>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	81050513          	addi	a0,a0,-2032 # 6810 <malloc+0xb40>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	7a850513          	addi	a0,a0,1960 # 6818 <malloc+0xb48>
    1078:	00005097          	auipc	ra,0x5
    107c:	b9a080e7          	jalr	-1126(ra) # 5c12 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	7a850513          	addi	a0,a0,1960 # 6838 <malloc+0xb68>
    1098:	00005097          	auipc	ra,0x5
    109c:	b7a080e7          	jalr	-1158(ra) # 5c12 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	7ac50513          	addi	a0,a0,1964 # 6858 <malloc+0xb88>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	b5e080e7          	jalr	-1186(ra) # 5c12 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	79a98993          	addi	s3,s3,1946 # 6878 <malloc+0xba8>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	76e50513          	addi	a0,a0,1902 # 6888 <malloc+0xbb8>
    1122:	00005097          	auipc	ra,0x5
    1126:	af0080e7          	jalr	-1296(ra) # 5c12 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	46e4b483          	ld	s1,1134(s1) # 85b0 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x578>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	fca98993          	addi	s3,s3,-54 # 6150 <malloc+0x480>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	86078793          	addi	a5,a5,-1952 # 7a70 <malloc+0x1da0>
  ...
  if(pid == 0){
    ...
    124a:	47a78793          	addi	a5,a5,1146 # 86c0 <big.1291>
    124e:	00008697          	auipc	a3,0x8
    1252:	47268693          	addi	a3,a3,1138 # 96c0 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1268:	44078e23          	sb	zero,1116(a5) # 96c0 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	f1478793          	addi	a5,a5,-236 # 8180 <malloc+0x24b0>
    ...
    1294:	ec050513          	addi	a0,a0,-320 # 6150 <malloc+0x480>
    ...
    12ac:	68850513          	addi	a0,a0,1672 # 6930 <malloc+0xc60>
    12b0:	00005097          	auipc	ra,0x5
    12b4:	962080e7          	jalr	-1694(ra) # 5c12 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	5e050513          	addi	a0,a0,1504 # 68a8 <malloc+0xbd8>
    12d0:	00005097          	auipc	ra,0x5
    12d4:	942080e7          	jalr	-1726(ra) # 5c12 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	5e050513          	addi	a0,a0,1504 # 68c8 <malloc+0xbf8>
    12f0:	00005097          	auipc	ra,0x5
    12f4:	922080e7          	jalr	-1758(ra) # 5c12 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	5de50513          	addi	a0,a0,1502 # 68e8 <malloc+0xc18>
    1312:	00005097          	auipc	ra,0x5
    1316:	900080e7          	jalr	-1792(ra) # 5c12 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	5e650513          	addi	a0,a0,1510 # 6910 <malloc+0xc40>
    1332:	00005097          	auipc	ra,0x5
    1336:	8e0080e7          	jalr	-1824(ra) # 5c12 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	a6450513          	addi	a0,a0,-1436 # 6da8 <malloc+0x10d8>
    134c:	00005097          	auipc	ra,0x5
    1350:	8c6080e7          	jalr	-1850(ra) # 5c12 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	5ca50513          	addi	a0,a0,1482 # 6958 <malloc+0xc88>
    1396:	00005097          	auipc	ra,0x5
    139a:	87c080e7          	jalr	-1924(ra) # 5c12 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	de850513          	addi	a0,a0,-536 # 61a8 <malloc+0x4d8>
  ...
  if(pid == 0){
    ...
    13ee:	dbea0a13          	addi	s4,s4,-578 # 61a8 <malloc+0x4d8>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	5c6a8a93          	addi	s5,s5,1478 # 69b8 <malloc+0xce8>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	52650513          	addi	a0,a0,1318 # 6988 <malloc+0xcb8>
    146a:	00004097          	auipc	ra,0x4
    146e:	7a8080e7          	jalr	1960(ra) # 5c12 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	52250513          	addi	a0,a0,1314 # 69a0 <malloc+0xcd0>
    1486:	00004097          	auipc	ra,0x4
    148a:	78c080e7          	jalr	1932(ra) # 5c12 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	52c50513          	addi	a0,a0,1324 # 69c8 <malloc+0xcf8>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	76e080e7          	jalr	1902(ra) # 5c12 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	ceea0a13          	addi	s4,s4,-786 # 61a8 <malloc+0x4d8>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	526a8a93          	addi	s5,s5,1318 # 69e8 <malloc+0xd18>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	c9c50513          	addi	a0,a0,-868 # 61a8 <malloc+0x4d8>
  ...
  exit(xstatus);
    ...
    152e:	47650513          	addi	a0,a0,1142 # 69a0 <malloc+0xcd0>
    1532:	00004097          	auipc	ra,0x4
    1536:	6e0080e7          	jalr	1760(ra) # 5c12 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	4a850513          	addi	a0,a0,1192 # 69f0 <malloc+0xd20>
    1550:	00004097          	auipc	ra,0x4
    1554:	6c2080e7          	jalr	1730(ra) # 5c12 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	be078793          	addi	a5,a5,-1056 # 6150 <malloc+0x480>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	49478793          	addi	a5,a5,1172 # 6a10 <malloc+0xd40>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	48c50513          	addi	a0,a0,1164 # 6a18 <malloc+0xd48>
  ...
  if(pid == 0) {
    ...
    15be:	45e50513          	addi	a0,a0,1118 # 6a18 <malloc+0xd48>
    ...
    15da:	46250513          	addi	a0,a0,1122 # 6a38 <malloc+0xd68>
    15de:	00004097          	auipc	ra,0x4
    15e2:	634080e7          	jalr	1588(ra) # 5c12 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	39650513          	addi	a0,a0,918 # 6988 <malloc+0xcb8>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	618080e7          	jalr	1560(ra) # 5c12 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	41250513          	addi	a0,a0,1042 # 6a20 <malloc+0xd50>
    1616:	00004097          	auipc	ra,0x4
    161a:	5fc080e7          	jalr	1532(ra) # 5c12 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	b2450513          	addi	a0,a0,-1244 # 6150 <malloc+0x480>
  ...
  if(xstatus != 0)
    ...
    1664:	3e850513          	addi	a0,a0,1000 # 6a48 <malloc+0xd78>
    1668:	00004097          	auipc	ra,0x4
    166c:	5aa080e7          	jalr	1450(ra) # 5c12 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	3e450513          	addi	a0,a0,996 # 6a60 <malloc+0xd90>
    1684:	00004097          	auipc	ra,0x4
    1688:	58e080e7          	jalr	1422(ra) # 5c12 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	38850513          	addi	a0,a0,904 # 6a18 <malloc+0xd48>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	e2650513          	addi	a0,a0,-474 # 64e0 <malloc+0x810>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	550080e7          	jalr	1360(ra) # 5c12 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	2ca50513          	addi	a0,a0,714 # 69a0 <malloc+0xcd0>
    16de:	00004097          	auipc	ra,0x4
    16e2:	534080e7          	jalr	1332(ra) # 5c12 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	32850513          	addi	a0,a0,808 # 6a18 <malloc+0xd48>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	35e50513          	addi	a0,a0,862 # 6a78 <malloc+0xda8>
    1722:	00004097          	auipc	ra,0x4
    1726:	4f0080e7          	jalr	1264(ra) # 5c12 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	652a8a93          	addi	s5,s5,1618 # bdd8 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	63470713          	addi	a4,a4,1588 # bdd8 <buf>
    ...
    17e0:	2b450513          	addi	a0,a0,692 # 6a90 <malloc+0xdc0>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	42e080e7          	jalr	1070(ra) # 5c12 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    1806:	5d6b0b13          	addi	s6,s6,1494 # bdd8 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	24650513          	addi	a0,a0,582 # 6aa8 <malloc+0xdd8>
    186a:	00004097          	auipc	ra,0x4
    186e:	3a8080e7          	jalr	936(ra) # 5c12 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	24250513          	addi	a0,a0,578 # 6ac0 <malloc+0xdf0>
    1886:	00004097          	auipc	ra,0x4
    188a:	38c080e7          	jalr	908(ra) # 5c12 <printf>
}
    ...
    18b4:	22850513          	addi	a0,a0,552 # 6ad8 <malloc+0xe08>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	35a080e7          	jalr	858(ra) # 5c12 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	20850513          	addi	a0,a0,520 # 6af8 <malloc+0xe28>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	31a080e7          	jalr	794(ra) # 5c12 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	02650513          	addi	a0,a0,38 # 6988 <malloc+0xcb8>
    196a:	00004097          	auipc	ra,0x4
    196e:	2a8080e7          	jalr	680(ra) # 5c12 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	19250513          	addi	a0,a0,402 # 6b10 <malloc+0xe40>
    1986:	00004097          	auipc	ra,0x4
    198a:	28c080e7          	jalr	652(ra) # 5c12 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	18e50513          	addi	a0,a0,398 # 6b28 <malloc+0xe58>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	270080e7          	jalr	624(ra) # 5c12 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	f7650513          	addi	a0,a0,-138 # 6988 <malloc+0xcb8>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	1f8080e7          	jalr	504(ra) # 5c12 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	f5250513          	addi	a0,a0,-174 # 6988 <malloc+0xcb8>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	1d4080e7          	jalr	468(ra) # 5c12 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	09850513          	addi	a0,a0,152 # 6b48 <malloc+0xe78>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	15a080e7          	jalr	346(ra) # 5c12 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	d90080e7          	jalr	-624(ra) # 5852 <exit>
{
    ...
    1b0c:	05050513          	addi	a0,a0,80 # 6b58 <malloc+0xe88>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	102080e7          	jalr	258(ra) # 5c12 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	25250513          	addi	a0,a0,594 # 6da8 <malloc+0x10d8>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	0b4080e7          	jalr	180(ra) # 5c12 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	1b450513          	addi	a0,a0,436 # 6da8 <malloc+0x10d8>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	016080e7          	jalr	22(ra) # 5c12 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	e0050513          	addi	a0,a0,-512 # 6a20 <malloc+0xd50>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	fea080e7          	jalr	-22(ra) # 5c12 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	ee650513          	addi	a0,a0,-282 # 6b78 <malloc+0xea8>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	f78080e7          	jalr	-136(ra) # 5c12 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	eca50513          	addi	a0,a0,-310 # 6b90 <malloc+0xec0>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	f44080e7          	jalr	-188(ra) # 5c12 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	e8c50513          	addi	a0,a0,-372 # 6bb8 <malloc+0xee8>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	ede080e7          	jalr	-290(ra) # 5c12 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	3f450513          	addi	a0,a0,1012 # 61c0 <malloc+0x4f0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	3b8a8a93          	addi	s5,s5,952 # 61c0 <malloc+0x4f0>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	dd0b8b93          	addi	s7,s7,-560 # 6be0 <malloc+0xf10>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	b6c50513          	addi	a0,a0,-1172 # 6988 <malloc+0xcb8>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	dee080e7          	jalr	-530(ra) # 5c12 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	e9e50513          	addi	a0,a0,-354 # 6da8 <malloc+0x10d8>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	d00080e7          	jalr	-768(ra) # 5c12 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	e92b8b93          	addi	s7,s7,-366 # bdd8 <buf>
    ...
    1fbe:	c2e50513          	addi	a0,a0,-978 # 6be8 <malloc+0xf18>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	c50080e7          	jalr	-944(ra) # 5c12 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	23650513          	addi	a0,a0,566 # 6210 <malloc+0x540>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	c30080e7          	jalr	-976(ra) # 5c12 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	bf050513          	addi	a0,a0,-1040 # 6c18 <malloc+0xf48>
    2030:	00004097          	auipc	ra,0x4
    2034:	be2080e7          	jalr	-1054(ra) # 5c12 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	b7650513          	addi	a0,a0,-1162 # 6c00 <malloc+0xf30>
    2092:	00004097          	auipc	ra,0x4
    2096:	b80080e7          	jalr	-1152(ra) # 5c12 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	b9a50513          	addi	a0,a0,-1126 # 6c40 <malloc+0xf70>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	b64080e7          	jalr	-1180(ra) # 5c12 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	b9650513          	addi	a0,a0,-1130 # 6c58 <malloc+0xf88>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	b48080e7          	jalr	-1208(ra) # 5c12 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x578>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e698>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	84650513          	addi	a0,a0,-1978 # 6988 <malloc+0xcb8>
    214a:	00004097          	auipc	ra,0x4
    214e:	ac8080e7          	jalr	-1336(ra) # 5c12 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	b0c50513          	addi	a0,a0,-1268 # 6c70 <malloc+0xfa0>
    216c:	00004097          	auipc	ra,0x4
    2170:	aa6080e7          	jalr	-1370(ra) # 5c12 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	7a250513          	addi	a0,a0,1954 # 6988 <malloc+0xcb8>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	a24080e7          	jalr	-1500(ra) # 5c12 <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    2216:	a7e50513          	addi	a0,a0,-1410 # 6c90 <malloc+0xfc0>
    221a:	00004097          	auipc	ra,0x4
    221e:	9f8080e7          	jalr	-1544(ra) # 5c12 <printf>
      exit(1);
    2222:	4505                	li	a0,1
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	a6650513          	addi	a0,a0,-1434 # 6ca8 <malloc+0xfd8>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	a3450513          	addi	a0,a0,-1484 # 6ca8 <malloc+0xfd8>
  ...
  close(fd);
    ...
    229e:	32678793          	addi	a5,a5,806 # 85c0 <args.1880>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	41668693          	addi	a3,a3,1046 # 86b8 <args.1880+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	a0e70713          	addi	a4,a4,-1522 # 6cb8 <malloc+0xfe8>
    ...
    2302:	a9a50513          	addi	a0,a0,-1382 # 6d98 <malloc+0x10c8>
    2306:	00004097          	auipc	ra,0x4
    230a:	90c080e7          	jalr	-1780(ra) # 5c12 <printf>
    exit(1);
    230e:	4505                	li	a0,1
    ...
    2326:	a9650513          	addi	a0,a0,-1386 # 6db8 <malloc+0x10e8>
    232a:	00004097          	auipc	ra,0x4
    232e:	8e8080e7          	jalr	-1816(ra) # 5c12 <printf>
    exit(1);
    2332:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237a:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0218>
    237e:	85a6                	mv	a1,s1
    2380:	00005517          	auipc	a0,0x5
    2384:	a5850513          	addi	a0,a0,-1448 # 6dd8 <malloc+0x1108>
    2388:	00004097          	auipc	ra,0x4
    238c:	88a080e7          	jalr	-1910(ra) # 5c12 <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    23a0:	5ec50513          	addi	a0,a0,1516 # 6988 <malloc+0xcb8>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	86e080e7          	jalr	-1938(ra) # 5c12 <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	63a78793          	addi	a5,a5,1594 # 7a70 <malloc+0x1da0>
  ...
  if(ret != -1){
    ...
    247c:	98850513          	addi	a0,a0,-1656 # 6e00 <malloc+0x1130>
    2480:	00003097          	auipc	ra,0x3
    2484:	792080e7          	jalr	1938(ra) # 5c12 <printf>
    exit(1);
    2488:	4505                	li	a0,1
    ...
    249a:	41250513          	addi	a0,a0,1042 # 68a8 <malloc+0xbd8>
    249e:	00003097          	auipc	ra,0x3
    24a2:	774080e7          	jalr	1908(ra) # 5c12 <printf>
    exit(1);
    24a6:	4505                	li	a0,1
    ...
    24b8:	41450513          	addi	a0,a0,1044 # 68c8 <malloc+0xbf8>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	756080e7          	jalr	1878(ra) # 5c12 <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d8:	41450513          	addi	a0,a0,1044 # 68e8 <malloc+0xc18>
    24dc:	00003097          	auipc	ra,0x3
    24e0:	736080e7          	jalr	1846(ra) # 5c12 <printf>
    exit(1);
    24e4:	4505                	li	a0,1
    ...
    24f6:	41e50513          	addi	a0,a0,1054 # 6910 <malloc+0xc40>
    24fa:	00003097          	auipc	ra,0x3
    24fe:	718080e7          	jalr	1816(ra) # 5c12 <printf>
    exit(1);
    2502:	4505                	li	a0,1
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	90250513          	addi	a0,a0,-1790 # 5e40 <malloc+0x170>
  ...
  if(n >= 0){
    ...
    2574:	8e850513          	addi	a0,a0,-1816 # 6e58 <malloc+0x1188>
    2578:	00003097          	auipc	ra,0x3
    257c:	69a080e7          	jalr	1690(ra) # 5c12 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	87e50513          	addi	a0,a0,-1922 # 6e08 <malloc+0x1138>
    2592:	00003097          	auipc	ra,0x3
    2596:	680080e7          	jalr	1664(ra) # 5c12 <printf>
    exit(1);
    259a:	4505                	li	a0,1
    ...
    25a8:	87c50513          	addi	a0,a0,-1924 # 6e20 <malloc+0x1150>
    25ac:	00003097          	auipc	ra,0x3
    25b0:	666080e7          	jalr	1638(ra) # 5c12 <printf>
    exit(1);
    25b4:	4505                	li	a0,1
    ...
    25c2:	88250513          	addi	a0,a0,-1918 # 6e40 <malloc+0x1170>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	64c080e7          	jalr	1612(ra) # 5c12 <printf>
    exit(1);
    25ce:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e6:	85e50513          	addi	a0,a0,-1954 # 5e40 <malloc+0x170>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2b8080e7          	jalr	696(ra) # 58a2 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	cf450513          	addi	a0,a0,-780 # 62e8 <malloc+0x618>
  ...
  if(n >= 0){
    ...
    2622:	86a50513          	addi	a0,a0,-1942 # 6e88 <malloc+0x11b8>
    2626:	00003097          	auipc	ra,0x3
    262a:	5ec080e7          	jalr	1516(ra) # 5c12 <printf>
    exit(1);
    262e:	4505                	li	a0,1
    ...
    263c:	80850513          	addi	a0,a0,-2040 # 6e40 <malloc+0x1170>
    2640:	00003097          	auipc	ra,0x3
    2644:	5d2080e7          	jalr	1490(ra) # 5c12 <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1218>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26be:	7f650513          	addi	a0,a0,2038 # 6eb0 <malloc+0x11e0>
    26c2:	00003097          	auipc	ra,0x3
    26c6:	550080e7          	jalr	1360(ra) # 5c12 <printf>
    exit(1);
    26ca:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2712:	7c250513          	addi	a0,a0,1986 # 6ed0 <malloc+0x1200>
    2716:	00003097          	auipc	ra,0x3
    271a:	4fc080e7          	jalr	1276(ra) # 5c12 <printf>
    exit(1);
    271e:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2774:	7c050513          	addi	a0,a0,1984 # 6f30 <malloc+0x1260>
    2778:	00003097          	auipc	ra,0x3
    277c:	49a080e7          	jalr	1178(ra) # 5c12 <printf>
    exit(1);
    2780:	4505                	li	a0,1
    ...
    2796:	75e50513          	addi	a0,a0,1886 # 6ef0 <malloc+0x1220>
    279a:	00003097          	auipc	ra,0x3
    279e:	478080e7          	jalr	1144(ra) # 5c12 <printf>
      exit(1);
    27a2:	4505                	li	a0,1
    ...
    27b2:	76250513          	addi	a0,a0,1890 # 6f10 <malloc+0x1240>
    27b6:	00003097          	auipc	ra,0x3
    27ba:	45c080e7          	jalr	1116(ra) # 5c12 <printf>
    exit(1);
    27be:	4505                	li	a0,1
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1217>
  a = sbrk(0);
    2854:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1217>
  ...
  if(c != a){
    ...
    28fc:	65850513          	addi	a0,a0,1624 # 6f50 <malloc+0x1280>
    2900:	00003097          	auipc	ra,0x3
    2904:	312080e7          	jalr	786(ra) # 5c12 <printf>
    exit(1);
    2908:	4505                	li	a0,1
    ...
    2918:	68450513          	addi	a0,a0,1668 # 6f98 <malloc+0x12c8>
    291c:	00003097          	auipc	ra,0x3
    2920:	2f6080e7          	jalr	758(ra) # 5c12 <printf>
    exit(1);
    2924:	4505                	li	a0,1
    ...
    2938:	68450513          	addi	a0,a0,1668 # 6fb8 <malloc+0x12e8>
    293c:	00003097          	auipc	ra,0x3
    2940:	2d6080e7          	jalr	726(ra) # 5c12 <printf>
    exit(1);
    2944:	4505                	li	a0,1
    ...
    2958:	6a450513          	addi	a0,a0,1700 # 6ff8 <malloc+0x1328>
    295c:	00003097          	auipc	ra,0x3
    2960:	2b6080e7          	jalr	694(ra) # 5c12 <printf>
    exit(1);
    2964:	4505                	li	a0,1
    ...
    2974:	6b850513          	addi	a0,a0,1720 # 7028 <malloc+0x1358>
    2978:	00003097          	auipc	ra,0x3
    297c:	29a080e7          	jalr	666(ra) # 5c12 <printf>
    exit(1);
    2980:	4505                	li	a0,1
    ...
    2994:	6d050513          	addi	a0,a0,1744 # 7060 <malloc+0x1390>
    2998:	00003097          	auipc	ra,0x3
    299c:	27a080e7          	jalr	634(ra) # 5c12 <printf>
    exit(1);
    29a0:	4505                	li	a0,1
...
00000000000029aa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29ce:	6be50513          	addi	a0,a0,1726 # 7088 <malloc+0x13b8>
    29d2:	00003097          	auipc	ra,0x3
    29d6:	ec0080e7          	jalr	-320(ra) # 5892 <open>
    29da:	84aa                	mv	s1,a0
  unlink("sbrk");
    29dc:	00004517          	auipc	a0,0x4
    29e0:	6ac50513          	addi	a0,a0,1708 # 7088 <malloc+0x13b8>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a34:	66050513          	addi	a0,a0,1632 # 7090 <malloc+0x13c0>
    2a38:	00003097          	auipc	ra,0x3
    2a3c:	1da080e7          	jalr	474(ra) # 5c12 <printf>
    exit(1);
    2a40:	4505                	li	a0,1
    ...
    2a50:	65c50513          	addi	a0,a0,1628 # 70a8 <malloc+0x13d8>
    2a54:	00003097          	auipc	ra,0x3
    2a58:	1be080e7          	jalr	446(ra) # 5c12 <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a6c:	02850513          	addi	a0,a0,40 # 6a90 <malloc+0xdc0>
    2a70:	00003097          	auipc	ra,0x3
    2a74:	1a2080e7          	jalr	418(ra) # 5c12 <printf>
    exit(1);
    2a78:	4505                	li	a0,1
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	62e50513          	addi	a0,a0,1582 # 70c0 <malloc+0x13f0>
  ...
  close(fd);
    ...
    2ade:	ec650513          	addi	a0,a0,-314 # 69a0 <malloc+0xcd0>
    2ae2:	00003097          	auipc	ra,0x3
    2ae6:	130080e7          	jalr	304(ra) # 5c12 <printf>
    exit(1);
    2aea:	4505                	li	a0,1
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2c:	28050513          	addi	a0,a0,640 # 6da8 <malloc+0x10d8>
    2b30:	00003097          	auipc	ra,0x3
    2b34:	0e2080e7          	jalr	226(ra) # 5c12 <printf>
    exit(1);
    2b38:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b82:	22a50513          	addi	a0,a0,554 # 6da8 <malloc+0x10d8>
    2b86:	00003097          	auipc	ra,0x3
    2b8a:	08c080e7          	jalr	140(ra) # 5c12 <printf>
    exit(1);
    2b8e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2be2:	1ca50513          	addi	a0,a0,458 # 6da8 <malloc+0x10d8>
    2be6:	00003097          	auipc	ra,0x3
    2bea:	02c080e7          	jalr	44(ra) # 5c12 <printf>
    exit(1);
    2bee:	4505                	li	a0,1
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff1217>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d56:	05650513          	addi	a0,a0,86 # 6da8 <malloc+0x10d8>
    2d5a:	00003097          	auipc	ra,0x3
    2d5e:	eb8080e7          	jalr	-328(ra) # 5c12 <printf>
      exit(1);
    2d62:	4505                	li	a0,1
    ...
    2daa:	3aa50513          	addi	a0,a0,938 # 6150 <malloc+0x480>
    2dae:	faa43c23          	sd	a0,-72(s0)
    2db2:	00003797          	auipc	a5,0x3
    2db6:	40e78793          	addi	a5,a5,1038 # 61c0 <malloc+0x4f0>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	4b450513          	addi	a0,a0,1204 # 7298 <malloc+0x15c8>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	2fa50513          	addi	a0,a0,762 # 70f0 <malloc+0x1420>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e10:	33c50513          	addi	a0,a0,828 # 7148 <malloc+0x1478>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2e:	39650513          	addi	a0,a0,918 # 71c0 <malloc+0x14f0>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4a:	3ea50513          	addi	a0,a0,1002 # 7230 <malloc+0x1560>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	43050513          	addi	a0,a0,1072 # 7288 <malloc+0x15b8>
  ...
  unlink("12345678901234");
    ...
    2eda:	1f250513          	addi	a0,a0,498 # 70c8 <malloc+0x13f8>
    2ede:	00003097          	auipc	ra,0x3
    2ee2:	d34080e7          	jalr	-716(ra) # 5c12 <printf>
    exit(1);
    2ee6:	4505                	li	a0,1
    ...
    2ef6:	21e50513          	addi	a0,a0,542 # 7110 <malloc+0x1440>
    2efa:	00003097          	auipc	ra,0x3
    2efe:	d18080e7          	jalr	-744(ra) # 5c12 <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f12:	26a50513          	addi	a0,a0,618 # 7178 <malloc+0x14a8>
    2f16:	00003097          	auipc	ra,0x3
    2f1a:	cfc080e7          	jalr	-772(ra) # 5c12 <printf>
    exit(1);
    2f1e:	4505                	li	a0,1
    ...
    2f2e:	2c650513          	addi	a0,a0,710 # 71f0 <malloc+0x1520>
    2f32:	00003097          	auipc	ra,0x3
    2f36:	ce0080e7          	jalr	-800(ra) # 5c12 <printf>
    exit(1);
    2f3a:	4505                	li	a0,1
    ...
    2f4a:	30a50513          	addi	a0,a0,778 # 7250 <malloc+0x1580>
    2f4e:	00003097          	auipc	ra,0x3
    2f52:	cc4080e7          	jalr	-828(ra) # 5c12 <printf>
    exit(1);
    2f56:	4505                	li	a0,1
    ...
    2f66:	34650513          	addi	a0,a0,838 # 72a8 <malloc+0x15d8>
    2f6a:	00003097          	auipc	ra,0x3
    2f6e:	ca8080e7          	jalr	-856(ra) # 5c12 <printf>
    exit(1);
    2f72:	4505                	li	a0,1
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	35850513          	addi	a0,a0,856 # 72e0 <malloc+0x1610>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	34450513          	addi	a0,a0,836 # 72e0 <malloc+0x1610>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	37050513          	addi	a0,a0,880 # 7320 <malloc+0x1650>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	38c50513          	addi	a0,a0,908 # 7350 <malloc+0x1680>
    ...
    2fe8:	30450513          	addi	a0,a0,772 # 72e8 <malloc+0x1618>
    2fec:	00003097          	auipc	ra,0x3
    2ff0:	c26080e7          	jalr	-986(ra) # 5c12 <printf>
    exit(1);
    2ff4:	4505                	li	a0,1
    ...
    3004:	30050513          	addi	a0,a0,768 # 7300 <malloc+0x1630>
    3008:	00003097          	auipc	ra,0x3
    300c:	c0a080e7          	jalr	-1014(ra) # 5c12 <printf>
    exit(1);
    3010:	4505                	li	a0,1
    ...
    3020:	31450513          	addi	a0,a0,788 # 7330 <malloc+0x1660>
    3024:	00003097          	auipc	ra,0x3
    3028:	bee080e7          	jalr	-1042(ra) # 5c12 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    303c:	32050513          	addi	a0,a0,800 # 7358 <malloc+0x1688>
    3040:	00003097          	auipc	ra,0x3
    3044:	bd2080e7          	jalr	-1070(ra) # 5c12 <printf>
    exit(1);
    3048:	4505                	li	a0,1
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3070:	27450513          	addi	a0,a0,628 # 72e0 <malloc+0x1610>
    ...
    3084:	26050513          	addi	a0,a0,608 # 72e0 <malloc+0x1610>
    ...
    3098:	28c50513          	addi	a0,a0,652 # 7320 <malloc+0x1650>
    ...
    30b8:	8d450513          	addi	a0,a0,-1836 # 6988 <malloc+0xcb8>
    30bc:	00003097          	auipc	ra,0x3
    30c0:	b56080e7          	jalr	-1194(ra) # 5c12 <printf>
    exit(1);
    30c4:	4505                	li	a0,1
    ...
    30d4:	21850513          	addi	a0,a0,536 # 72e8 <malloc+0x1618>
    30d8:	00003097          	auipc	ra,0x3
    30dc:	b3a080e7          	jalr	-1222(ra) # 5c12 <printf>
      exit(1);
    30e0:	4505                	li	a0,1
    ...
    30f0:	28450513          	addi	a0,a0,644 # 7370 <malloc+0x16a0>
    30f4:	00003097          	auipc	ra,0x3
    30f8:	b1e080e7          	jalr	-1250(ra) # 5c12 <printf>
      exit(1);
    30fc:	4505                	li	a0,1
    ...
    310c:	22850513          	addi	a0,a0,552 # 7330 <malloc+0x1660>
    3110:	00003097          	auipc	ra,0x3
    3114:	b02080e7          	jalr	-1278(ra) # 5c12 <printf>
      exit(1);
    3118:	4505                	li	a0,1
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	24250513          	addi	a0,a0,578 # 7388 <malloc+0x16b8>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	22e50513          	addi	a0,a0,558 # 7388 <malloc+0x16b8>
  ...
  if(chdir("..") < 0){
    ...
    3172:	23a50513          	addi	a0,a0,570 # 73a8 <malloc+0x16d8>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	20650513          	addi	a0,a0,518 # 7388 <malloc+0x16b8>
    ...
    31a6:	14650513          	addi	a0,a0,326 # 72e8 <malloc+0x1618>
    31aa:	00003097          	auipc	ra,0x3
    31ae:	a68080e7          	jalr	-1432(ra) # 5c12 <printf>
    exit(1);
    31b2:	4505                	li	a0,1
    ...
    31c2:	1d250513          	addi	a0,a0,466 # 7390 <malloc+0x16c0>
    31c6:	00003097          	auipc	ra,0x3
    31ca:	a4c080e7          	jalr	-1460(ra) # 5c12 <printf>
    exit(1);
    31ce:	4505                	li	a0,1
    ...
    31de:	1d650513          	addi	a0,a0,470 # 73b0 <malloc+0x16e0>
    31e2:	00003097          	auipc	ra,0x3
    31e6:	a30080e7          	jalr	-1488(ra) # 5c12 <printf>
    exit(1);
    31ea:	4505                	li	a0,1
    ...
    31fa:	1d250513          	addi	a0,a0,466 # 73c8 <malloc+0x16f8>
    31fe:	00003097          	auipc	ra,0x3
    3202:	a14080e7          	jalr	-1516(ra) # 5c12 <printf>
    exit(1);
    3206:	4505                	li	a0,1
...
0000000000003210 <subdir>:
{
  ...
  unlink("ff");
    ...
    3222:	2f250513          	addi	a0,a0,754 # 7510 <malloc+0x1840>
    3226:	00002097          	auipc	ra,0x2
    322a:	67c080e7          	jalr	1660(ra) # 58a2 <unlink>
  if(mkdir("dd") != 0){
    322e:	00004517          	auipc	a0,0x4
    3232:	1b250513          	addi	a0,a0,434 # 73e0 <malloc+0x1710>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	1ba50513          	addi	a0,a0,442 # 7400 <malloc+0x1730>
  ...
  write(fd, "ff", 2);
    ...
    3262:	2b258593          	addi	a1,a1,690 # 7510 <malloc+0x1840>
  ...
  if(unlink("dd") >= 0){
    ...
    327c:	16850513          	addi	a0,a0,360 # 73e0 <malloc+0x1710>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	1cc50513          	addi	a0,a0,460 # 7458 <malloc+0x1788>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	1dc50513          	addi	a0,a0,476 # 7480 <malloc+0x17b0>
  ...
  write(fd, "FF", 2);
    ...
    32c0:	1f458593          	addi	a1,a1,500 # 74b0 <malloc+0x17e0>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32dc:	1e050513          	addi	a0,a0,480 # 74b8 <malloc+0x17e8>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	ae858593          	addi	a1,a1,-1304 # bdd8 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330a:	ad274703          	lbu	a4,-1326(a4) # bdd8 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3324:	1e858593          	addi	a1,a1,488 # 7508 <malloc+0x1838>
    3328:	00004517          	auipc	a0,0x4
    332c:	15850513          	addi	a0,a0,344 # 7480 <malloc+0x17b0>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	14450513          	addi	a0,a0,324 # 7480 <malloc+0x17b0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	12e50513          	addi	a0,a0,302 # 7480 <malloc+0x17b0>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	07a50513          	addi	a0,a0,122 # 73e0 <malloc+0x1710>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	22650513          	addi	a0,a0,550 # 75a0 <malloc+0x18d0>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	24250513          	addi	a0,a0,578 # 75d0 <malloc+0x1900>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	25e50513          	addi	a0,a0,606 # 7600 <malloc+0x1930>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	15050513          	addi	a0,a0,336 # 7508 <malloc+0x1838>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d4:	a0858593          	addi	a1,a1,-1528 # bdd8 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f6:	08e50513          	addi	a0,a0,142 # 7480 <malloc+0x17b0>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	28650513          	addi	a0,a0,646 # 7690 <malloc+0x19c0>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	29e50513          	addi	a0,a0,670 # 76c0 <malloc+0x19f0>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	fa650513          	addi	a0,a0,-90 # 73e0 <malloc+0x1710>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	f9050513          	addi	a0,a0,-112 # 73e0 <malloc+0x1710>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	f7a50513          	addi	a0,a0,-134 # 73e0 <malloc+0x1710>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347e:	2d658593          	addi	a1,a1,726 # 7750 <malloc+0x1a80>
    3482:	00004517          	auipc	a0,0x4
    3486:	20e50513          	addi	a0,a0,526 # 7690 <malloc+0x19c0>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349a:	2ba58593          	addi	a1,a1,698 # 7750 <malloc+0x1a80>
    349e:	00004517          	auipc	a0,0x4
    34a2:	22250513          	addi	a0,a0,546 # 76c0 <malloc+0x19f0>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b6:	05658593          	addi	a1,a1,86 # 7508 <malloc+0x1838>
    34ba:	00004517          	auipc	a0,0x4
    34be:	f4650513          	addi	a0,a0,-186 # 7400 <malloc+0x1730>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	1c250513          	addi	a0,a0,450 # 7690 <malloc+0x19c0>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	1de50513          	addi	a0,a0,478 # 76c0 <malloc+0x19f0>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	01250513          	addi	a0,a0,18 # 7508 <malloc+0x1838>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	1b650513          	addi	a0,a0,438 # 76c0 <malloc+0x19f0>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	17250513          	addi	a0,a0,370 # 7690 <malloc+0x19c0>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	ece50513          	addi	a0,a0,-306 # 7400 <malloc+0x1730>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	35a50513          	addi	a0,a0,858 # 78a0 <malloc+0x1bd0>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	fae50513          	addi	a0,a0,-82 # 7508 <malloc+0x1838>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	e9250513          	addi	a0,a0,-366 # 7400 <malloc+0x1730>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	e5e50513          	addi	a0,a0,-418 # 73e0 <malloc+0x1710>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	37a50513          	addi	a0,a0,890 # 7910 <malloc+0x1c40>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	e3650513          	addi	a0,a0,-458 # 73e0 <malloc+0x1710>
    ...
    35d0:	e1c50513          	addi	a0,a0,-484 # 73e8 <malloc+0x1718>
    35d4:	00002097          	auipc	ra,0x2
    35d8:	63e080e7          	jalr	1598(ra) # 5c12 <printf>
    exit(1);
    35dc:	4505                	li	a0,1
    ...
    35ec:	e2050513          	addi	a0,a0,-480 # 7408 <malloc+0x1738>
    35f0:	00002097          	auipc	ra,0x2
    35f4:	622080e7          	jalr	1570(ra) # 5c12 <printf>
    exit(1);
    35f8:	4505                	li	a0,1
    ...
    3608:	e2450513          	addi	a0,a0,-476 # 7428 <malloc+0x1758>
    360c:	00002097          	auipc	ra,0x2
    3610:	606080e7          	jalr	1542(ra) # 5c12 <printf>
    exit(1);
    3614:	4505                	li	a0,1
    ...
    3624:	e4050513          	addi	a0,a0,-448 # 7460 <malloc+0x1790>
    3628:	00002097          	auipc	ra,0x2
    362c:	5ea080e7          	jalr	1514(ra) # 5c12 <printf>
    exit(1);
    3630:	4505                	li	a0,1
    ...
    3640:	e5450513          	addi	a0,a0,-428 # 7490 <malloc+0x17c0>
    3644:	00002097          	auipc	ra,0x2
    3648:	5ce080e7          	jalr	1486(ra) # 5c12 <printf>
    exit(1);
    364c:	4505                	li	a0,1
    ...
    365c:	e7050513          	addi	a0,a0,-400 # 74c8 <malloc+0x17f8>
    3660:	00002097          	auipc	ra,0x2
    3664:	5b2080e7          	jalr	1458(ra) # 5c12 <printf>
    exit(1);
    3668:	4505                	li	a0,1
    ...
    3678:	e7450513          	addi	a0,a0,-396 # 74e8 <malloc+0x1818>
    367c:	00002097          	auipc	ra,0x2
    3680:	596080e7          	jalr	1430(ra) # 5c12 <printf>
    exit(1);
    3684:	4505                	li	a0,1
    ...
    3694:	e8850513          	addi	a0,a0,-376 # 7518 <malloc+0x1848>
    3698:	00002097          	auipc	ra,0x2
    369c:	57a080e7          	jalr	1402(ra) # 5c12 <printf>
    exit(1);
    36a0:	4505                	li	a0,1
    ...
    36b0:	e9450513          	addi	a0,a0,-364 # 7540 <malloc+0x1870>
    36b4:	00002097          	auipc	ra,0x2
    36b8:	55e080e7          	jalr	1374(ra) # 5c12 <printf>
    exit(1);
    36bc:	4505                	li	a0,1
    ...
    36cc:	e9850513          	addi	a0,a0,-360 # 7560 <malloc+0x1890>
    36d0:	00002097          	auipc	ra,0x2
    36d4:	542080e7          	jalr	1346(ra) # 5c12 <printf>
    exit(1);
    36d8:	4505                	li	a0,1
    ...
    36e8:	ea450513          	addi	a0,a0,-348 # 7588 <malloc+0x18b8>
    36ec:	00002097          	auipc	ra,0x2
    36f0:	526080e7          	jalr	1318(ra) # 5c12 <printf>
    exit(1);
    36f4:	4505                	li	a0,1
    ...
    3704:	eb050513          	addi	a0,a0,-336 # 75b0 <malloc+0x18e0>
    3708:	00002097          	auipc	ra,0x2
    370c:	50a080e7          	jalr	1290(ra) # 5c12 <printf>
    exit(1);
    3710:	4505                	li	a0,1
    ...
    3720:	ec450513          	addi	a0,a0,-316 # 75e0 <malloc+0x1910>
    3724:	00002097          	auipc	ra,0x2
    3728:	4ee080e7          	jalr	1262(ra) # 5c12 <printf>
    exit(1);
    372c:	4505                	li	a0,1
    ...
    373c:	ed050513          	addi	a0,a0,-304 # 7608 <malloc+0x1938>
    3740:	00002097          	auipc	ra,0x2
    3744:	4d2080e7          	jalr	1234(ra) # 5c12 <printf>
    exit(1);
    3748:	4505                	li	a0,1
    ...
    3758:	ecc50513          	addi	a0,a0,-308 # 7620 <malloc+0x1950>
    375c:	00002097          	auipc	ra,0x2
    3760:	4b6080e7          	jalr	1206(ra) # 5c12 <printf>
    exit(1);
    3764:	4505                	li	a0,1
    ...
    3774:	ed050513          	addi	a0,a0,-304 # 7640 <malloc+0x1970>
    3778:	00002097          	auipc	ra,0x2
    377c:	49a080e7          	jalr	1178(ra) # 5c12 <printf>
    exit(1);
    3780:	4505                	li	a0,1
    ...
    3790:	ed450513          	addi	a0,a0,-300 # 7660 <malloc+0x1990>
    3794:	00002097          	auipc	ra,0x2
    3798:	47e080e7          	jalr	1150(ra) # 5c12 <printf>
    exit(1);
    379c:	4505                	li	a0,1
    ...
    37ac:	ef850513          	addi	a0,a0,-264 # 76a0 <malloc+0x19d0>
    37b0:	00002097          	auipc	ra,0x2
    37b4:	462080e7          	jalr	1122(ra) # 5c12 <printf>
    exit(1);
    37b8:	4505                	li	a0,1
    ...
    37c8:	f0c50513          	addi	a0,a0,-244 # 76d0 <malloc+0x1a00>
    37cc:	00002097          	auipc	ra,0x2
    37d0:	446080e7          	jalr	1094(ra) # 5c12 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e4:	f1050513          	addi	a0,a0,-240 # 76f0 <malloc+0x1a20>
    37e8:	00002097          	auipc	ra,0x2
    37ec:	42a080e7          	jalr	1066(ra) # 5c12 <printf>
    exit(1);
    37f0:	4505                	li	a0,1
    ...
    3800:	f1450513          	addi	a0,a0,-236 # 7710 <malloc+0x1a40>
    3804:	00002097          	auipc	ra,0x2
    3808:	40e080e7          	jalr	1038(ra) # 5c12 <printf>
    exit(1);
    380c:	4505                	li	a0,1
    ...
    381c:	f1850513          	addi	a0,a0,-232 # 7730 <malloc+0x1a60>
    3820:	00002097          	auipc	ra,0x2
    3824:	3f2080e7          	jalr	1010(ra) # 5c12 <printf>
    exit(1);
    3828:	4505                	li	a0,1
    ...
    3838:	f2c50513          	addi	a0,a0,-212 # 7760 <malloc+0x1a90>
    383c:	00002097          	auipc	ra,0x2
    3840:	3d6080e7          	jalr	982(ra) # 5c12 <printf>
    exit(1);
    3844:	4505                	li	a0,1
    ...
    3854:	f3850513          	addi	a0,a0,-200 # 7788 <malloc+0x1ab8>
    3858:	00002097          	auipc	ra,0x2
    385c:	3ba080e7          	jalr	954(ra) # 5c12 <printf>
    exit(1);
    3860:	4505                	li	a0,1
    ...
    3870:	f4450513          	addi	a0,a0,-188 # 77b0 <malloc+0x1ae0>
    3874:	00002097          	auipc	ra,0x2
    3878:	39e080e7          	jalr	926(ra) # 5c12 <printf>
    exit(1);
    387c:	4505                	li	a0,1
    ...
    388c:	f5050513          	addi	a0,a0,-176 # 77d8 <malloc+0x1b08>
    3890:	00002097          	auipc	ra,0x2
    3894:	382080e7          	jalr	898(ra) # 5c12 <printf>
    exit(1);
    3898:	4505                	li	a0,1
    ...
    38a8:	f5450513          	addi	a0,a0,-172 # 77f8 <malloc+0x1b28>
    38ac:	00002097          	auipc	ra,0x2
    38b0:	366080e7          	jalr	870(ra) # 5c12 <printf>
    exit(1);
    38b4:	4505                	li	a0,1
    ...
    38c4:	f5850513          	addi	a0,a0,-168 # 7818 <malloc+0x1b48>
    38c8:	00002097          	auipc	ra,0x2
    38cc:	34a080e7          	jalr	842(ra) # 5c12 <printf>
    exit(1);
    38d0:	4505                	li	a0,1
    ...
    38e0:	f6450513          	addi	a0,a0,-156 # 7840 <malloc+0x1b70>
    38e4:	00002097          	auipc	ra,0x2
    38e8:	32e080e7          	jalr	814(ra) # 5c12 <printf>
    exit(1);
    38ec:	4505                	li	a0,1
    ...
    38fc:	f6850513          	addi	a0,a0,-152 # 7860 <malloc+0x1b90>
    3900:	00002097          	auipc	ra,0x2
    3904:	312080e7          	jalr	786(ra) # 5c12 <printf>
    exit(1);
    3908:	4505                	li	a0,1
    ...
    3918:	f6c50513          	addi	a0,a0,-148 # 7880 <malloc+0x1bb0>
    391c:	00002097          	auipc	ra,0x2
    3920:	2f6080e7          	jalr	758(ra) # 5c12 <printf>
    exit(1);
    3924:	4505                	li	a0,1
    ...
    3934:	f7850513          	addi	a0,a0,-136 # 78a8 <malloc+0x1bd8>
    3938:	00002097          	auipc	ra,0x2
    393c:	2da080e7          	jalr	730(ra) # 5c12 <printf>
    exit(1);
    3940:	4505                	li	a0,1
    ...
    3950:	bf450513          	addi	a0,a0,-1036 # 7540 <malloc+0x1870>
    3954:	00002097          	auipc	ra,0x2
    3958:	2be080e7          	jalr	702(ra) # 5c12 <printf>
    exit(1);
    395c:	4505                	li	a0,1
    ...
    396c:	f6050513          	addi	a0,a0,-160 # 78c8 <malloc+0x1bf8>
    3970:	00002097          	auipc	ra,0x2
    3974:	2a2080e7          	jalr	674(ra) # 5c12 <printf>
    exit(1);
    3978:	4505                	li	a0,1
    ...
    3988:	f6450513          	addi	a0,a0,-156 # 78e8 <malloc+0x1c18>
    398c:	00002097          	auipc	ra,0x2
    3990:	286080e7          	jalr	646(ra) # 5c12 <printf>
    exit(1);
    3994:	4505                	li	a0,1
    ...
    39a4:	f7850513          	addi	a0,a0,-136 # 7918 <malloc+0x1c48>
    39a8:	00002097          	auipc	ra,0x2
    39ac:	26a080e7          	jalr	618(ra) # 5c12 <printf>
    exit(1);
    39b0:	4505                	li	a0,1
    ...
    39c0:	f7c50513          	addi	a0,a0,-132 # 7938 <malloc+0x1c68>
    39c4:	00002097          	auipc	ra,0x2
    39c8:	24e080e7          	jalr	590(ra) # 5c12 <printf>
    exit(1);
    39cc:	4505                	li	a0,1
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	f6e50513          	addi	a0,a0,-146 # 7950 <malloc+0x1c80>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	f5c50513          	addi	a0,a0,-164 # 7950 <malloc+0x1c80>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	de250513          	addi	a0,a0,-542 # 67e8 <malloc+0xb18>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	99050513          	addi	a0,a0,-1648 # 73a8 <malloc+0x16d8>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	92650513          	addi	a0,a0,-1754 # 7350 <malloc+0x1680>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	f7c50513          	addi	a0,a0,-132 # 79b8 <malloc+0x1ce8>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	f9250513          	addi	a0,a0,-110 # 79e0 <malloc+0x1d10>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	ef050513          	addi	a0,a0,-272 # 7950 <malloc+0x1c80>
    ...
    3a82:	eda50513          	addi	a0,a0,-294 # 7958 <malloc+0x1c88>
    3a86:	00002097          	auipc	ra,0x2
    3a8a:	18c080e7          	jalr	396(ra) # 5c12 <printf>
    exit(1);
    3a8e:	4505                	li	a0,1
    ...
    3a9e:	ed650513          	addi	a0,a0,-298 # 7970 <malloc+0x1ca0>
    3aa2:	00002097          	auipc	ra,0x2
    3aa6:	170080e7          	jalr	368(ra) # 5c12 <printf>
    exit(1);
    3aaa:	4505                	li	a0,1
    ...
    3aba:	ed250513          	addi	a0,a0,-302 # 7988 <malloc+0x1cb8>
    3abe:	00002097          	auipc	ra,0x2
    3ac2:	154080e7          	jalr	340(ra) # 5c12 <printf>
    exit(1);
    3ac6:	4505                	li	a0,1
    ...
    3ad6:	ece50513          	addi	a0,a0,-306 # 79a0 <malloc+0x1cd0>
    3ada:	00002097          	auipc	ra,0x2
    3ade:	138080e7          	jalr	312(ra) # 5c12 <printf>
    exit(1);
    3ae2:	4505                	li	a0,1
    ...
    3af2:	86a50513          	addi	a0,a0,-1942 # 7358 <malloc+0x1688>
    3af6:	00002097          	auipc	ra,0x2
    3afa:	11c080e7          	jalr	284(ra) # 5c12 <printf>
    exit(1);
    3afe:	4505                	li	a0,1
    ...
    3b0e:	eb650513          	addi	a0,a0,-330 # 79c0 <malloc+0x1cf0>
    3b12:	00002097          	auipc	ra,0x2
    3b16:	100080e7          	jalr	256(ra) # 5c12 <printf>
    exit(1);
    3b1a:	4505                	li	a0,1
    ...
    3b2a:	ec250513          	addi	a0,a0,-318 # 79e8 <malloc+0x1d18>
    3b2e:	00002097          	auipc	ra,0x2
    3b32:	0e4080e7          	jalr	228(ra) # 5c12 <printf>
    exit(1);
    3b36:	4505                	li	a0,1
    ...
    3b46:	ec650513          	addi	a0,a0,-314 # 7a08 <malloc+0x1d38>
    3b4a:	00002097          	auipc	ra,0x2
    3b4e:	0c8080e7          	jalr	200(ra) # 5c12 <printf>
    exit(1);
    3b52:	4505                	li	a0,1
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b72:	58250513          	addi	a0,a0,1410 # 60f0 <malloc+0x420>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8e:	56650513          	addi	a0,a0,1382 # 60f0 <malloc+0x420>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	eca50513          	addi	a0,a0,-310 # 7a68 <malloc+0x1d98>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	eb250513          	addi	a0,a0,-334 # 7a68 <malloc+0x1d98>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	e9e50513          	addi	a0,a0,-354 # 7a68 <malloc+0x1d98>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	e8a50513          	addi	a0,a0,-374 # 7a68 <malloc+0x1d98>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf6:	e7658593          	addi	a1,a1,-394 # 7a68 <malloc+0x1d98>
    3bfa:	00002517          	auipc	a0,0x2
    3bfe:	6ee50513          	addi	a0,a0,1774 # 62e8 <malloc+0x618>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	4e250513          	addi	a0,a0,1250 # 60f0 <malloc+0x420>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	bc450513          	addi	a0,a0,-1084 # 67e8 <malloc+0xb18>
  ...
  fd = open(".", 0);
    ...
    3c3e:	bae50513          	addi	a0,a0,-1106 # 67e8 <malloc+0xb18>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c52:	57258593          	addi	a1,a1,1394 # 61c0 <malloc+0x4f0>
  ...
  close(fd);
    ...
    3c7e:	dae50513          	addi	a0,a0,-594 # 7a28 <malloc+0x1d58>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	f90080e7          	jalr	-112(ra) # 5c12 <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	db250513          	addi	a0,a0,-590 # 7a48 <malloc+0x1d78>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	f74080e7          	jalr	-140(ra) # 5c12 <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	dc650513          	addi	a0,a0,-570 # 7a78 <malloc+0x1da8>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	f58080e7          	jalr	-168(ra) # 5c12 <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	daa50513          	addi	a0,a0,-598 # 7a78 <malloc+0x1da8>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	f3c080e7          	jalr	-196(ra) # 5c12 <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	db650513          	addi	a0,a0,-586 # 7aa0 <malloc+0x1dd0>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	f20080e7          	jalr	-224(ra) # 5c12 <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	dc250513          	addi	a0,a0,-574 # 7ac8 <malloc+0x1df8>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	f04080e7          	jalr	-252(ra) # 5c12 <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	dce50513          	addi	a0,a0,-562 # 7af0 <malloc+0x1e20>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	ee8080e7          	jalr	-280(ra) # 5c12 <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	dda50513          	addi	a0,a0,-550 # 7b18 <malloc+0x1e48>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	ecc080e7          	jalr	-308(ra) # 5c12 <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	dde50513          	addi	a0,a0,-546 # 7b38 <malloc+0x1e68>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	eb0080e7          	jalr	-336(ra) # 5c12 <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	dea50513          	addi	a0,a0,-534 # 7b60 <malloc+0x1e90>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	e94080e7          	jalr	-364(ra) # 5c12 <printf>
    exit(1);
    3d86:	4505                	li	a0,1
...
0000000000003d90 <iref>:
{
    ...
    3dae:	dcea0a13          	addi	s4,s4,-562 # 7b78 <malloc+0x1ea8>
    mkdir("");
    3db2:	00004497          	auipc	s1,0x4
    3db6:	8d648493          	addi	s1,s1,-1834 # 7688 <malloc+0x19b8>
    link("README", "");
    3dba:	00002a97          	auipc	s5,0x2
    3dbe:	52ea8a93          	addi	s5,s5,1326 # 62e8 <malloc+0x618>
    fd = open("xx", O_CREATE);
    3dc2:	00004997          	auipc	s3,0x4
    3dc6:	cae98993          	addi	s3,s3,-850 # 7a70 <malloc+0x1da0>
    3dca:	a891                	j	3e1e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dcc:	85da                	mv	a1,s6
    3dce:	00004517          	auipc	a0,0x4
    3dd2:	db250513          	addi	a0,a0,-590 # 7b80 <malloc+0x1eb0>
    3dd6:	00002097          	auipc	ra,0x2
    3dda:	e3c080e7          	jalr	-452(ra) # 5c12 <printf>
      exit(1);
    3dde:	4505                	li	a0,1
    ...
    3dee:	dae50513          	addi	a0,a0,-594 # 7b98 <malloc+0x1ec8>
    3df2:	00002097          	auipc	ra,0x2
    3df6:	e20080e7          	jalr	-480(ra) # 5c12 <printf>
      exit(1);
    3dfa:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e82:	52a98993          	addi	s3,s3,1322 # 73a8 <malloc+0x16d8>
    unlink("irefd");
    3e86:	00004917          	auipc	s2,0x4
    3e8a:	cf290913          	addi	s2,s2,-782 # 7b78 <malloc+0x1ea8>
    chdir("..");
    3e8e:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eaa:	4aa50513          	addi	a0,a0,1194 # 7350 <malloc+0x1680>
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	cda50513          	addi	a0,a0,-806 # 7bb0 <malloc+0x1ee0>
  ...
  if(pid == 0){
    ...
    3efe:	cb650513          	addi	a0,a0,-842 # 7bb0 <malloc+0x1ee0>
    ...
    3f14:	cc050513          	addi	a0,a0,-832 # 7bd0 <malloc+0x1f00>
    3f18:	00002097          	auipc	ra,0x2
    3f1c:	cfa080e7          	jalr	-774(ra) # 5c12 <printf>
      exit(1);
    3f20:	4505                	li	a0,1
    ...
    3f30:	c8c50513          	addi	a0,a0,-884 # 7bb8 <malloc+0x1ee8>
    3f34:	00002097          	auipc	ra,0x2
    3f38:	cde080e7          	jalr	-802(ra) # 5c12 <printf>
    exit(1);
    3f3c:	4505                	li	a0,1
    ...
    3f4c:	a4050513          	addi	a0,a0,-1472 # 6988 <malloc+0xcb8>
    3f50:	00002097          	auipc	ra,0x2
    3f54:	cc2080e7          	jalr	-830(ra) # 5c12 <printf>
    exit(1);
    3f58:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f7a:	c3a50513          	addi	a0,a0,-966 # 7bb0 <malloc+0x1ee0>
    ...
    3f8e:	bee50513          	addi	a0,a0,-1042 # 6b78 <malloc+0xea8>
    3f92:	00002097          	auipc	ra,0x2
    3f96:	c80080e7          	jalr	-896(ra) # 5c12 <printf>
    exit(1);
    3f9a:	4505                	li	a0,1
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	c3050513          	addi	a0,a0,-976 # 7bf8 <malloc+0x1f28>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	c0450513          	addi	a0,a0,-1020 # 7bf8 <malloc+0x1f28>
  ...
  sleep(10); // one second
    ...
    4030:	b1c50513          	addi	a0,a0,-1252 # 6b48 <malloc+0xe78>
    4034:	00002097          	auipc	ra,0x2
    4038:	bde080e7          	jalr	-1058(ra) # 5c12 <printf>
    exit(1);
    403c:	4505                	li	a0,1
    ...
    404a:	bb248493          	addi	s1,s1,-1102 # 7bf8 <malloc+0x1f28>
    404e:	4581                	li	a1,0
    4050:	8526                	mv	a0,s1
...
000000000000408c <killstatus>:
{
  ...
  exit(0);
    ...
    40f2:	89a50513          	addi	a0,a0,-1894 # 6988 <malloc+0xcb8>
    40f6:	00002097          	auipc	ra,0x2
    40fa:	b1c080e7          	jalr	-1252(ra) # 5c12 <printf>
      exit(1);
    40fe:	4505                	li	a0,1
    ...
    4118:	af450513          	addi	a0,a0,-1292 # 7c08 <malloc+0x1f38>
    411c:	00002097          	auipc	ra,0x2
    4120:	af6080e7          	jalr	-1290(ra) # 5c12 <printf>
       exit(1);
    4124:	4505                	li	a0,1
...
000000000000412e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4158:	9f450513          	addi	a0,a0,-1548 # 6b48 <malloc+0xe78>
    415c:	00002097          	auipc	ra,0x2
    4160:	ab6080e7          	jalr	-1354(ra) # 5c12 <printf>
    exit(1);
    4164:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4186:	80650513          	addi	a0,a0,-2042 # 6988 <malloc+0xcb8>
    418a:	00002097          	auipc	ra,0x2
    418e:	a88080e7          	jalr	-1400(ra) # 5c12 <printf>
    exit(1);
    4192:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41ca:	ffa58593          	addi	a1,a1,-6 # 61c0 <malloc+0x4f0>
    ...
    41f4:	79850513          	addi	a0,a0,1944 # 6988 <malloc+0xcb8>
    41f8:	00002097          	auipc	ra,0x2
    41fc:	a1a080e7          	jalr	-1510(ra) # 5c12 <printf>
     exit(1);
    4200:	4505                	li	a0,1
    ...
    4210:	a1c50513          	addi	a0,a0,-1508 # 7c28 <malloc+0x1f58>
    4214:	00002097          	auipc	ra,0x2
    4218:	9fe080e7          	jalr	-1538(ra) # 5c12 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4230:	bac58593          	addi	a1,a1,-1108 # bdd8 <buf>
    ...
    424c:	9f850513          	addi	a0,a0,-1544 # 7c40 <malloc+0x1f70>
    4250:	00002097          	auipc	ra,0x2
    4254:	9c2080e7          	jalr	-1598(ra) # 5c12 <printf>
}
  ...
  printf("kill... ");
    ...
    4278:	9e450513          	addi	a0,a0,-1564 # 7c58 <malloc+0x1f88>
    427c:	00002097          	auipc	ra,0x2
    4280:	996080e7          	jalr	-1642(ra) # 5c12 <printf>
  kill(pid1);
    4284:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    42a6:	9c650513          	addi	a0,a0,-1594 # 7c68 <malloc+0x1f98>
    42aa:	00002097          	auipc	ra,0x2
    42ae:	968080e7          	jalr	-1688(ra) # 5c12 <printf>
  wait(0);
    42b2:	4501                	li	a0,0
...
00000000000042d2 <reparent>:
{
  ...
  exit(0);
    ...
    4326:	66650513          	addi	a0,a0,1638 # 6988 <malloc+0xcb8>
    432a:	00002097          	auipc	ra,0x2
    432e:	8e8080e7          	jalr	-1816(ra) # 5c12 <printf>
      exit(1);
    4332:	4505                	li	a0,1
    ...
    4342:	7d250513          	addi	a0,a0,2002 # 6b10 <malloc+0xe40>
    4346:	00002097          	auipc	ra,0x2
    434a:	8cc080e7          	jalr	-1844(ra) # 5c12 <printf>
        exit(1);
    434e:	4505                	li	a0,1
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b8:	6dc50513          	addi	a0,a0,1756 # 6a90 <malloc+0xdc0>
    43bc:	00002097          	auipc	ra,0x2
    43c0:	856080e7          	jalr	-1962(ra) # 5c12 <printf>
    exit(1);
    43c4:	4505                	li	a0,1
    ...
    43ee:	dd658593          	addi	a1,a1,-554 # 61c0 <malloc+0x4f0>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b2:	7ca50513          	addi	a0,a0,1994 # 7c78 <malloc+0x1fa8>
    44b6:	00001097          	auipc	ra,0x1
    44ba:	75c080e7          	jalr	1884(ra) # 5c12 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	4be50513          	addi	a0,a0,1214 # 6988 <malloc+0xcb8>
    44d2:	00001097          	auipc	ra,0x1
    44d6:	740080e7          	jalr	1856(ra) # 5c12 <printf>
    exit(1);
    44da:	4505                	li	a0,1
    ...
    451a:	78250513          	addi	a0,a0,1922 # 7c98 <malloc+0x1fc8>
    451e:	00001097          	auipc	ra,0x1
    4522:	6f4080e7          	jalr	1780(ra) # 5c12 <printf>
    exit(1);
    4526:	4505                	li	a0,1
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4562:	772080e7          	jalr	1906(ra) # 5cd0 <malloc>
    ...
    45a2:	72a50513          	addi	a0,a0,1834 # 7cc8 <malloc+0x1ff8>
    45a6:	00001097          	auipc	ra,0x1
    45aa:	66c080e7          	jalr	1644(ra) # 5c12 <printf>
      exit(1);
    45ae:	4505                	li	a0,1
...
00000000000045e0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4676:	67650513          	addi	a0,a0,1654 # 7ce8 <malloc+0x2018>
    467a:	00001097          	auipc	ra,0x1
    467e:	598080e7          	jalr	1432(ra) # 5c12 <printf>
    exit(1);
    4682:	4505                	li	a0,1
    ...
    4692:	68250513          	addi	a0,a0,1666 # 7d10 <malloc+0x2040>
    4696:	00001097          	auipc	ra,0x1
    469a:	57c080e7          	jalr	1404(ra) # 5c12 <printf>
      exit(1);
    469e:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d6:	88e50513          	addi	a0,a0,-1906 # 5f60 <malloc+0x290>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4716:	61e50513          	addi	a0,a0,1566 # 7d30 <malloc+0x2060>
    471a:	00001097          	auipc	ra,0x1
    471e:	4f8080e7          	jalr	1272(ra) # 5c12 <printf>
    exit(1);
    4722:	4505                	li	a0,1
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1218>
  ...
  unlink("sharedfd");
    ...
    4752:	81250513          	addi	a0,a0,-2030 # 5f60 <malloc+0x290>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4778:	5e450513          	addi	a0,a0,1508 # 7d58 <malloc+0x2088>
    477c:	00001097          	auipc	ra,0x1
    4780:	496080e7          	jalr	1174(ra) # 5c12 <printf>
    exit(1);
    4784:	4505                	li	a0,1
...
0000000000004798 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47bc:	60078793          	addi	a5,a5,1536 # 5db8 <malloc+0xe8>
    47c0:	f6f43823          	sd	a5,-144(s0)
    47c4:	00001797          	auipc	a5,0x1
    47c8:	5fc78793          	addi	a5,a5,1532 # 5dc0 <malloc+0xf0>
    47cc:	f6f43c23          	sd	a5,-136(s0)
    47d0:	00001797          	auipc	a5,0x1
    47d4:	5f878793          	addi	a5,a5,1528 # 5dc8 <malloc+0xf8>
    47d8:	f8f43023          	sd	a5,-128(s0)
    47dc:	00001797          	auipc	a5,0x1
    47e0:	5f478793          	addi	a5,a5,1524 # 5dd0 <malloc+0x100>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483a:	5a2a0a13          	addi	s4,s4,1442 # bdd8 <buf>
    483e:	00007a97          	auipc	s5,0x7
    4842:	59ba8a93          	addi	s5,s5,1435 # bdd9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4858:	55450513          	addi	a0,a0,1364 # 6da8 <malloc+0x10d8>
    485c:	00001097          	auipc	ra,0x1
    4860:	3b6080e7          	jalr	950(ra) # 5c12 <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    48d2:	4a250513          	addi	a0,a0,1186 # 7d70 <malloc+0x20a0>
    48d6:	00001097          	auipc	ra,0x1
    48da:	33c080e7          	jalr	828(ra) # 5c12 <printf>
        exit(1);
    48de:	4505                	li	a0,1
    ...
    48ec:	49850513          	addi	a0,a0,1176 # 7d80 <malloc+0x20b0>
    48f0:	00001097          	auipc	ra,0x1
    48f4:	322080e7          	jalr	802(ra) # 5c12 <printf>
          exit(1);
    48f8:	4505                	li	a0,1
    ...
    4910:	48c50513          	addi	a0,a0,1164 # 7d98 <malloc+0x20c8>
    4914:	00001097          	auipc	ra,0x1
    4918:	2fe080e7          	jalr	766(ra) # 5c12 <printf>
          exit(1);
    491c:	4505                	li	a0,1
    ...
    4940:	49c78793          	addi	a5,a5,1180 # bdd8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	40c50513          	addi	a0,a0,1036 # 7da8 <malloc+0x20d8>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	26e080e7          	jalr	622(ra) # 5c12 <printf>
      exit(1);
    49ac:	4505                	li	a0,1
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	3c2b8b93          	addi	s7,s7,962 # 7dc0 <malloc+0x20f0>
  for(i = 0; i < N; i++){
    ...
    4a44:	38850513          	addi	a0,a0,904 # 7dc8 <malloc+0x20f8>
    4a48:	00001097          	auipc	ra,0x1
    4a4c:	1ca080e7          	jalr	458(ra) # 5c12 <printf>
        exit(1);
    4a50:	4505                	li	a0,1
    ...
    4a62:	36250513          	addi	a0,a0,866 # 7dc0 <malloc+0x20f0>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d5250513          	addi	a0,a0,-686 # 67e8 <malloc+0xb18>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac0:	32c50513          	addi	a0,a0,812 # 7de8 <malloc+0x2118>
    4ac4:	00001097          	auipc	ra,0x1
    4ac8:	14e080e7          	jalr	334(ra) # 5c12 <printf>
        exit(1);
    4acc:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b30:	2dc50513          	addi	a0,a0,732 # 7e08 <malloc+0x2138>
    4b34:	00001097          	auipc	ra,0x1
    4b38:	0de080e7          	jalr	222(ra) # 5c12 <printf>
        exit(1);
    4b3c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	2cc50513          	addi	a0,a0,716 # 7e30 <malloc+0x2160>
    4b6c:	00001097          	auipc	ra,0x1
    4b70:	0a6080e7          	jalr	166(ra) # 5c12 <printf>
    exit(1);
    4b74:	4505                	li	a0,1
    ...
    4b84:	e0850513          	addi	a0,a0,-504 # 6988 <malloc+0xcb8>
    4b88:	00001097          	auipc	ra,0x1
    4b8c:	08a080e7          	jalr	138(ra) # 5c12 <printf>
      exit(1);
    4b90:	4505                	li	a0,1
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6e:	06e90913          	addi	s2,s2,110 # bdd8 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	0b650513          	addi	a0,a0,182 # 7e68 <malloc+0x2198>
  ...
  for(i = 0; ; i++){
    ...
    4dcc:	01090913          	addi	s2,s2,16 # bdd8 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	06250513          	addi	a0,a0,98 # 7e78 <malloc+0x21a8>
    4e1e:	00001097          	auipc	ra,0x1
    4e22:	df4080e7          	jalr	-524(ra) # 5c12 <printf>
    exit(1);
    4e26:	4505                	li	a0,1
    ...
    4e36:	06650513          	addi	a0,a0,102 # 7e98 <malloc+0x21c8>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	dd8080e7          	jalr	-552(ra) # 5c12 <printf>
      exit(1);
    4e42:	4505                	li	a0,1
    ...
    4e52:	06a50513          	addi	a0,a0,106 # 7eb8 <malloc+0x21e8>
    4e56:	00001097          	auipc	ra,0x1
    4e5a:	dbc080e7          	jalr	-580(ra) # 5c12 <printf>
    exit(1);
    4e5e:	4505                	li	a0,1
    ...
    4e6e:	06e50513          	addi	a0,a0,110 # 7ed8 <malloc+0x2208>
    4e72:	00001097          	auipc	ra,0x1
    4e76:	da0080e7          	jalr	-608(ra) # 5c12 <printf>
      exit(1);
    4e7a:	4505                	li	a0,1
    ...
    4e8a:	07250513          	addi	a0,a0,114 # 7ef8 <malloc+0x2228>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	d84080e7          	jalr	-636(ra) # 5c12 <printf>
      exit(1);
    4e96:	4505                	li	a0,1
    ...
    4ea6:	06e50513          	addi	a0,a0,110 # 7f10 <malloc+0x2240>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	d68080e7          	jalr	-664(ra) # 5c12 <printf>
      exit(1);
    4eb2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	f9850513          	addi	a0,a0,-104 # 7e68 <malloc+0x2198>
    ...
    4ef8:	03c50513          	addi	a0,a0,60 # 7f30 <malloc+0x2260>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	d16080e7          	jalr	-746(ra) # 5c12 <printf>
    exit(1);
    4f04:	4505                	li	a0,1
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	02450513          	addi	a0,a0,36 # 7f50 <malloc+0x2280>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	cde080e7          	jalr	-802(ra) # 5c12 <printf>
  for(nfiles = 0; ; nfiles++){
    4f3c:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f50:	014c8c93          	addi	s9,s9,20 # 7f60 <malloc+0x2290>
    int total = 0;
    4f54:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f56:	00007a17          	auipc	s4,0x7
    4f5a:	e82a0a13          	addi	s4,s4,-382 # bdd8 <buf>
    name[0] = 'f';
    ...
    4fa8:	c6e080e7          	jalr	-914(ra) # 5c12 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fca:	faa50513          	addi	a0,a0,-86 # 7f70 <malloc+0x22a0>
    4fce:	00001097          	auipc	ra,0x1
    4fd2:	c44080e7          	jalr	-956(ra) # 5c12 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f5450513          	addi	a0,a0,-172 # 7f90 <malloc+0x22c0>
    5044:	00001097          	auipc	ra,0x1
    5048:	bce080e7          	jalr	-1074(ra) # 5c12 <printf>
}
    ...
    5090:	ef450513          	addi	a0,a0,-268 # 7f80 <malloc+0x22b0>
    5094:	00001097          	auipc	ra,0x1
    5098:	b7e080e7          	jalr	-1154(ra) # 5c12 <printf>
    close(fd);
    509c:	854a                	mv	a0,s2
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	e8a50513          	addi	a0,a0,-374 # 7fa8 <malloc+0x22d8>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	08a58593          	addi	a1,a1,138 # 61c0 <malloc+0x4f0>
    ...
    5150:	e7c50513          	addi	a0,a0,-388 # 7fc8 <malloc+0x22f8>
    5154:	00001097          	auipc	ra,0x1
    5158:	abe080e7          	jalr	-1346(ra) # 5c12 <printf>
    exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	e4a50513          	addi	a0,a0,-438 # 7fb0 <malloc+0x22e0>
    516e:	00001097          	auipc	ra,0x1
    5172:	aa4080e7          	jalr	-1372(ra) # 5c12 <printf>
      exit(1);
    5176:	4505                	li	a0,1
    ...
    5184:	e3050513          	addi	a0,a0,-464 # 7fb0 <malloc+0x22e0>
    5188:	00001097          	auipc	ra,0x1
    518c:	a8a080e7          	jalr	-1398(ra) # 5c12 <printf>
    exit(1);
    5190:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a8:	e0450513          	addi	a0,a0,-508 # 7fa8 <malloc+0x22d8>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	fc690913          	addi	s2,s2,-58 # 61c0 <malloc+0x4f0>
      uint64 a = (uint64) sbrk(4096);
    ...
    5232:	dea50513          	addi	a0,a0,-534 # 8018 <malloc+0x2348>
    5236:	00001097          	auipc	ra,0x1
    523a:	9dc080e7          	jalr	-1572(ra) # 5c12 <printf>
        exit(1);
    523e:	4505                	li	a0,1
    ...
    524c:	d9050513          	addi	a0,a0,-624 # 7fd8 <malloc+0x2308>
    5250:	00001097          	auipc	ra,0x1
    5254:	9c2080e7          	jalr	-1598(ra) # 5c12 <printf>
    exit(1);
    5258:	4505                	li	a0,1
    ...
    5266:	d9650513          	addi	a0,a0,-618 # 7ff8 <malloc+0x2328>
    526a:	00001097          	auipc	ra,0x1
    526e:	9a8080e7          	jalr	-1624(ra) # 5c12 <printf>
    exit(1);
    5272:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b4:	d8850513          	addi	a0,a0,-632 # 8038 <malloc+0x2368>
    52b8:	00001097          	auipc	ra,0x1
    52bc:	95a080e7          	jalr	-1702(ra) # 5c12 <printf>
      exit(1);
    52c0:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5304:	d5850513          	addi	a0,a0,-680 # 8058 <malloc+0x2388>
    5308:	00001097          	auipc	ra,0x1
    530c:	90a080e7          	jalr	-1782(ra) # 5c12 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5334:	d5050513          	addi	a0,a0,-688 # 8080 <malloc+0x23b0>
    5338:	00001097          	auipc	ra,0x1
    533c:	8da080e7          	jalr	-1830(ra) # 5c12 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5358:	d1450513          	addi	a0,a0,-748 # 8068 <malloc+0x2398>
    535c:	00001097          	auipc	ra,0x1
    5360:	8b6080e7          	jalr	-1866(ra) # 5c12 <printf>
    exit(1);
    5364:	4505                	li	a0,1
    ...
    5380:	d0c50513          	addi	a0,a0,-756 # 8088 <malloc+0x23b8>
    5384:	00001097          	auipc	ra,0x1
    5388:	88e080e7          	jalr	-1906(ra) # 5c12 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ca:	dda78793          	addi	a5,a5,-550 # 81a0 <malloc+0x24d0>
    53ce:	bd040713          	addi	a4,s0,-1072
    53d2:	00003317          	auipc	t1,0x3
    53d6:	1be30313          	addi	t1,t1,446 # 8590 <malloc+0x28c0>
  ...
  printf("usertests starting\n");
    ...
    540a:	d3a50513          	addi	a0,a0,-710 # 8140 <malloc+0x2470>
    540e:	00001097          	auipc	ra,0x1
    5412:	804080e7          	jalr	-2044(ra) # 5c12 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5442:	cba50513          	addi	a0,a0,-838 # 80f8 <malloc+0x2428>
    5446:	00000097          	auipc	ra,0x0
    544a:	7cc080e7          	jalr	1996(ra) # 5c12 <printf>
    exit(1);
    544e:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545e:	c3658593          	addi	a1,a1,-970 # 8090 <malloc+0x23c0>
    ...
    5474:	d0858593          	addi	a1,a1,-760 # 8178 <malloc+0x24a8>
    ...
    5498:	c0450513          	addi	a0,a0,-1020 # 8098 <malloc+0x23c8>
    549c:	00000097          	auipc	ra,0x0
    54a0:	776080e7          	jalr	1910(ra) # 5c12 <printf>
    exit(1);
    54a4:	4505                	li	a0,1
    ...
    54c2:	754080e7          	jalr	1876(ra) # 5c12 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5504:	be050513          	addi	a0,a0,-1056 # 80e0 <malloc+0x2410>
    5508:	00000097          	auipc	ra,0x0
    550c:	70a080e7          	jalr	1802(ra) # 5c12 <printf>
    exit(1);
    5510:	4505                	li	a0,1
    ...
    551e:	c0e50513          	addi	a0,a0,-1010 # 8128 <malloc+0x2458>
    5522:	00000097          	auipc	ra,0x0
    5526:	6f0080e7          	jalr	1776(ra) # 5c12 <printf>
    exit(0);
    552a:	4501                	li	a0,0
    ...
    553a:	6dc080e7          	jalr	1756(ra) # 5c12 <printf>
        if(continuous != 2)
    ...
    557c:	c2878793          	addi	a5,a5,-984 # 81a0 <malloc+0x24d0>
    5580:	bd040713          	addi	a4,s0,-1072
    5584:	00003317          	auipc	t1,0x3
    5588:	00c30313          	addi	t1,t1,12 # 8590 <malloc+0x28c0>
    ...
    55bc:	ba050513          	addi	a0,a0,-1120 # 8158 <malloc+0x2488>
    55c0:	00000097          	auipc	ra,0x0
    55c4:	652080e7          	jalr	1618(ra) # 5c12 <printf>
        printf("SOME TESTS FAILED\n");
    55c8:	00003a97          	auipc	s5,0x3
    55cc:	b18a8a93          	addi	s5,s5,-1256 # 80e0 <malloc+0x2410>
        if(continuous != 2)
    55d0:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d2:	00003b17          	auipc	s6,0x3
    55d6:	aeeb0b13          	addi	s6,s6,-1298 # 80c0 <malloc+0x23f0>
...
putc(int fd, char c)
{
    593a:	1101                	addi	sp,sp,-32
    593c:	ec06                	sd	ra,24(sp)
    593e:	e822                	sd	s0,16(sp)
    5940:	1000                	addi	s0,sp,32
    5942:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5946:	4605                	li	a2,1
    5948:	fef40593          	addi	a1,s0,-17
    594c:	00000097          	auipc	ra,0x0
    5950:	f26080e7          	jalr	-218(ra) # 5872 <write>
}
    5954:	60e2                	ld	ra,24(sp)
    5956:	6442                	ld	s0,16(sp)
    5958:	6105                	addi	sp,sp,32
    595a:	8082                	ret

000000000000595c <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    595c:	7139                	addi	sp,sp,-64
    595e:	fc06                	sd	ra,56(sp)
    5960:	f822                	sd	s0,48(sp)
    5962:	f426                	sd	s1,40(sp)
    5964:	f04a                	sd	s2,32(sp)
    5966:	ec4e                	sd	s3,24(sp)
    5968:	0080                	addi	s0,sp,64
    596a:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    596c:	c299                	beqz	a3,5972 <printint+0x16>
    596e:	0805c863          	bltz	a1,59fe <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5972:	2581                	sext.w	a1,a1
  neg = 0;
    5974:	4881                	li	a7,0
    5976:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    597c:	2601                	sext.w	a2,a2
    597e:	00003517          	auipc	a0,0x3
    5982:	c1a50513          	addi	a0,a0,-998 # 8598 <digits>
    5986:	883a                	mv	a6,a4
    5988:	2705                	addiw	a4,a4,1
    598a:	02c5f7bb          	remuw	a5,a1,a2
    598e:	1782                	slli	a5,a5,0x20
    5990:	9381                	srli	a5,a5,0x20
    5992:	97aa                	add	a5,a5,a0
    5994:	0007c783          	lbu	a5,0(a5)
    5998:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    599c:	0005879b          	sext.w	a5,a1
    59a0:	02c5d5bb          	divuw	a1,a1,a2
    59a4:	0685                	addi	a3,a3,1
    59a6:	fec7f0e3          	bgeu	a5,a2,5986 <printint+0x2a>
  if(neg)
    59aa:	00088b63          	beqz	a7,59c0 <printint+0x64>
    buf[i++] = '-';
    59ae:	fd040793          	addi	a5,s0,-48
    59b2:	973e                	add	a4,a4,a5
    59b4:	02d00793          	li	a5,45
    59b8:	fef70823          	sb	a5,-16(a4)
    59bc:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    59c0:	02e05863          	blez	a4,59f0 <printint+0x94>
    59c4:	fc040793          	addi	a5,s0,-64
    59c8:	00e78933          	add	s2,a5,a4
    59cc:	fff78993          	addi	s3,a5,-1
    59d0:	99ba                	add	s3,s3,a4
    59d2:	377d                	addiw	a4,a4,-1
    59d4:	1702                	slli	a4,a4,0x20
    59d6:	9301                	srli	a4,a4,0x20
    59d8:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    59dc:	fff94583          	lbu	a1,-1(s2)
    59e0:	8526                	mv	a0,s1
    59e2:	00000097          	auipc	ra,0x0
    59e6:	f58080e7          	jalr	-168(ra) # 593a <putc>
  while(--i >= 0)
    59ea:	197d                	addi	s2,s2,-1
    59ec:	ff3918e3          	bne	s2,s3,59dc <printint+0x80>
}
    59f0:	70e2                	ld	ra,56(sp)
    59f2:	7442                	ld	s0,48(sp)
    ...
    59fc:	8082                	ret
    x = -xx;
    59fe:	40b005bb          	negw	a1,a1
    neg = 1;
    5a02:	4885                	li	a7,1
    x = -xx;
    5a04:	bf8d                	j	5976 <printint+0x1a>

0000000000005a06 <vprintf>:
}
...
{
    5a06:	7119                	addi	sp,sp,-128
    5a08:	fc86                	sd	ra,120(sp)
    5a0a:	f8a2                	sd	s0,112(sp)
    5a0c:	f4a6                	sd	s1,104(sp)
    5a0e:	f0ca                	sd	s2,96(sp)
    5a10:	ecce                	sd	s3,88(sp)
    5a12:	e8d2                	sd	s4,80(sp)
    5a14:	e4d6                	sd	s5,72(sp)
    5a16:	e0da                	sd	s6,64(sp)
    5a18:	fc5e                	sd	s7,56(sp)
    5a1a:	f862                	sd	s8,48(sp)
    5a1c:	f466                	sd	s9,40(sp)
    5a1e:	f06a                	sd	s10,32(sp)
    5a20:	ec6e                	sd	s11,24(sp)
    5a22:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5a24:	0005c903          	lbu	s2,0(a1)
    5a28:	18090f63          	beqz	s2,5bc6 <vprintf+0x1c0>
    5a2c:	8aaa                	mv	s5,a0
    5a2e:	8b32                	mv	s6,a2
    5a30:	00158493          	addi	s1,a1,1
  state = 0;
    5a34:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a36:	02500a13          	li	s4,37
      if(c == 'd'){
    5a3a:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5a3e:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5a42:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5a46:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a4a:	00003b97          	auipc	s7,0x3
    5a4e:	b4eb8b93          	addi	s7,s7,-1202 # 8598 <digits>
    5a52:	a839                	j	5a70 <vprintf+0x6a>
        putc(fd, c);
    5a54:	85ca                	mv	a1,s2
    5a56:	8556                	mv	a0,s5
    5a58:	00000097          	auipc	ra,0x0
    5a5c:	ee2080e7          	jalr	-286(ra) # 593a <putc>
    5a60:	a019                	j	5a66 <vprintf+0x60>
    } else if(state == '%'){
    5a62:	01498f63          	beq	s3,s4,5a80 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a66:	0485                	addi	s1,s1,1
    5a68:	fff4c903          	lbu	s2,-1(s1)
    5a6c:	14090d63          	beqz	s2,5bc6 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a70:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a74:	fe0997e3          	bnez	s3,5a62 <vprintf+0x5c>
      if(c == '%'){
    5a78:	fd479ee3          	bne	a5,s4,5a54 <vprintf+0x4e>
        state = '%';
    5a7c:	89be                	mv	s3,a5
    5a7e:	b7e5                	j	5a66 <vprintf+0x60>
      if(c == 'd'){
    5a80:	05878063          	beq	a5,s8,5ac0 <vprintf+0xba>
      } else if(c == 'l') {
    5a84:	05978c63          	beq	a5,s9,5adc <vprintf+0xd6>
      } else if(c == 'x') {
    5a88:	07a78863          	beq	a5,s10,5af8 <vprintf+0xf2>
      } else if(c == 'p') {
    5a8c:	09b78463          	beq	a5,s11,5b14 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5a90:	07300713          	li	a4,115
    5a94:	0ce78663          	beq	a5,a4,5b60 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5a9c:	0ee78e63          	beq	a5,a4,5b98 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5aa0:	11478863          	beq	a5,s4,5bb0 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5aac:	e92080e7          	jalr	-366(ra) # 593a <putc>
        putc(fd, c);
    5ab0:	85ca                	mv	a1,s2
    5ab2:	8556                	mv	a0,s5
    5ab4:	00000097          	auipc	ra,0x0
    5ab8:	e86080e7          	jalr	-378(ra) # 593a <putc>
      }
      state = 0;
    5abc:	4981                	li	s3,0
    5abe:	b765                	j	5a66 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5ad2:	e8e080e7          	jalr	-370(ra) # 595c <printint>
    5ad6:	8b4a                	mv	s6,s2
      state = 0;
    5ad8:	4981                	li	s3,0
    5ada:	b771                	j	5a66 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5adc:	008b0913          	addi	s2,s6,8
    5ae0:	4681                	li	a3,0
    5ae2:	4629                	li	a2,10
    5ae4:	000b2583          	lw	a1,0(s6)
    5ae8:	8556                	mv	a0,s5
    5aea:	00000097          	auipc	ra,0x0
    5aee:	e72080e7          	jalr	-398(ra) # 595c <printint>
    5af2:	8b4a                	mv	s6,s2
      state = 0;
    5af4:	4981                	li	s3,0
    5af6:	bf85                	j	5a66 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5b0a:	e56080e7          	jalr	-426(ra) # 595c <printint>
    5b0e:	8b4a                	mv	s6,s2
      state = 0;
    5b10:	4981                	li	s3,0
    5b12:	bf91                	j	5a66 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5b14:	008b0793          	addi	a5,s6,8
    5b18:	f8f43423          	sd	a5,-120(s0)
    5b1c:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5b20:	03000593          	li	a1,48
    5b24:	8556                	mv	a0,s5
    5b26:	00000097          	auipc	ra,0x0
    5b2a:	e14080e7          	jalr	-492(ra) # 593a <putc>
  putc(fd, 'x');
    5b2e:	85ea                	mv	a1,s10
    5b30:	8556                	mv	a0,s5
    5b32:	00000097          	auipc	ra,0x0
    5b36:	e08080e7          	jalr	-504(ra) # 593a <putc>
    5b3a:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5b3c:	03c9d793          	srli	a5,s3,0x3c
    5b40:	97de                	add	a5,a5,s7
    5b42:	0007c583          	lbu	a1,0(a5)
    5b46:	8556                	mv	a0,s5
    5b48:	00000097          	auipc	ra,0x0
    5b4c:	df2080e7          	jalr	-526(ra) # 593a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b50:	0992                	slli	s3,s3,0x4
    5b52:	397d                	addiw	s2,s2,-1
    5b54:	fe0914e3          	bnez	s2,5b3c <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b58:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b5c:	4981                	li	s3,0
    5b5e:	b721                	j	5a66 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b60:	008b0993          	addi	s3,s6,8
    5b64:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b68:	02090163          	beqz	s2,5b8a <vprintf+0x184>
        while(*s != 0){
    5b6c:	00094583          	lbu	a1,0(s2)
    5b70:	c9a1                	beqz	a1,5bc0 <vprintf+0x1ba>
          putc(fd, *s);
    5b72:	8556                	mv	a0,s5
    5b74:	00000097          	auipc	ra,0x0
    5b78:	dc6080e7          	jalr	-570(ra) # 593a <putc>
          s++;
    5b7c:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b7e:	00094583          	lbu	a1,0(s2)
    5b82:	f9e5                	bnez	a1,5b72 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5b84:	8b4e                	mv	s6,s3
      state = 0;
    5b86:	4981                	li	s3,0
    5b88:	bdf9                	j	5a66 <vprintf+0x60>
          s = "(null)";
    5b8a:	00003917          	auipc	s2,0x3
    5b8e:	a0690913          	addi	s2,s2,-1530 # 8590 <malloc+0x28c0>
        while(*s != 0){
    5b92:	02800593          	li	a1,40
    5b96:	bff1                	j	5b72 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5b98:	008b0913          	addi	s2,s6,8
    5b9c:	000b4583          	lbu	a1,0(s6)
    5ba0:	8556                	mv	a0,s5
    5ba2:	00000097          	auipc	ra,0x0
    5ba6:	d98080e7          	jalr	-616(ra) # 593a <putc>
    5baa:	8b4a                	mv	s6,s2
      state = 0;
    5bac:	4981                	li	s3,0
    5bae:	bd65                	j	5a66 <vprintf+0x60>
        putc(fd, c);
    5bb0:	85d2                	mv	a1,s4
    5bb2:	8556                	mv	a0,s5
    5bb4:	00000097          	auipc	ra,0x0
    5bb8:	d86080e7          	jalr	-634(ra) # 593a <putc>
      state = 0;
    5bbc:	4981                	li	s3,0
    5bbe:	b565                	j	5a66 <vprintf+0x60>
        s = va_arg(ap, char*);
    5bc0:	8b4e                	mv	s6,s3
      state = 0;
    5bc2:	4981                	li	s3,0
    5bc4:	b54d                	j	5a66 <vprintf+0x60>
    }
  }
}
    5bc6:	70e6                	ld	ra,120(sp)
    5bc8:	7446                	ld	s0,112(sp)
    5bca:	74a6                	ld	s1,104(sp)
    5bcc:	7906                	ld	s2,96(sp)
    5bce:	69e6                	ld	s3,88(sp)
    5bd0:	6a46                	ld	s4,80(sp)
    5bd2:	6aa6                	ld	s5,72(sp)
    5bd4:	6b06                	ld	s6,64(sp)
    5bd6:	7be2                	ld	s7,56(sp)
    5bd8:	7c42                	ld	s8,48(sp)
    5bda:	7ca2                	ld	s9,40(sp)
    5bdc:	7d02                	ld	s10,32(sp)
    5bde:	6de2                	ld	s11,24(sp)
    5be0:	6109                	addi	sp,sp,128
    5be2:	8082                	ret

0000000000005be4 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5be4:	715d                	addi	sp,sp,-80
    5be6:	ec06                	sd	ra,24(sp)
    5be8:	e822                	sd	s0,16(sp)
    5bea:	1000                	addi	s0,sp,32
    5bec:	e010                	sd	a2,0(s0)
    5bee:	e414                	sd	a3,8(s0)
    5bf0:	e818                	sd	a4,16(s0)
    5bf2:	ec1c                	sd	a5,24(s0)
    5bf4:	03043023          	sd	a6,32(s0)
    5bf8:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bfc:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5c00:	8622                	mv	a2,s0
    5c02:	00000097          	auipc	ra,0x0
    5c06:	e04080e7          	jalr	-508(ra) # 5a06 <vprintf>
}
    5c0a:	60e2                	ld	ra,24(sp)
    5c0c:	6442                	ld	s0,16(sp)
    5c0e:	6161                	addi	sp,sp,80
    5c10:	8082                	ret

0000000000005c12 <printf>:

void
printf(const char *fmt, ...)
{
    5c12:	711d                	addi	sp,sp,-96
    5c14:	ec06                	sd	ra,24(sp)
    5c16:	e822                	sd	s0,16(sp)
    5c18:	1000                	addi	s0,sp,32
    5c1a:	e40c                	sd	a1,8(s0)
    5c1c:	e810                	sd	a2,16(s0)
    5c1e:	ec14                	sd	a3,24(s0)
    5c20:	f018                	sd	a4,32(s0)
    5c22:	f41c                	sd	a5,40(s0)
    5c24:	03043823          	sd	a6,48(s0)
    5c28:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5c2c:	00840613          	addi	a2,s0,8
    5c30:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5c34:	85aa                	mv	a1,a0
    5c36:	4505                	li	a0,1
    5c38:	00000097          	auipc	ra,0x0
    5c3c:	dce080e7          	jalr	-562(ra) # 5a06 <vprintf>
}
    5c40:	60e2                	ld	ra,24(sp)
    5c42:	6442                	ld	s0,16(sp)
    5c44:	6125                	addi	sp,sp,96
    5c46:	8082                	ret

0000000000005c48 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5c48:	1141                	addi	sp,sp,-16
    5c4a:	e422                	sd	s0,8(sp)
    5c4c:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c4e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c52:	00003797          	auipc	a5,0x3
    5c56:	9667b783          	ld	a5,-1690(a5) # 85b8 <freep>
    5c5a:	a805                	j	5c8a <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c5c:	4618                	lw	a4,8(a2)
    5c5e:	9db9                	addw	a1,a1,a4
    5c60:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c64:	6398                	ld	a4,0(a5)
    5c66:	6318                	ld	a4,0(a4)
    5c68:	fee53823          	sd	a4,-16(a0)
    5c6c:	a091                	j	5cb0 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c6e:	ff852703          	lw	a4,-8(a0)
    5c72:	9e39                	addw	a2,a2,a4
    5c74:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c76:	ff053703          	ld	a4,-16(a0)
    5c7a:	e398                	sd	a4,0(a5)
    5c7c:	a099                	j	5cc2 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c7e:	6398                	ld	a4,0(a5)
    5c80:	00e7e463          	bltu	a5,a4,5c88 <free+0x40>
    5c84:	00e6ea63          	bltu	a3,a4,5c98 <free+0x50>
{
    5c88:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c8a:	fed7fae3          	bgeu	a5,a3,5c7e <free+0x36>
    5c8e:	6398                	ld	a4,0(a5)
    5c90:	00e6e463          	bltu	a3,a4,5c98 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c94:	fee7eae3          	bltu	a5,a4,5c88 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5c98:	ff852583          	lw	a1,-8(a0)
    5c9c:	6390                	ld	a2,0(a5)
    5c9e:	02059713          	slli	a4,a1,0x20
    5ca2:	9301                	srli	a4,a4,0x20
    5ca4:	0712                	slli	a4,a4,0x4
    5ca6:	9736                	add	a4,a4,a3
    5ca8:	fae60ae3          	beq	a2,a4,5c5c <free+0x14>
    bp->s.ptr = p->s.ptr;
    5cac:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5cb0:	4790                	lw	a2,8(a5)
    5cb2:	02061713          	slli	a4,a2,0x20
    5cb6:	9301                	srli	a4,a4,0x20
    5cb8:	0712                	slli	a4,a4,0x4
    5cba:	973e                	add	a4,a4,a5
    5cbc:	fae689e3          	beq	a3,a4,5c6e <free+0x26>
  } else
    p->s.ptr = bp;
    5cc0:	e394                	sd	a3,0(a5)
  freep = p;
    5cc2:	00003717          	auipc	a4,0x3
    5cc6:	8ef73b23          	sd	a5,-1802(a4) # 85b8 <freep>
}
    5cca:	6422                	ld	s0,8(sp)
    5ccc:	0141                	addi	sp,sp,16
    5cce:	8082                	ret

0000000000005cd0 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5cd0:	7139                	addi	sp,sp,-64
    5cd2:	fc06                	sd	ra,56(sp)
    5cd4:	f822                	sd	s0,48(sp)
    5cd6:	f426                	sd	s1,40(sp)
    5cd8:	f04a                	sd	s2,32(sp)
    5cda:	ec4e                	sd	s3,24(sp)
    5cdc:	e852                	sd	s4,16(sp)
    5cde:	e456                	sd	s5,8(sp)
    5ce0:	e05a                	sd	s6,0(sp)
    5ce2:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5ce4:	02051493          	slli	s1,a0,0x20
    5ce8:	9081                	srli	s1,s1,0x20
    5cea:	04bd                	addi	s1,s1,15
    5cec:	8091                	srli	s1,s1,0x4
    5cee:	0014899b          	addiw	s3,s1,1
    5cf2:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cf4:	00003517          	auipc	a0,0x3
    5cf8:	8c453503          	ld	a0,-1852(a0) # 85b8 <freep>
    5cfc:	c515                	beqz	a0,5d28 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cfe:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d00:	4798                	lw	a4,8(a5)
    5d02:	02977f63          	bgeu	a4,s1,5d40 <malloc+0x70>
    5d06:	8a4e                	mv	s4,s3
    5d08:	0009871b          	sext.w	a4,s3
    5d0c:	6685                	lui	a3,0x1
    5d0e:	00d77363          	bgeu	a4,a3,5d14 <malloc+0x44>
    5d12:	6a05                	lui	s4,0x1
    5d14:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5d18:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5d1c:	00003917          	auipc	s2,0x3
    5d20:	89c90913          	addi	s2,s2,-1892 # 85b8 <freep>
  if(p == (char*)-1)
    5d24:	5afd                	li	s5,-1
    5d26:	a88d                	j	5d98 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5d28:	00009797          	auipc	a5,0x9
    5d2c:	0b078793          	addi	a5,a5,176 # edd8 <base>
    5d30:	00003717          	auipc	a4,0x3
    5d34:	88f73423          	sd	a5,-1912(a4) # 85b8 <freep>
    5d38:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d3a:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d3e:	b7e1                	j	5d06 <malloc+0x36>
      if(p->s.size == nunits)
    5d40:	02e48b63          	beq	s1,a4,5d76 <malloc+0xa6>
        p->s.size -= nunits;
    5d44:	4137073b          	subw	a4,a4,s3
    5d48:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d4a:	1702                	slli	a4,a4,0x20
    5d4c:	9301                	srli	a4,a4,0x20
    5d4e:	0712                	slli	a4,a4,0x4
    5d50:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d52:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d56:	00003717          	auipc	a4,0x3
    5d5a:	86a73123          	sd	a0,-1950(a4) # 85b8 <freep>
      return (void*)(p + 1);
    5d5e:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5d62:	70e2                	ld	ra,56(sp)
    5d64:	7442                	ld	s0,48(sp)
    5d66:	74a2                	ld	s1,40(sp)
    5d68:	7902                	ld	s2,32(sp)
    5d6a:	69e2                	ld	s3,24(sp)
    5d6c:	6a42                	ld	s4,16(sp)
    5d6e:	6aa2                	ld	s5,8(sp)
    5d70:	6b02                	ld	s6,0(sp)
    5d72:	6121                	addi	sp,sp,64
    5d74:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d76:	6398                	ld	a4,0(a5)
    5d78:	e118                	sd	a4,0(a0)
    5d7a:	bff1                	j	5d56 <malloc+0x86>
  hp->s.size = nu;
    5d7c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d80:	0541                	addi	a0,a0,16
    5d82:	00000097          	auipc	ra,0x0
    5d86:	ec6080e7          	jalr	-314(ra) # 5c48 <free>
  return freep;
    5d8a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d8e:	d971                	beqz	a0,5d62 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d90:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d92:	4798                	lw	a4,8(a5)
    5d94:	fa9776e3          	bgeu	a4,s1,5d40 <malloc+0x70>
    if(p == freep)
    5d98:	00093703          	ld	a4,0(s2)
    5d9c:	853e                	mv	a0,a5
    5d9e:	fef719e3          	bne	a4,a5,5d90 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5da2:	8552                	mv	a0,s4
    5da4:	00000097          	auipc	ra,0x0
    5da8:	b36080e7          	jalr	-1226(ra) # 58da <sbrk>
  if(p == (char*)-1)
    5dac:	fd5518e3          	bne	a0,s5,5d7c <malloc+0xac>
        return 0;
    5db0:	4501                	li	a0,0
    5db2:	bf45                	j	5d62 <malloc+0x92>
