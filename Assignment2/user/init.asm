...
main(void)
{
  ...
  3a:	8a290913          	addi	s2,s2,-1886 # 8d8 <malloc+0xec>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8be50513          	addi	a0,a0,-1858 # 928 <malloc+0x13c>
  ...
  8c:	84850513          	addi	a0,a0,-1976 # 8d0 <malloc+0xe4>
  90:	00000097          	auipc	ra,0x0
  94:	326080e7          	jalr	806(ra) # 3b6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	83650513          	addi	a0,a0,-1994 # 8d0 <malloc+0xe4>
  a2:	00000097          	auipc	ra,0x0
  a6:	30c080e7          	jalr	780(ra) # 3ae <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	84450513          	addi	a0,a0,-1980 # 8f0 <malloc+0x104>
  ...
  ca:	8a258593          	addi	a1,a1,-1886 # 968 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	83a50513          	addi	a0,a0,-1990 # 908 <malloc+0x11c>
  d6:	00000097          	auipc	ra,0x0
  da:	2d0080e7          	jalr	720(ra) # 3a6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	83250513          	addi	a0,a0,-1998 # 910 <malloc+0x124>
...
putc(int fd, char c)
{
 ...
 46c:	f26080e7          	jalr	-218(ra) # 38e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49e:	4b650513          	addi	a0,a0,1206 # 950 <digits>
 4a2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 56a:	3eab8b93          	addi	s7,s7,1002 # 950 <digits>
 ...
 6aa:	2a290913          	addi	s2,s2,674 # 948 <malloc+0x15c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 772:	20a7b783          	ld	a5,522(a5) # 978 <freep>
 ...
 7a0:	00e6ea63          	bltu	a3,a4,7b4 <free+0x50>
{
 ...
 7e2:	18f73d23          	sd	a5,410(a4) # 978 <freep>
}
 7e6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 814:	16853503          	ld	a0,360(a0) # 978 <freep>
 ...
 83c:	14090913          	addi	s2,s2,320 # 978 <freep>
  if(p == (char*)-1)
 840:	5afd                	li	s5,-1
 842:	a88d                	j	8b4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 844:	00000797          	auipc	a5,0x0
 848:	13c78793          	addi	a5,a5,316 # 980 <base>
 84c:	00000717          	auipc	a4,0x0
 850:	12f73623          	sd	a5,300(a4) # 978 <freep>
 854:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 876:	10a73323          	sd	a0,262(a4) # 978 <freep>
      return (void*)(p + 1);
 ...
 8c4:	b36080e7          	jalr	-1226(ra) # 3f6 <sbrk>
  if(p == (char*)-1)
