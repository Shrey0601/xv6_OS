...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	32058593          	addi	a1,a1,800 # 1330 <malloc+0xe8>
      18:	4509                	li	a0,2
      1a:	00001097          	auipc	ra,0x1
      1e:	142080e7          	jalr	322(ra) # 115c <fprintf>
  memset(buf, 0, nbuf);
      22:	864a                	mv	a2,s2
      24:	4581                	li	a1,0
      26:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2da58593          	addi	a1,a1,730 # 1338 <malloc+0xf0>
      66:	4509                	li	a0,2
      68:	00001097          	auipc	ra,0x1
      6c:	0f4080e7          	jalr	244(ra) # 115c <fprintf>
  exit(1);
      70:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2a850513          	addi	a0,a0,680 # 1340 <malloc+0xf8>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	37c70713          	addi	a4,a4,892 # 1440 <malloc+0x1f8>
    ...
    panic("runcmd");
      ...
      e2:	26a50513          	addi	a0,a0,618 # 1348 <malloc+0x100>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	25058593          	addi	a1,a1,592 # 1350 <malloc+0x108>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	052080e7          	jalr	82(ra) # 115c <fprintf>
  exit(0);
     112:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     150:	21458593          	addi	a1,a1,532 # 1360 <malloc+0x118>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	006080e7          	jalr	6(ra) # 115c <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
    ...
    break;
     ...
     1e6:	18e50513          	addi	a0,a0,398 # 1370 <malloc+0x128>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	fc4080e7          	jalr	-60(ra) # 1248 <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	f7a080e7          	jalr	-134(ra) # 1248 <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	f20080e7          	jalr	-224(ra) # 1248 <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	eda080e7          	jalr	-294(ra) # 1248 <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	e98080e7          	jalr	-360(ra) # 1248 <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	09e98993          	addi	s3,s3,158 # 1498 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	03a98993          	addi	s3,s3,58 # 1498 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	fd098993          	addi	s3,s3,-48 # 1498 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	fc0a8a93          	addi	s5,s5,-64 # 1490 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	f6698993          	addi	s3,s3,-154 # 1498 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	df6b8b93          	addi	s7,s7,-522 # 1398 <malloc+0x150>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	dc450513          	addi	a0,a0,-572 # 1378 <malloc+0x130>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d0460613          	addi	a2,a2,-764 # 13a0 <malloc+0x158>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	cf4b0b13          	addi	s6,s6,-780 # 13c0 <malloc+0x178>
  ...
  return ret;
     ...
     70a:	ca250513          	addi	a0,a0,-862 # 13a8 <malloc+0x160>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c4850513          	addi	a0,a0,-952 # 13b0 <malloc+0x168>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c2660613          	addi	a2,a2,-986 # 13c8 <malloc+0x180>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	bbea0a13          	addi	s4,s4,-1090 # 13d0 <malloc+0x188>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	b9060613          	addi	a2,a2,-1136 # 13d8 <malloc+0x190>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	af260613          	addi	a2,a2,-1294 # 13a0 <malloc+0x158>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b1260613          	addi	a2,a2,-1262 # 13f0 <malloc+0x1a8>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	ac050513          	addi	a0,a0,-1344 # 13e0 <malloc+0x198>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	ac850513          	addi	a0,a0,-1336 # 13f8 <malloc+0x1b0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	afc70713          	addi	a4,a4,-1284 # 1458 <malloc+0x210>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a0860613          	addi	a2,a2,-1528 # 1410 <malloc+0x1c8>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	9da58593          	addi	a1,a1,-1574 # 1418 <malloc+0x1d0>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	714080e7          	jalr	1812(ra) # 115c <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	95850513          	addi	a0,a0,-1704 # 13a8 <malloc+0x160>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9b648493          	addi	s1,s1,-1610 # 1428 <malloc+0x1e0>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a1048493          	addi	s1,s1,-1520 # 14a8 <buf.1154>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a03a0a13          	addi	s4,s4,-1533 # 14ab <buf.1154+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	980a8a93          	addi	s5,s5,-1664 # 1430 <malloc+0x1e8>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2c:	634080e7          	jalr	1588(ra) # 115c <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	97650513          	addi	a0,a0,-1674 # 14a8 <buf.1154>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ebe:	4605                	li	a2,1
     ec0:	fef40593          	addi	a1,s0,-17
     ec4:	00000097          	auipc	ra,0x0
     ec8:	f26080e7          	jalr	-218(ra) # dea <write>
}
...
{
     ed4:	7139                	addi	sp,sp,-64
     ed6:	fc06                	sd	ra,56(sp)
     ed8:	f822                	sd	s0,48(sp)
     eda:	f426                	sd	s1,40(sp)
     edc:	f04a                	sd	s2,32(sp)
     ede:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     ee4:	c299                	beqz	a3,eea <printint+0x16>
     ee6:	0805c863          	bltz	a1,f76 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efa:	58250513          	addi	a0,a0,1410 # 1478 <digits>
     efe:	883a                	mv	a6,a4
     ...
     f1e:	fec7f0e3          	bgeu	a5,a2,efe <printint+0x2a>
  if(neg)
     f22:	00088b63          	beqz	a7,f38 <printint+0x64>
    buf[i++] = '-';
     f26:	fd040793          	addi	a5,s0,-48
     f2a:	973e                	add	a4,a4,a5
     f2c:	02d00793          	li	a5,45
     f30:	fef70823          	sb	a5,-16(a4)
     f34:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     f38:	02e05863          	blez	a4,f68 <printint+0x94>
    ...
    putc(fd, buf[i]);
     ...
     f5e:	f58080e7          	jalr	-168(ra) # eb2 <putc>
  while(--i >= 0)
     f62:	197d                	addi	s2,s2,-1
     f64:	ff3918e3          	bne	s2,s3,f54 <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     fae:	02500a13          	li	s4,37
      if(c == 'd'){
     fb2:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
     fb6:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
     fba:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
     fbe:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fc2:	00000b97          	auipc	s7,0x0
     fc6:	4b6b8b93          	addi	s7,s7,1206 # 1478 <digits>
     fca:	a839                	j	fe8 <vprintf+0x6a>
        putc(fd, c);
     fcc:	85ca                	mv	a1,s2
     fce:	8556                	mv	a0,s5
     fd0:	00000097          	auipc	ra,0x0
     fd4:	ee2080e7          	jalr	-286(ra) # eb2 <putc>
     fd8:	a019                	j	fde <vprintf+0x60>
    } else if(state == '%'){
     fda:	01498f63          	beq	s3,s4,ff8 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     fde:	0485                	addi	s1,s1,1
     fe0:	fff4c903          	lbu	s2,-1(s1)
     fe4:	14090d63          	beqz	s2,113e <vprintf+0x1c0>
    c = fmt[i] & 0xff;
     fe8:	0009079b          	sext.w	a5,s2
    if(state == 0){
     fec:	fe0997e3          	bnez	s3,fda <vprintf+0x5c>
      if(c == '%'){
     ff0:	fd479ee3          	bne	a5,s4,fcc <vprintf+0x4e>
        state = '%';
     ff4:	89be                	mv	s3,a5
     ff6:	b7e5                	j	fde <vprintf+0x60>
      if(c == 'd'){
     ff8:	05878063          	beq	a5,s8,1038 <vprintf+0xba>
      } else if(c == 'l') {
     ffc:	05978c63          	beq	a5,s9,1054 <vprintf+0xd6>
      } else if(c == 'x') {
    1000:	07a78863          	beq	a5,s10,1070 <vprintf+0xf2>
      } else if(c == 'p') {
    1004:	09b78463          	beq	a5,s11,108c <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    1008:	07300713          	li	a4,115
    100c:	0ce78663          	beq	a5,a4,10d8 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1010:	06300713          	li	a4,99
    1014:	0ee78e63          	beq	a5,a4,1110 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    1018:	11478863          	beq	a5,s4,1128 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    1024:	e92080e7          	jalr	-366(ra) # eb2 <putc>
        putc(fd, c);
    1028:	85ca                	mv	a1,s2
    102a:	8556                	mv	a0,s5
    102c:	00000097          	auipc	ra,0x0
    1030:	e86080e7          	jalr	-378(ra) # eb2 <putc>
      }
      state = 0;
    1034:	4981                	li	s3,0
    ...
    104a:	e8e080e7          	jalr	-370(ra) # ed4 <printint>
    104e:	8b4a                	mv	s6,s2
      state = 0;
    1050:	4981                	li	s3,0
    ...
    1066:	e72080e7          	jalr	-398(ra) # ed4 <printint>
    106a:	8b4a                	mv	s6,s2
      state = 0;
    106c:	4981                	li	s3,0
    106e:	bf85                	j	fde <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    1070:	008b0913          	addi	s2,s6,8
    1074:	4681                	li	a3,0
    1076:	4641                	li	a2,16
    1078:	000b2583          	lw	a1,0(s6)
    107c:	8556                	mv	a0,s5
    107e:	00000097          	auipc	ra,0x0
    1082:	e56080e7          	jalr	-426(ra) # ed4 <printint>
    1086:	8b4a                	mv	s6,s2
      state = 0;
    1088:	4981                	li	s3,0
    108a:	bf91                	j	fde <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    108c:	008b0793          	addi	a5,s6,8
    1090:	f8f43423          	sd	a5,-120(s0)
    1094:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    1098:	03000593          	li	a1,48
    109c:	8556                	mv	a0,s5
    109e:	00000097          	auipc	ra,0x0
    10a2:	e14080e7          	jalr	-492(ra) # eb2 <putc>
  putc(fd, 'x');
    10a6:	85ea                	mv	a1,s10
    10a8:	8556                	mv	a0,s5
    10aa:	00000097          	auipc	ra,0x0
    10ae:	e08080e7          	jalr	-504(ra) # eb2 <putc>
    10b2:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    10b4:	03c9d793          	srli	a5,s3,0x3c
    10b8:	97de                	add	a5,a5,s7
    10ba:	0007c583          	lbu	a1,0(a5)
    10be:	8556                	mv	a0,s5
    10c0:	00000097          	auipc	ra,0x0
    10c4:	df2080e7          	jalr	-526(ra) # eb2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10c8:	0992                	slli	s3,s3,0x4
    10ca:	397d                	addiw	s2,s2,-1
    10cc:	fe0914e3          	bnez	s2,10b4 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10d0:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10d4:	4981                	li	s3,0
    10d6:	b721                	j	fde <vprintf+0x60>
        s = va_arg(ap, char*);
    10d8:	008b0993          	addi	s3,s6,8
    10dc:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    10e0:	02090163          	beqz	s2,1102 <vprintf+0x184>
        while(*s != 0){
    10e4:	00094583          	lbu	a1,0(s2)
    10e8:	c9a1                	beqz	a1,1138 <vprintf+0x1ba>
          putc(fd, *s);
    10ea:	8556                	mv	a0,s5
    10ec:	00000097          	auipc	ra,0x0
    10f0:	dc6080e7          	jalr	-570(ra) # eb2 <putc>
          s++;
    10f4:	0905                	addi	s2,s2,1
        while(*s != 0){
    10f6:	00094583          	lbu	a1,0(s2)
    10fa:	f9e5                	bnez	a1,10ea <vprintf+0x16c>
        s = va_arg(ap, char*);
    10fc:	8b4e                	mv	s6,s3
      state = 0;
    10fe:	4981                	li	s3,0
    1100:	bdf9                	j	fde <vprintf+0x60>
          s = "(null)";
    1102:	00000917          	auipc	s2,0x0
    1106:	36e90913          	addi	s2,s2,878 # 1470 <malloc+0x228>
        while(*s != 0){
    110a:	02800593          	li	a1,40
    110e:	bff1                	j	10ea <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    1110:	008b0913          	addi	s2,s6,8
    1114:	000b4583          	lbu	a1,0(s6)
    1118:	8556                	mv	a0,s5
    111a:	00000097          	auipc	ra,0x0
    111e:	d98080e7          	jalr	-616(ra) # eb2 <putc>
    1122:	8b4a                	mv	s6,s2
      state = 0;
    1124:	4981                	li	s3,0
    1126:	bd65                	j	fde <vprintf+0x60>
        putc(fd, c);
    1128:	85d2                	mv	a1,s4
    112a:	8556                	mv	a0,s5
    112c:	00000097          	auipc	ra,0x0
    1130:	d86080e7          	jalr	-634(ra) # eb2 <putc>
      state = 0;
    1134:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11ce:	2d67b783          	ld	a5,726(a5) # 14a0 <freep>
    11d2:	a805                	j	1202 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11d4:	4618                	lw	a4,8(a2)
    11d6:	9db9                	addw	a1,a1,a4
    11d8:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11dc:	6398                	ld	a4,0(a5)
    11de:	6318                	ld	a4,0(a4)
    11e0:	fee53823          	sd	a4,-16(a0)
    11e4:	a091                	j	1228 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    11e6:	ff852703          	lw	a4,-8(a0)
    11ea:	9e39                	addw	a2,a2,a4
    11ec:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    11ee:	ff053703          	ld	a4,-16(a0)
    11f2:	e398                	sd	a4,0(a5)
    11f4:	a099                	j	123a <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11f6:	6398                	ld	a4,0(a5)
    11f8:	00e7e463          	bltu	a5,a4,1200 <free+0x40>
    11fc:	00e6ea63          	bltu	a3,a4,1210 <free+0x50>
{
    1200:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1202:	fed7fae3          	bgeu	a5,a3,11f6 <free+0x36>
    1206:	6398                	ld	a4,0(a5)
    1208:	00e6e463          	bltu	a3,a4,1210 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    120c:	fee7eae3          	bltu	a5,a4,1200 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    1210:	ff852583          	lw	a1,-8(a0)
    1214:	6390                	ld	a2,0(a5)
    1216:	02059713          	slli	a4,a1,0x20
    121a:	9301                	srli	a4,a4,0x20
    121c:	0712                	slli	a4,a4,0x4
    121e:	9736                	add	a4,a4,a3
    1220:	fae60ae3          	beq	a2,a4,11d4 <free+0x14>
    bp->s.ptr = p->s.ptr;
    1224:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1228:	4790                	lw	a2,8(a5)
    122a:	02061713          	slli	a4,a2,0x20
    122e:	9301                	srli	a4,a4,0x20
    1230:	0712                	slli	a4,a4,0x4
    1232:	973e                	add	a4,a4,a5
    1234:	fae689e3          	beq	a3,a4,11e6 <free+0x26>
  } else
    p->s.ptr = bp;
    1238:	e394                	sd	a3,0(a5)
  freep = p;
    123a:	00000717          	auipc	a4,0x0
    123e:	26f73323          	sd	a5,614(a4) # 14a0 <freep>
}
...
malloc(uint nbytes)
{
    ...
    1250:	f04a                	sd	s2,32(sp)
    1252:	ec4e                	sd	s3,24(sp)
    1254:	e852                	sd	s4,16(sp)
    1256:	e456                	sd	s5,8(sp)
    1258:	e05a                	sd	s6,0(sp)
  ...
  if((prevp = freep) == 0){
    ...
    1270:	23453503          	ld	a0,564(a0) # 14a0 <freep>
    1274:	c515                	beqz	a0,12a0 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    127a:	02977f63          	bgeu	a4,s1,12b8 <malloc+0x70>
    127e:	8a4e                	mv	s4,s3
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1294:	00000917          	auipc	s2,0x0
    1298:	20c90913          	addi	s2,s2,524 # 14a0 <freep>
  if(p == (char*)-1)
    129c:	5afd                	li	s5,-1
    129e:	a88d                	j	1310 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12a0:	00000797          	auipc	a5,0x0
    12a4:	27078793          	addi	a5,a5,624 # 1510 <base>
    12a8:	00000717          	auipc	a4,0x0
    12ac:	1ef73c23          	sd	a5,504(a4) # 14a0 <freep>
    12b0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12b2:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12b6:	b7e1                	j	127e <malloc+0x36>
      if(p->s.size == nunits)
    12b8:	02e48b63          	beq	s1,a4,12ee <malloc+0xa6>
        p->s.size -= nunits;
    12bc:	4137073b          	subw	a4,a4,s3
    12c0:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12c2:	1702                	slli	a4,a4,0x20
    12c4:	9301                	srli	a4,a4,0x20
    12c6:	0712                	slli	a4,a4,0x4
    12c8:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    12ca:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    12ce:	00000717          	auipc	a4,0x0
    12d2:	1ca73923          	sd	a0,466(a4) # 14a0 <freep>
      return (void*)(p + 1);
    12d6:	01078513          	addi	a0,a5,16
    ...
    12de:	74a2                	ld	s1,40(sp)
    12e0:	7902                	ld	s2,32(sp)
    12e2:	69e2                	ld	s3,24(sp)
    12e4:	6a42                	ld	s4,16(sp)
    12e6:	6aa2                	ld	s5,8(sp)
    12e8:	6b02                	ld	s6,0(sp)
    12ea:	6121                	addi	sp,sp,64
    12ec:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    12ee:	6398                	ld	a4,0(a5)
    12f0:	e118                	sd	a4,0(a0)
    12f2:	bff1                	j	12ce <malloc+0x86>
  hp->s.size = nu;
    12f4:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12f8:	0541                	addi	a0,a0,16
    12fa:	00000097          	auipc	ra,0x0
    12fe:	ec6080e7          	jalr	-314(ra) # 11c0 <free>
  return freep;
    1302:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1306:	d971                	beqz	a0,12da <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1308:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    130a:	4798                	lw	a4,8(a5)
    130c:	fa9776e3          	bgeu	a4,s1,12b8 <malloc+0x70>
    if(p == freep)
    1310:	00093703          	ld	a4,0(s2)
    1314:	853e                	mv	a0,a5
    1316:	fef719e3          	bne	a4,a5,1308 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    131a:	8552                	mv	a0,s4
    131c:	00000097          	auipc	ra,0x0
    1320:	b36080e7          	jalr	-1226(ra) # e52 <sbrk>
  if(p == (char*)-1)
    1324:	fd5518e3          	bne	a0,s5,12f4 <malloc+0xac>
        return 0;
    1328:	4501                	li	a0,0
    132a:	bf45                	j	12da <malloc+0x92>
