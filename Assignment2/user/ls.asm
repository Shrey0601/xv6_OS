...
fmtname(char *path)
{
  ...
  6a:	ae298993          	addi	s3,s3,-1310 # b48 <buf.1128>
...
ls(char *path)
{
 ...
 128:	9bc50513          	addi	a0,a0,-1604 # ae0 <malloc+0x118>
 12c:	00000097          	auipc	ra,0x0
 130:	7de080e7          	jalr	2014(ra) # 90a <printf>
      }
 ...
 166:	94e58593          	addi	a1,a1,-1714 # ab0 <malloc+0xe8>
 16a:	4509                	li	a0,2
 16c:	00000097          	auipc	ra,0x0
 170:	770080e7          	jalr	1904(ra) # 8dc <fprintf>
    return;
 174:	b7e9                	j	13e <ls+0x8a>
    fprintf(2, "ls: cannot stat %s\n", path);
 176:	864a                	mv	a2,s2
 178:	00001597          	auipc	a1,0x1
 17c:	95058593          	addi	a1,a1,-1712 # ac8 <malloc+0x100>
 180:	4509                	li	a0,2
 182:	00000097          	auipc	ra,0x0
 186:	75a080e7          	jalr	1882(ra) # 8dc <fprintf>
    close(fd);
 18a:	8526                	mv	a0,s1
 ...
 1ae:	94650513          	addi	a0,a0,-1722 # af0 <malloc+0x128>
 1b2:	00000097          	auipc	ra,0x0
 1b6:	758080e7          	jalr	1880(ra) # 90a <printf>
      break;
 ...
 1f4:	918a0a13          	addi	s4,s4,-1768 # b08 <malloc+0x140>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	8d0a8a93          	addi	s5,s5,-1840 # ac8 <malloc+0x100>
 ...
 20c:	702080e7          	jalr	1794(ra) # 90a <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 210:	4641                	li	a2,16
 ...
 274:	69a080e7          	jalr	1690(ra) # 90a <printf>
...
main(int argc, char *argv[])
{
 ...
 2be:	85e50513          	addi	a0,a0,-1954 # b18 <malloc+0x150>
...
putc(int fd, char c)
{
 ...
 648:	f26080e7          	jalr	-218(ra) # 56a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 67a:	4b250513          	addi	a0,a0,1202 # b28 <digits>
 67e:	883a                	mv	a6,a4
 680:	2705                	addiw	a4,a4,1
 ...
 69e:	fec7f0e3          	bgeu	a5,a2,67e <printint+0x2a>
  if(neg)
 6a2:	00088b63          	beqz	a7,6b8 <printint+0x64>
    buf[i++] = '-';
 6a6:	fd040793          	addi	a5,s0,-48
 ...
 6b4:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 6b8:	02e05863          	blez	a4,6e8 <printint+0x94>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72e:	02500a13          	li	s4,37
      if(c == 'd'){
 732:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
 736:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
 73a:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
 73e:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 742:	00000b97          	auipc	s7,0x0
 746:	3e6b8b93          	addi	s7,s7,998 # b28 <digits>
 ...
 75a:	01498f63          	beq	s3,s4,778 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 ...
 768:	0009079b          	sext.w	a5,s2
    if(state == 0){
 76c:	fe0997e3          	bnez	s3,75a <vprintf+0x5c>
      if(c == '%'){
 770:	fd479ee3          	bne	a5,s4,74c <vprintf+0x4e>
        state = '%';
 774:	89be                	mv	s3,a5
 776:	b7e5                	j	75e <vprintf+0x60>
      if(c == 'd'){
 778:	05878063          	beq	a5,s8,7b8 <vprintf+0xba>
      } else if(c == 'l') {
 77c:	05978c63          	beq	a5,s9,7d4 <vprintf+0xd6>
      } else if(c == 'x') {
 780:	07a78863          	beq	a5,s10,7f0 <vprintf+0xf2>
      } else if(c == 'p') {
 784:	09b78463          	beq	a5,s11,80c <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
 788:	07300713          	li	a4,115
 78c:	0ce78663          	beq	a5,a4,858 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 794:	0ee78e63          	beq	a5,a4,890 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
 798:	11478863          	beq	a5,s4,8a8 <vprintf+0x1aa>
        putc(fd, c);
      } else {
 ...
 7a4:	e92080e7          	jalr	-366(ra) # 632 <putc>
        putc(fd, c);
 7a8:	85ca                	mv	a1,s2
 7aa:	8556                	mv	a0,s5
 7ac:	00000097          	auipc	ra,0x0
 7b0:	e86080e7          	jalr	-378(ra) # 632 <putc>
      }
      state = 0;
 7b4:	4981                	li	s3,0
 ...
 802:	e56080e7          	jalr	-426(ra) # 654 <printint>
 806:	8b4a                	mv	s6,s2
      state = 0;
 808:	4981                	li	s3,0
 80a:	bf91                	j	75e <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
 ...
 822:	e14080e7          	jalr	-492(ra) # 632 <putc>
  putc(fd, 'x');
 826:	85ea                	mv	a1,s10
 828:	8556                	mv	a0,s5
 82a:	00000097          	auipc	ra,0x0
 82e:	e08080e7          	jalr	-504(ra) # 632 <putc>
 832:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 844:	df2080e7          	jalr	-526(ra) # 632 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 848:	0992                	slli	s3,s3,0x4
 84a:	397d                	addiw	s2,s2,-1
 84c:	fe0914e3          	bnez	s2,834 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
 850:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 854:	4981                	li	s3,0
 856:	b721                	j	75e <vprintf+0x60>
        s = va_arg(ap, char*);
 858:	008b0993          	addi	s3,s6,8
 85c:	000b3903          	ld	s2,0(s6)
        if(s == 0)
 860:	02090163          	beqz	s2,882 <vprintf+0x184>
        while(*s != 0){
 864:	00094583          	lbu	a1,0(s2)
 868:	c9a1                	beqz	a1,8b8 <vprintf+0x1ba>
          putc(fd, *s);
 86a:	8556                	mv	a0,s5
 86c:	00000097          	auipc	ra,0x0
 870:	dc6080e7          	jalr	-570(ra) # 632 <putc>
          s++;
 874:	0905                	addi	s2,s2,1
        while(*s != 0){
 876:	00094583          	lbu	a1,0(s2)
 87a:	f9e5                	bnez	a1,86a <vprintf+0x16c>
        s = va_arg(ap, char*);
 87c:	8b4e                	mv	s6,s3
      state = 0;
 87e:	4981                	li	s3,0
 880:	bdf9                	j	75e <vprintf+0x60>
          s = "(null)";
 882:	00000917          	auipc	s2,0x0
 886:	29e90913          	addi	s2,s2,670 # b20 <malloc+0x158>
        while(*s != 0){
 88a:	02800593          	li	a1,40
 88e:	bff1                	j	86a <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
 890:	008b0913          	addi	s2,s6,8
 894:	000b4583          	lbu	a1,0(s6)
 898:	8556                	mv	a0,s5
 89a:	00000097          	auipc	ra,0x0
 89e:	d98080e7          	jalr	-616(ra) # 632 <putc>
 8a2:	8b4a                	mv	s6,s2
      state = 0;
 8a4:	4981                	li	s3,0
 8a6:	bd65                	j	75e <vprintf+0x60>
        putc(fd, c);
 8a8:	85d2                	mv	a1,s4
 8aa:	8556                	mv	a0,s5
...
free(void *ap)
{
 ...
 94e:	1f67b783          	ld	a5,502(a5) # b40 <freep>
 952:	a805                	j	982 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
 954:	4618                	lw	a4,8(a2)
 956:	9db9                	addw	a1,a1,a4
 958:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
 95c:	6398                	ld	a4,0(a5)
 95e:	6318                	ld	a4,0(a4)
 960:	fee53823          	sd	a4,-16(a0)
 964:	a091                	j	9a8 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
 966:	ff852703          	lw	a4,-8(a0)
 96a:	9e39                	addw	a2,a2,a4
 96c:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
 96e:	ff053703          	ld	a4,-16(a0)
 972:	e398                	sd	a4,0(a5)
 974:	a099                	j	9ba <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 976:	6398                	ld	a4,0(a5)
 978:	00e7e463          	bltu	a5,a4,980 <free+0x40>
 97c:	00e6ea63          	bltu	a3,a4,990 <free+0x50>
{
 980:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 982:	fed7fae3          	bgeu	a5,a3,976 <free+0x36>
 986:	6398                	ld	a4,0(a5)
 988:	00e6e463          	bltu	a3,a4,990 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 98c:	fee7eae3          	bltu	a5,a4,980 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
 990:	ff852583          	lw	a1,-8(a0)
 994:	6390                	ld	a2,0(a5)
 996:	02059713          	slli	a4,a1,0x20
 99a:	9301                	srli	a4,a4,0x20
 99c:	0712                	slli	a4,a4,0x4
 99e:	9736                	add	a4,a4,a3
 9a0:	fae60ae3          	beq	a2,a4,954 <free+0x14>
    bp->s.ptr = p->s.ptr;
 ...
 9b4:	fae689e3          	beq	a3,a4,966 <free+0x26>
  } else
    p->s.ptr = bp;
 9b8:	e394                	sd	a3,0(a5)
  freep = p;
 9ba:	00000717          	auipc	a4,0x0
 9be:	18f73323          	sd	a5,390(a4) # b40 <freep>
}
 9c2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9f0:	15453503          	ld	a0,340(a0) # b40 <freep>
 9f4:	c515                	beqz	a0,a20 <malloc+0x58>
 ...
 9f6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 9f8:	4798                	lw	a4,8(a5)
 9fa:	02977f63          	bgeu	a4,s1,a38 <malloc+0x70>
 9fe:	8a4e                	mv	s4,s3
 ...
 a18:	12c90913          	addi	s2,s2,300 # b40 <freep>
  if(p == (char*)-1)
 a1c:	5afd                	li	s5,-1
 a1e:	a88d                	j	a90 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a20:	00000797          	auipc	a5,0x0
 a24:	13878793          	addi	a5,a5,312 # b58 <base>
 a28:	00000717          	auipc	a4,0x0
 a2c:	10f73c23          	sd	a5,280(a4) # b40 <freep>
 a30:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 a32:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 a36:	b7e1                	j	9fe <malloc+0x36>
      if(p->s.size == nunits)
 a38:	02e48b63          	beq	s1,a4,a6e <malloc+0xa6>
        p->s.size -= nunits;
 ...
 a52:	0ea73923          	sd	a0,242(a4) # b40 <freep>
      return (void*)(p + 1);
 ...
 a82:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 a86:	d971                	beqz	a0,a5a <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a88:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 a8a:	4798                	lw	a4,8(a5)
 a8c:	fa9776e3          	bgeu	a4,s1,a38 <malloc+0x70>
    if(p == freep)
 a90:	00093703          	ld	a4,0(s2)
 a94:	853e                	mv	a0,a5
 a96:	fef719e3          	bne	a4,a5,a88 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
 a9a:	8552                	mv	a0,s4
 a9c:	00000097          	auipc	ra,0x0
 aa0:	b36080e7          	jalr	-1226(ra) # 5d2 <sbrk>
  if(p == (char*)-1)
 aa4:	fd5518e3          	bne	a0,s5,a74 <malloc+0xac>
        return 0;
 aa8:	4501                	li	a0,0
 aaa:	bf45                	j	a5a <malloc+0x92>
