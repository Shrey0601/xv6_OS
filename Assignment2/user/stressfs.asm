...
main(int argc, char *argv[])
{
  ...
  1a:	90278793          	addi	a5,a5,-1790 # 918 <malloc+0x118>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8bc50513          	addi	a0,a0,-1860 # 8e8 <malloc+0xe8>
  34:	00000097          	auipc	ra,0x0
  38:	70e080e7          	jalr	1806(ra) # 742 <printf>
  ...
  6c:	89850513          	addi	a0,a0,-1896 # 900 <malloc+0x100>
  70:	00000097          	auipc	ra,0x0
  74:	6d2080e7          	jalr	1746(ra) # 742 <printf>
...
putc(int fd, char c)
{
 ...
 480:	f26080e7          	jalr	-218(ra) # 3a2 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b2:	48250513          	addi	a0,a0,1154 # 930 <digits>
 4b6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6be:	26e90913          	addi	s2,s2,622 # 928 <malloc+0x128>
        while(*s != 0){
...
free(void *ap)
{
 ...
 786:	1c67b783          	ld	a5,454(a5) # 948 <freep>
 ...
 7b4:	00e6ea63          	bltu	a3,a4,7c8 <free+0x50>
{
 ...
 7f6:	14f73b23          	sd	a5,342(a4) # 948 <freep>
}
 7fa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 828:	12453503          	ld	a0,292(a0) # 948 <freep>
 ...
 850:	0fc90913          	addi	s2,s2,252 # 948 <freep>
  if(p == (char*)-1)
 854:	5afd                	li	s5,-1
 856:	a88d                	j	8c8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 858:	00000797          	auipc	a5,0x0
 85c:	0f878793          	addi	a5,a5,248 # 950 <base>
 ...
 8d8:	b36080e7          	jalr	-1226(ra) # 40a <sbrk>
  if(p == (char*)-1)
