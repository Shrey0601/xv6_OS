...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0ca50513          	addi	a0,a0,202 # 6108 <malloc+0x448>
      46:	00006097          	auipc	ra,0x6
      4a:	bbc080e7          	jalr	-1092(ra) # 5c02 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	66078793          	addi	a5,a5,1632 # 96b8 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	d6868693          	addi	a3,a3,-664 # bdc8 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	0a850513          	addi	a0,a0,168 # 6128 <malloc+0x468>
      88:	00006097          	auipc	ra,0x6
      8c:	b7a080e7          	jalr	-1158(ra) # 5c02 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	09850513          	addi	a0,a0,152 # 6140 <malloc+0x480>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	09a50513          	addi	a0,a0,154 # 6160 <malloc+0x4a0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	06250513          	addi	a0,a0,98 # 6148 <malloc+0x488>
      ee:	00006097          	auipc	ra,0x6
      f2:	b14080e7          	jalr	-1260(ra) # 5c02 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	06e50513          	addi	a0,a0,110 # 6170 <malloc+0x4b0>
     10a:	00006097          	auipc	ra,0x6
     10e:	af8080e7          	jalr	-1288(ra) # 5c02 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	06c50513          	addi	a0,a0,108 # 6198 <malloc+0x4d8>
     134:	00005097          	auipc	ra,0x5
     138:	76e080e7          	jalr	1902(ra) # 58a2 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	05850513          	addi	a0,a0,88 # 6198 <malloc+0x4d8>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	05458593          	addi	a1,a1,84 # 61a8 <malloc+0x4e8>
     15c:	00005097          	auipc	ra,0x5
     160:	716080e7          	jalr	1814(ra) # 5872 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	03050513          	addi	a0,a0,48 # 6198 <malloc+0x4d8>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	03458593          	addi	a1,a1,52 # 61b0 <malloc+0x4f0>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	00450513          	addi	a0,a0,4 # 6198 <malloc+0x4d8>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fee50513          	addi	a0,a0,-18 # 61b8 <malloc+0x4f8>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a30080e7          	jalr	-1488(ra) # 5c02 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	d0c50513          	addi	a0,a0,-756 # 5f88 <malloc+0x2c8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	cf8a8a93          	addi	s5,s5,-776 # 5f88 <malloc+0x2c8>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	b30a0a13          	addi	s4,s4,-1232 # bdc8 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ece50513          	addi	a0,a0,-306 # 61e0 <malloc+0x520>
     31a:	00006097          	auipc	ra,0x6
     31e:	8e8080e7          	jalr	-1816(ra) # 5c02 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	eca50513          	addi	a0,a0,-310 # 6200 <malloc+0x540>
     33e:	00006097          	auipc	ra,0x6
     342:	8c4080e7          	jalr	-1852(ra) # 5c02 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	ea6a0a13          	addi	s4,s4,-346 # 6218 <malloc+0x558>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	e0250513          	addi	a0,a0,-510 # 6220 <malloc+0x560>
     426:	00005097          	auipc	ra,0x5
     42a:	7dc080e7          	jalr	2012(ra) # 5c02 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	dfc50513          	addi	a0,a0,-516 # 6238 <malloc+0x578>
     444:	00005097          	auipc	ra,0x5
     448:	7be080e7          	jalr	1982(ra) # 5c02 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	e0e50513          	addi	a0,a0,-498 # 6268 <malloc+0x5a8>
     462:	00005097          	auipc	ra,0x5
     466:	7a0080e7          	jalr	1952(ra) # 5c02 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	e2450513          	addi	a0,a0,-476 # 6298 <malloc+0x5d8>
     47c:	00005097          	auipc	ra,0x5
     480:	786080e7          	jalr	1926(ra) # 5c02 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	e1650513          	addi	a0,a0,-490 # 62a8 <malloc+0x5e8>
     49a:	00005097          	auipc	ra,0x5
     49e:	768080e7          	jalr	1896(ra) # 5c02 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	e08a0a13          	addi	s4,s4,-504 # 62d8 <malloc+0x618>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	cd8a8a93          	addi	s5,s5,-808 # 61b0 <malloc+0x4f0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d6250513          	addi	a0,a0,-670 # 62e0 <malloc+0x620>
     586:	00005097          	auipc	ra,0x5
     58a:	67c080e7          	jalr	1660(ra) # 5c02 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d5c50513          	addi	a0,a0,-676 # 62f8 <malloc+0x638>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	65e080e7          	jalr	1630(ra) # 5c02 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	ce250513          	addi	a0,a0,-798 # 6298 <malloc+0x5d8>
     5be:	00005097          	auipc	ra,0x5
     5c2:	644080e7          	jalr	1604(ra) # 5c02 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d5850513          	addi	a0,a0,-680 # 6328 <malloc+0x668>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	62a080e7          	jalr	1578(ra) # 5c02 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d5250513          	addi	a0,a0,-686 # 6340 <malloc+0x680>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	60c080e7          	jalr	1548(ra) # 5c02 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b6458593          	addi	a1,a1,-1180 # 61a8 <malloc+0x4e8>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b3850513          	addi	a0,a0,-1224 # 6198 <malloc+0x4d8>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	b0c50513          	addi	a0,a0,-1268 # 6198 <malloc+0x4d8>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	af850513          	addi	a0,a0,-1288 # 6198 <malloc+0x4d8>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	cf258593          	addi	a1,a1,-782 # 63d0 <malloc+0x710>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	a7850513          	addi	a0,a0,-1416 # 6198 <malloc+0x4d8>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	c0c50513          	addi	a0,a0,-1012 # 6370 <malloc+0x6b0>
     76c:	00005097          	auipc	ra,0x5
     770:	496080e7          	jalr	1174(ra) # 5c02 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	c1050513          	addi	a0,a0,-1008 # 6390 <malloc+0x6d0>
     788:	00005097          	auipc	ra,0x5
     78c:	47a080e7          	jalr	1146(ra) # 5c02 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	c0c50513          	addi	a0,a0,-1012 # 63a0 <malloc+0x6e0>
     79c:	00005097          	auipc	ra,0x5
     7a0:	466080e7          	jalr	1126(ra) # 5c02 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	c1050513          	addi	a0,a0,-1008 # 63c0 <malloc+0x700>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	44a080e7          	jalr	1098(ra) # 5c02 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	bdc50513          	addi	a0,a0,-1060 # 63a0 <malloc+0x6e0>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	436080e7          	jalr	1078(ra) # 5c02 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	bf650513          	addi	a0,a0,-1034 # 63d8 <malloc+0x718>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	418080e7          	jalr	1048(ra) # 5c02 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	bf850513          	addi	a0,a0,-1032 # 63f8 <malloc+0x738>
     808:	00005097          	auipc	ra,0x5
     80c:	3fa080e7          	jalr	1018(ra) # 5c02 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	be450513          	addi	a0,a0,-1052 # 6418 <malloc+0x758>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	bf498993          	addi	s3,s3,-1036 # 6440 <malloc+0x780>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	c24a8a93          	addi	s5,s5,-988 # 6478 <malloc+0x7b8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	b7e50513          	addi	a0,a0,-1154 # 6418 <malloc+0x758>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	51458593          	addi	a1,a1,1300 # bdc8 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b4250513          	addi	a0,a0,-1214 # 6418 <malloc+0x758>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	b2050513          	addi	a0,a0,-1248 # 6420 <malloc+0x760>
     908:	00005097          	auipc	ra,0x5
     90c:	2fa080e7          	jalr	762(ra) # 5c02 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	b3250513          	addi	a0,a0,-1230 # 6450 <malloc+0x790>
     926:	00005097          	auipc	ra,0x5
     92a:	2dc080e7          	jalr	732(ra) # 5c02 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b4c50513          	addi	a0,a0,-1204 # 6488 <malloc+0x7c8>
     944:	00005097          	auipc	ra,0x5
     948:	2be080e7          	jalr	702(ra) # 5c02 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b5850513          	addi	a0,a0,-1192 # 64b0 <malloc+0x7f0>
     960:	00005097          	auipc	ra,0x5
     964:	2a2080e7          	jalr	674(ra) # 5c02 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b5c50513          	addi	a0,a0,-1188 # 64d0 <malloc+0x810>
     97c:	00005097          	auipc	ra,0x5
     980:	286080e7          	jalr	646(ra) # 5c02 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b5850513          	addi	a0,a0,-1192 # 64e8 <malloc+0x828>
     998:	00005097          	auipc	ra,0x5
     99c:	26a080e7          	jalr	618(ra) # 5c02 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b4650513          	addi	a0,a0,-1210 # 6508 <malloc+0x848>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	3f290913          	addi	s2,s2,1010 # bdc8 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	af450513          	addi	a0,a0,-1292 # 6508 <malloc+0x848>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	3a090913          	addi	s2,s2,928 # bdc8 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	ab450513          	addi	a0,a0,-1356 # 6510 <malloc+0x850>
     a64:	00005097          	auipc	ra,0x5
     a68:	19e080e7          	jalr	414(ra) # 5c02 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	ab650513          	addi	a0,a0,-1354 # 6530 <malloc+0x870>
     a82:	00005097          	auipc	ra,0x5
     a86:	180080e7          	jalr	384(ra) # 5c02 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	ac250513          	addi	a0,a0,-1342 # 6558 <malloc+0x898>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	164080e7          	jalr	356(ra) # 5c02 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a4650513          	addi	a0,a0,-1466 # 6508 <malloc+0x848>
     ...
     af2:	a8a50513          	addi	a0,a0,-1398 # 6578 <malloc+0x8b8>
     af6:	00005097          	auipc	ra,0x5
     afa:	10c080e7          	jalr	268(ra) # 5c02 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	a9450513          	addi	a0,a0,-1388 # 65a0 <malloc+0x8e0>
     b14:	00005097          	auipc	ra,0x5
     b18:	0ee080e7          	jalr	238(ra) # 5c02 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	a8e50513          	addi	a0,a0,-1394 # 65b8 <malloc+0x8f8>
     b32:	00005097          	auipc	ra,0x5
     b36:	0d0080e7          	jalr	208(ra) # 5c02 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	a9a50513          	addi	a0,a0,-1382 # 65e0 <malloc+0x920>
     b4e:	00005097          	auipc	ra,0x5
     b52:	0b4080e7          	jalr	180(ra) # 5c02 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	3a450513          	addi	a0,a0,932 # 5f18 <malloc+0x258>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	a8c58593          	addi	a1,a1,-1396 # 6618 <malloc+0x958>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	37050513          	addi	a0,a0,880 # 5f18 <malloc+0x258>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	35a50513          	addi	a0,a0,858 # 5f18 <malloc+0x258>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	34450513          	addi	a0,a0,836 # 5f18 <malloc+0x258>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	a7858593          	addi	a1,a1,-1416 # 6660 <malloc+0x9a0>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	1c458593          	addi	a1,a1,452 # bdc8 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	2c850513          	addi	a0,a0,712 # 5f18 <malloc+0x258>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	98850513          	addi	a0,a0,-1656 # 65f8 <malloc+0x938>
     c78:	00005097          	auipc	ra,0x5
     c7c:	f8a080e7          	jalr	-118(ra) # 5c02 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	99450513          	addi	a0,a0,-1644 # 6620 <malloc+0x960>
     c94:	00005097          	auipc	ra,0x5
     c98:	f6e080e7          	jalr	-146(ra) # 5c02 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	99850513          	addi	a0,a0,-1640 # 6640 <malloc+0x980>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	f52080e7          	jalr	-174(ra) # 5c02 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	9a450513          	addi	a0,a0,-1628 # 6668 <malloc+0x9a8>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	f36080e7          	jalr	-202(ra) # 5c02 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	9a850513          	addi	a0,a0,-1624 # 6688 <malloc+0x9c8>
     ce8:	00005097          	auipc	ra,0x5
     cec:	f1a080e7          	jalr	-230(ra) # 5c02 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	9ac50513          	addi	a0,a0,-1620 # 66a8 <malloc+0x9e8>
     d04:	00005097          	auipc	ra,0x5
     d08:	efe080e7          	jalr	-258(ra) # 5c02 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	8b858593          	addi	a1,a1,-1864 # 6618 <malloc+0x958>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	95058593          	addi	a1,a1,-1712 # 66d0 <malloc+0xa10>
     d88:	00006517          	auipc	a0,0x6
     d8c:	94050513          	addi	a0,a0,-1728 # 66c8 <malloc+0xa08>
  ...
  unlink("lf1");
     ...
     da0:	92c50513          	addi	a0,a0,-1748 # 66c8 <malloc+0xa08>
     da4:	00005097          	auipc	ra,0x5
     da8:	afe080e7          	jalr	-1282(ra) # 58a2 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	91a50513          	addi	a0,a0,-1766 # 66c8 <malloc+0xa08>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	90c50513          	addi	a0,a0,-1780 # 66d0 <malloc+0xa10>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	fec58593          	addi	a1,a1,-20 # bdc8 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	8d458593          	addi	a1,a1,-1836 # 66d0 <malloc+0xa10>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	8be50513          	addi	a0,a0,-1858 # 66d0 <malloc+0xa10>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a88080e7          	jalr	-1400(ra) # 58a2 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	8a658593          	addi	a1,a1,-1882 # 66c8 <malloc+0xa08>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	8a650513          	addi	a0,a0,-1882 # 66d0 <malloc+0xa10>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	88a58593          	addi	a1,a1,-1910 # 66c8 <malloc+0xa08>
     e46:	00006517          	auipc	a0,0x6
     e4a:	99250513          	addi	a0,a0,-1646 # 67d8 <malloc+0xb18>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	87050513          	addi	a0,a0,-1936 # 66d8 <malloc+0xa18>
     e70:	00005097          	auipc	ra,0x5
     e74:	d92080e7          	jalr	-622(ra) # 5c02 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	86c50513          	addi	a0,a0,-1940 # 66f0 <malloc+0xa30>
     e8c:	00005097          	auipc	ra,0x5
     e90:	d76080e7          	jalr	-650(ra) # 5c02 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	86850513          	addi	a0,a0,-1944 # 6708 <malloc+0xa48>
     ea8:	00005097          	auipc	ra,0x5
     eac:	d5a080e7          	jalr	-678(ra) # 5c02 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	86c50513          	addi	a0,a0,-1940 # 6728 <malloc+0xa68>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	d3e080e7          	jalr	-706(ra) # 5c02 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	88050513          	addi	a0,a0,-1920 # 6758 <malloc+0xa98>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	d22080e7          	jalr	-734(ra) # 5c02 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	87c50513          	addi	a0,a0,-1924 # 6770 <malloc+0xab0>
     efc:	00005097          	auipc	ra,0x5
     f00:	d06080e7          	jalr	-762(ra) # 5c02 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	87850513          	addi	a0,a0,-1928 # 6788 <malloc+0xac8>
     f18:	00005097          	auipc	ra,0x5
     f1c:	cea080e7          	jalr	-790(ra) # 5c02 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	88450513          	addi	a0,a0,-1916 # 67b0 <malloc+0xaf0>
     f34:	00005097          	auipc	ra,0x5
     f38:	cce080e7          	jalr	-818(ra) # 5c02 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	89850513          	addi	a0,a0,-1896 # 67e0 <malloc+0xb20>
     f50:	00005097          	auipc	ra,0x5
     f54:	cb2080e7          	jalr	-846(ra) # 5c02 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	852a0a13          	addi	s4,s4,-1966 # 6800 <malloc+0xb40>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	80050513          	addi	a0,a0,-2048 # 6800 <malloc+0xb40>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	79850513          	addi	a0,a0,1944 # 6808 <malloc+0xb48>
    1078:	00005097          	auipc	ra,0x5
    107c:	b8a080e7          	jalr	-1142(ra) # 5c02 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	79850513          	addi	a0,a0,1944 # 6828 <malloc+0xb68>
    1098:	00005097          	auipc	ra,0x5
    109c:	b6a080e7          	jalr	-1174(ra) # 5c02 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	79c50513          	addi	a0,a0,1948 # 6848 <malloc+0xb88>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	b4e080e7          	jalr	-1202(ra) # 5c02 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	78a98993          	addi	s3,s3,1930 # 6868 <malloc+0xba8>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	75e50513          	addi	a0,a0,1886 # 6878 <malloc+0xbb8>
    1122:	00005097          	auipc	ra,0x5
    1126:	ae0080e7          	jalr	-1312(ra) # 5c02 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	45e4b483          	ld	s1,1118(s1) # 85a0 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x588>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	fba98993          	addi	s3,s3,-70 # 6140 <malloc+0x480>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	85078793          	addi	a5,a5,-1968 # 7a60 <malloc+0x1da0>
  ...
  if(pid == 0){
    ...
    124a:	46a78793          	addi	a5,a5,1130 # 86b0 <big.1288>
    124e:	00008697          	auipc	a3,0x8
    1252:	46268693          	addi	a3,a3,1122 # 96b0 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1268:	44078623          	sb	zero,1100(a5) # 96b0 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	f0478793          	addi	a5,a5,-252 # 8170 <malloc+0x24b0>
    ...
    1294:	eb050513          	addi	a0,a0,-336 # 6140 <malloc+0x480>
    ...
    12ac:	67850513          	addi	a0,a0,1656 # 6920 <malloc+0xc60>
    12b0:	00005097          	auipc	ra,0x5
    12b4:	952080e7          	jalr	-1710(ra) # 5c02 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	5d050513          	addi	a0,a0,1488 # 6898 <malloc+0xbd8>
    12d0:	00005097          	auipc	ra,0x5
    12d4:	932080e7          	jalr	-1742(ra) # 5c02 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	5d050513          	addi	a0,a0,1488 # 68b8 <malloc+0xbf8>
    12f0:	00005097          	auipc	ra,0x5
    12f4:	912080e7          	jalr	-1774(ra) # 5c02 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	5ce50513          	addi	a0,a0,1486 # 68d8 <malloc+0xc18>
    1312:	00005097          	auipc	ra,0x5
    1316:	8f0080e7          	jalr	-1808(ra) # 5c02 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	5d650513          	addi	a0,a0,1494 # 6900 <malloc+0xc40>
    1332:	00005097          	auipc	ra,0x5
    1336:	8d0080e7          	jalr	-1840(ra) # 5c02 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	a5450513          	addi	a0,a0,-1452 # 6d98 <malloc+0x10d8>
    134c:	00005097          	auipc	ra,0x5
    1350:	8b6080e7          	jalr	-1866(ra) # 5c02 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	5ba50513          	addi	a0,a0,1466 # 6948 <malloc+0xc88>
    1396:	00005097          	auipc	ra,0x5
    139a:	86c080e7          	jalr	-1940(ra) # 5c02 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	dd850513          	addi	a0,a0,-552 # 6198 <malloc+0x4d8>
  ...
  if(pid == 0){
    ...
    13ee:	daea0a13          	addi	s4,s4,-594 # 6198 <malloc+0x4d8>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	5b6a8a93          	addi	s5,s5,1462 # 69a8 <malloc+0xce8>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	51650513          	addi	a0,a0,1302 # 6978 <malloc+0xcb8>
    146a:	00004097          	auipc	ra,0x4
    146e:	798080e7          	jalr	1944(ra) # 5c02 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	51250513          	addi	a0,a0,1298 # 6990 <malloc+0xcd0>
    1486:	00004097          	auipc	ra,0x4
    148a:	77c080e7          	jalr	1916(ra) # 5c02 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	51c50513          	addi	a0,a0,1308 # 69b8 <malloc+0xcf8>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	75e080e7          	jalr	1886(ra) # 5c02 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	cdea0a13          	addi	s4,s4,-802 # 6198 <malloc+0x4d8>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	516a8a93          	addi	s5,s5,1302 # 69d8 <malloc+0xd18>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	c8c50513          	addi	a0,a0,-884 # 6198 <malloc+0x4d8>
  ...
  exit(xstatus);
    ...
    152e:	46650513          	addi	a0,a0,1126 # 6990 <malloc+0xcd0>
    1532:	00004097          	auipc	ra,0x4
    1536:	6d0080e7          	jalr	1744(ra) # 5c02 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	49850513          	addi	a0,a0,1176 # 69e0 <malloc+0xd20>
    1550:	00004097          	auipc	ra,0x4
    1554:	6b2080e7          	jalr	1714(ra) # 5c02 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	bd078793          	addi	a5,a5,-1072 # 6140 <malloc+0x480>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	48478793          	addi	a5,a5,1156 # 6a00 <malloc+0xd40>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	47c50513          	addi	a0,a0,1148 # 6a08 <malloc+0xd48>
  ...
  if(pid == 0) {
    ...
    15be:	44e50513          	addi	a0,a0,1102 # 6a08 <malloc+0xd48>
    ...
    15da:	45250513          	addi	a0,a0,1106 # 6a28 <malloc+0xd68>
    15de:	00004097          	auipc	ra,0x4
    15e2:	624080e7          	jalr	1572(ra) # 5c02 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	38650513          	addi	a0,a0,902 # 6978 <malloc+0xcb8>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	608080e7          	jalr	1544(ra) # 5c02 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	40250513          	addi	a0,a0,1026 # 6a10 <malloc+0xd50>
    1616:	00004097          	auipc	ra,0x4
    161a:	5ec080e7          	jalr	1516(ra) # 5c02 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	b1450513          	addi	a0,a0,-1260 # 6140 <malloc+0x480>
  ...
  if(xstatus != 0)
    ...
    1664:	3d850513          	addi	a0,a0,984 # 6a38 <malloc+0xd78>
    1668:	00004097          	auipc	ra,0x4
    166c:	59a080e7          	jalr	1434(ra) # 5c02 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	3d450513          	addi	a0,a0,980 # 6a50 <malloc+0xd90>
    1684:	00004097          	auipc	ra,0x4
    1688:	57e080e7          	jalr	1406(ra) # 5c02 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	37850513          	addi	a0,a0,888 # 6a08 <malloc+0xd48>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	e1650513          	addi	a0,a0,-490 # 64d0 <malloc+0x810>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	540080e7          	jalr	1344(ra) # 5c02 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	2ba50513          	addi	a0,a0,698 # 6990 <malloc+0xcd0>
    16de:	00004097          	auipc	ra,0x4
    16e2:	524080e7          	jalr	1316(ra) # 5c02 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	31850513          	addi	a0,a0,792 # 6a08 <malloc+0xd48>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	34e50513          	addi	a0,a0,846 # 6a68 <malloc+0xda8>
    1722:	00004097          	auipc	ra,0x4
    1726:	4e0080e7          	jalr	1248(ra) # 5c02 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	642a8a93          	addi	s5,s5,1602 # bdc8 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	62470713          	addi	a4,a4,1572 # bdc8 <buf>
    ...
    17e0:	2a450513          	addi	a0,a0,676 # 6a80 <malloc+0xdc0>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	41e080e7          	jalr	1054(ra) # 5c02 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    1806:	5c6b0b13          	addi	s6,s6,1478 # bdc8 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	23650513          	addi	a0,a0,566 # 6a98 <malloc+0xdd8>
    186a:	00004097          	auipc	ra,0x4
    186e:	398080e7          	jalr	920(ra) # 5c02 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	23250513          	addi	a0,a0,562 # 6ab0 <malloc+0xdf0>
    1886:	00004097          	auipc	ra,0x4
    188a:	37c080e7          	jalr	892(ra) # 5c02 <printf>
}
    ...
    18b4:	21850513          	addi	a0,a0,536 # 6ac8 <malloc+0xe08>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	34a080e7          	jalr	842(ra) # 5c02 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	1f850513          	addi	a0,a0,504 # 6ae8 <malloc+0xe28>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	30a080e7          	jalr	778(ra) # 5c02 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	01650513          	addi	a0,a0,22 # 6978 <malloc+0xcb8>
    196a:	00004097          	auipc	ra,0x4
    196e:	298080e7          	jalr	664(ra) # 5c02 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	18250513          	addi	a0,a0,386 # 6b00 <malloc+0xe40>
    1986:	00004097          	auipc	ra,0x4
    198a:	27c080e7          	jalr	636(ra) # 5c02 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	17e50513          	addi	a0,a0,382 # 6b18 <malloc+0xe58>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	260080e7          	jalr	608(ra) # 5c02 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	f6650513          	addi	a0,a0,-154 # 6978 <malloc+0xcb8>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	1e8080e7          	jalr	488(ra) # 5c02 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	f4250513          	addi	a0,a0,-190 # 6978 <malloc+0xcb8>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	1c4080e7          	jalr	452(ra) # 5c02 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	08850513          	addi	a0,a0,136 # 6b38 <malloc+0xe78>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	14a080e7          	jalr	330(ra) # 5c02 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	d90080e7          	jalr	-624(ra) # 5852 <exit>
{
    ...
    1b0c:	04050513          	addi	a0,a0,64 # 6b48 <malloc+0xe88>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	0f2080e7          	jalr	242(ra) # 5c02 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	24250513          	addi	a0,a0,578 # 6d98 <malloc+0x10d8>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	0a4080e7          	jalr	164(ra) # 5c02 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	1a450513          	addi	a0,a0,420 # 6d98 <malloc+0x10d8>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	006080e7          	jalr	6(ra) # 5c02 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	df050513          	addi	a0,a0,-528 # 6a10 <malloc+0xd50>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	fda080e7          	jalr	-38(ra) # 5c02 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	ed650513          	addi	a0,a0,-298 # 6b68 <malloc+0xea8>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	f68080e7          	jalr	-152(ra) # 5c02 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	eba50513          	addi	a0,a0,-326 # 6b80 <malloc+0xec0>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	f34080e7          	jalr	-204(ra) # 5c02 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	e7c50513          	addi	a0,a0,-388 # 6ba8 <malloc+0xee8>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	ece080e7          	jalr	-306(ra) # 5c02 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	3e450513          	addi	a0,a0,996 # 61b0 <malloc+0x4f0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	3a8a8a93          	addi	s5,s5,936 # 61b0 <malloc+0x4f0>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	dc0b8b93          	addi	s7,s7,-576 # 6bd0 <malloc+0xf10>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	b5c50513          	addi	a0,a0,-1188 # 6978 <malloc+0xcb8>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	dde080e7          	jalr	-546(ra) # 5c02 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	e8e50513          	addi	a0,a0,-370 # 6d98 <malloc+0x10d8>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	cf0080e7          	jalr	-784(ra) # 5c02 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	e82b8b93          	addi	s7,s7,-382 # bdc8 <buf>
    ...
    1fbe:	c1e50513          	addi	a0,a0,-994 # 6bd8 <malloc+0xf18>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	c40080e7          	jalr	-960(ra) # 5c02 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	22650513          	addi	a0,a0,550 # 6200 <malloc+0x540>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	c20080e7          	jalr	-992(ra) # 5c02 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	be050513          	addi	a0,a0,-1056 # 6c08 <malloc+0xf48>
    2030:	00004097          	auipc	ra,0x4
    2034:	bd2080e7          	jalr	-1070(ra) # 5c02 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	b6650513          	addi	a0,a0,-1178 # 6bf0 <malloc+0xf30>
    2092:	00004097          	auipc	ra,0x4
    2096:	b70080e7          	jalr	-1168(ra) # 5c02 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	b8a50513          	addi	a0,a0,-1142 # 6c30 <malloc+0xf70>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	b54080e7          	jalr	-1196(ra) # 5c02 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	b8650513          	addi	a0,a0,-1146 # 6c48 <malloc+0xf88>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	b38080e7          	jalr	-1224(ra) # 5c02 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x588>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e6a8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	83650513          	addi	a0,a0,-1994 # 6978 <malloc+0xcb8>
    214a:	00004097          	auipc	ra,0x4
    214e:	ab8080e7          	jalr	-1352(ra) # 5c02 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	afc50513          	addi	a0,a0,-1284 # 6c60 <malloc+0xfa0>
    216c:	00004097          	auipc	ra,0x4
    2170:	a96080e7          	jalr	-1386(ra) # 5c02 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	79250513          	addi	a0,a0,1938 # 6978 <malloc+0xcb8>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	a14080e7          	jalr	-1516(ra) # 5c02 <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    2216:	a6e50513          	addi	a0,a0,-1426 # 6c80 <malloc+0xfc0>
    221a:	00004097          	auipc	ra,0x4
    221e:	9e8080e7          	jalr	-1560(ra) # 5c02 <printf>
      exit(1);
    2222:	4505                	li	a0,1
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	a5650513          	addi	a0,a0,-1450 # 6c98 <malloc+0xfd8>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	a2450513          	addi	a0,a0,-1500 # 6c98 <malloc+0xfd8>
  ...
  close(fd);
    ...
    229e:	31678793          	addi	a5,a5,790 # 85b0 <args.1877>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	40668693          	addi	a3,a3,1030 # 86a8 <args.1877+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	9fe70713          	addi	a4,a4,-1538 # 6ca8 <malloc+0xfe8>
    ...
    2302:	a8a50513          	addi	a0,a0,-1398 # 6d88 <malloc+0x10c8>
    2306:	00004097          	auipc	ra,0x4
    230a:	8fc080e7          	jalr	-1796(ra) # 5c02 <printf>
    exit(1);
    230e:	4505                	li	a0,1
    ...
    2326:	a8650513          	addi	a0,a0,-1402 # 6da8 <malloc+0x10e8>
    232a:	00004097          	auipc	ra,0x4
    232e:	8d8080e7          	jalr	-1832(ra) # 5c02 <printf>
    exit(1);
    2332:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237a:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0228>
    237e:	85a6                	mv	a1,s1
    2380:	00005517          	auipc	a0,0x5
    2384:	a4850513          	addi	a0,a0,-1464 # 6dc8 <malloc+0x1108>
    2388:	00004097          	auipc	ra,0x4
    238c:	87a080e7          	jalr	-1926(ra) # 5c02 <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    23a0:	5dc50513          	addi	a0,a0,1500 # 6978 <malloc+0xcb8>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	85e080e7          	jalr	-1954(ra) # 5c02 <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	62a78793          	addi	a5,a5,1578 # 7a60 <malloc+0x1da0>
  ...
  if(ret != -1){
    ...
    247c:	97850513          	addi	a0,a0,-1672 # 6df0 <malloc+0x1130>
    2480:	00003097          	auipc	ra,0x3
    2484:	782080e7          	jalr	1922(ra) # 5c02 <printf>
    exit(1);
    2488:	4505                	li	a0,1
    ...
    249a:	40250513          	addi	a0,a0,1026 # 6898 <malloc+0xbd8>
    249e:	00003097          	auipc	ra,0x3
    24a2:	764080e7          	jalr	1892(ra) # 5c02 <printf>
    exit(1);
    24a6:	4505                	li	a0,1
    ...
    24b8:	40450513          	addi	a0,a0,1028 # 68b8 <malloc+0xbf8>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	746080e7          	jalr	1862(ra) # 5c02 <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d8:	40450513          	addi	a0,a0,1028 # 68d8 <malloc+0xc18>
    24dc:	00003097          	auipc	ra,0x3
    24e0:	726080e7          	jalr	1830(ra) # 5c02 <printf>
    exit(1);
    24e4:	4505                	li	a0,1
    ...
    24f6:	40e50513          	addi	a0,a0,1038 # 6900 <malloc+0xc40>
    24fa:	00003097          	auipc	ra,0x3
    24fe:	708080e7          	jalr	1800(ra) # 5c02 <printf>
    exit(1);
    2502:	4505                	li	a0,1
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	8f250513          	addi	a0,a0,-1806 # 5e30 <malloc+0x170>
  ...
  if(n >= 0){
    ...
    2574:	8d850513          	addi	a0,a0,-1832 # 6e48 <malloc+0x1188>
    2578:	00003097          	auipc	ra,0x3
    257c:	68a080e7          	jalr	1674(ra) # 5c02 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	86e50513          	addi	a0,a0,-1938 # 6df8 <malloc+0x1138>
    2592:	00003097          	auipc	ra,0x3
    2596:	670080e7          	jalr	1648(ra) # 5c02 <printf>
    exit(1);
    259a:	4505                	li	a0,1
    ...
    25a8:	86c50513          	addi	a0,a0,-1940 # 6e10 <malloc+0x1150>
    25ac:	00003097          	auipc	ra,0x3
    25b0:	656080e7          	jalr	1622(ra) # 5c02 <printf>
    exit(1);
    25b4:	4505                	li	a0,1
    ...
    25c2:	87250513          	addi	a0,a0,-1934 # 6e30 <malloc+0x1170>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	63c080e7          	jalr	1596(ra) # 5c02 <printf>
    exit(1);
    25ce:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e6:	84e50513          	addi	a0,a0,-1970 # 5e30 <malloc+0x170>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2b8080e7          	jalr	696(ra) # 58a2 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	ce450513          	addi	a0,a0,-796 # 62d8 <malloc+0x618>
  ...
  if(n >= 0){
    ...
    2622:	85a50513          	addi	a0,a0,-1958 # 6e78 <malloc+0x11b8>
    2626:	00003097          	auipc	ra,0x3
    262a:	5dc080e7          	jalr	1500(ra) # 5c02 <printf>
    exit(1);
    262e:	4505                	li	a0,1
    ...
    263c:	7f850513          	addi	a0,a0,2040 # 6e30 <malloc+0x1170>
    2640:	00003097          	auipc	ra,0x3
    2644:	5c2080e7          	jalr	1474(ra) # 5c02 <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1228>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26be:	7e650513          	addi	a0,a0,2022 # 6ea0 <malloc+0x11e0>
    26c2:	00003097          	auipc	ra,0x3
    26c6:	540080e7          	jalr	1344(ra) # 5c02 <printf>
    exit(1);
    26ca:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2712:	7b250513          	addi	a0,a0,1970 # 6ec0 <malloc+0x1200>
    2716:	00003097          	auipc	ra,0x3
    271a:	4ec080e7          	jalr	1260(ra) # 5c02 <printf>
    exit(1);
    271e:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2774:	7b050513          	addi	a0,a0,1968 # 6f20 <malloc+0x1260>
    2778:	00003097          	auipc	ra,0x3
    277c:	48a080e7          	jalr	1162(ra) # 5c02 <printf>
    exit(1);
    2780:	4505                	li	a0,1
    ...
    2796:	74e50513          	addi	a0,a0,1870 # 6ee0 <malloc+0x1220>
    279a:	00003097          	auipc	ra,0x3
    279e:	468080e7          	jalr	1128(ra) # 5c02 <printf>
      exit(1);
    27a2:	4505                	li	a0,1
    ...
    27b2:	75250513          	addi	a0,a0,1874 # 6f00 <malloc+0x1240>
    27b6:	00003097          	auipc	ra,0x3
    27ba:	44c080e7          	jalr	1100(ra) # 5c02 <printf>
    exit(1);
    27be:	4505                	li	a0,1
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1227>
  a = sbrk(0);
    2854:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1227>
  ...
  if(c != a){
    ...
    28fc:	64850513          	addi	a0,a0,1608 # 6f40 <malloc+0x1280>
    2900:	00003097          	auipc	ra,0x3
    2904:	302080e7          	jalr	770(ra) # 5c02 <printf>
    exit(1);
    2908:	4505                	li	a0,1
    ...
    2918:	67450513          	addi	a0,a0,1652 # 6f88 <malloc+0x12c8>
    291c:	00003097          	auipc	ra,0x3
    2920:	2e6080e7          	jalr	742(ra) # 5c02 <printf>
    exit(1);
    2924:	4505                	li	a0,1
    ...
    2938:	67450513          	addi	a0,a0,1652 # 6fa8 <malloc+0x12e8>
    293c:	00003097          	auipc	ra,0x3
    2940:	2c6080e7          	jalr	710(ra) # 5c02 <printf>
    exit(1);
    2944:	4505                	li	a0,1
    ...
    2958:	69450513          	addi	a0,a0,1684 # 6fe8 <malloc+0x1328>
    295c:	00003097          	auipc	ra,0x3
    2960:	2a6080e7          	jalr	678(ra) # 5c02 <printf>
    exit(1);
    2964:	4505                	li	a0,1
    ...
    2974:	6a850513          	addi	a0,a0,1704 # 7018 <malloc+0x1358>
    2978:	00003097          	auipc	ra,0x3
    297c:	28a080e7          	jalr	650(ra) # 5c02 <printf>
    exit(1);
    2980:	4505                	li	a0,1
    ...
    2994:	6c050513          	addi	a0,a0,1728 # 7050 <malloc+0x1390>
    2998:	00003097          	auipc	ra,0x3
    299c:	26a080e7          	jalr	618(ra) # 5c02 <printf>
    exit(1);
    29a0:	4505                	li	a0,1
...
00000000000029aa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29ce:	6ae50513          	addi	a0,a0,1710 # 7078 <malloc+0x13b8>
    29d2:	00003097          	auipc	ra,0x3
    29d6:	ec0080e7          	jalr	-320(ra) # 5892 <open>
    29da:	84aa                	mv	s1,a0
  unlink("sbrk");
    29dc:	00004517          	auipc	a0,0x4
    29e0:	69c50513          	addi	a0,a0,1692 # 7078 <malloc+0x13b8>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a34:	65050513          	addi	a0,a0,1616 # 7080 <malloc+0x13c0>
    2a38:	00003097          	auipc	ra,0x3
    2a3c:	1ca080e7          	jalr	458(ra) # 5c02 <printf>
    exit(1);
    2a40:	4505                	li	a0,1
    ...
    2a50:	64c50513          	addi	a0,a0,1612 # 7098 <malloc+0x13d8>
    2a54:	00003097          	auipc	ra,0x3
    2a58:	1ae080e7          	jalr	430(ra) # 5c02 <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a6c:	01850513          	addi	a0,a0,24 # 6a80 <malloc+0xdc0>
    2a70:	00003097          	auipc	ra,0x3
    2a74:	192080e7          	jalr	402(ra) # 5c02 <printf>
    exit(1);
    2a78:	4505                	li	a0,1
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	61e50513          	addi	a0,a0,1566 # 70b0 <malloc+0x13f0>
  ...
  close(fd);
    ...
    2ade:	eb650513          	addi	a0,a0,-330 # 6990 <malloc+0xcd0>
    2ae2:	00003097          	auipc	ra,0x3
    2ae6:	120080e7          	jalr	288(ra) # 5c02 <printf>
    exit(1);
    2aea:	4505                	li	a0,1
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2c:	27050513          	addi	a0,a0,624 # 6d98 <malloc+0x10d8>
    2b30:	00003097          	auipc	ra,0x3
    2b34:	0d2080e7          	jalr	210(ra) # 5c02 <printf>
    exit(1);
    2b38:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b82:	21a50513          	addi	a0,a0,538 # 6d98 <malloc+0x10d8>
    2b86:	00003097          	auipc	ra,0x3
    2b8a:	07c080e7          	jalr	124(ra) # 5c02 <printf>
    exit(1);
    2b8e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2be2:	1ba50513          	addi	a0,a0,442 # 6d98 <malloc+0x10d8>
    2be6:	00003097          	auipc	ra,0x3
    2bea:	01c080e7          	jalr	28(ra) # 5c02 <printf>
    exit(1);
    2bee:	4505                	li	a0,1
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff1227>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d56:	04650513          	addi	a0,a0,70 # 6d98 <malloc+0x10d8>
    2d5a:	00003097          	auipc	ra,0x3
    2d5e:	ea8080e7          	jalr	-344(ra) # 5c02 <printf>
      exit(1);
    2d62:	4505                	li	a0,1
    ...
    2daa:	39a50513          	addi	a0,a0,922 # 6140 <malloc+0x480>
    2dae:	faa43c23          	sd	a0,-72(s0)
    2db2:	00003797          	auipc	a5,0x3
    2db6:	3fe78793          	addi	a5,a5,1022 # 61b0 <malloc+0x4f0>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	4a450513          	addi	a0,a0,1188 # 7288 <malloc+0x15c8>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	2ea50513          	addi	a0,a0,746 # 70e0 <malloc+0x1420>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e10:	32c50513          	addi	a0,a0,812 # 7138 <malloc+0x1478>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2e:	38650513          	addi	a0,a0,902 # 71b0 <malloc+0x14f0>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4a:	3da50513          	addi	a0,a0,986 # 7220 <malloc+0x1560>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	42050513          	addi	a0,a0,1056 # 7278 <malloc+0x15b8>
  ...
  unlink("12345678901234");
    ...
    2eda:	1e250513          	addi	a0,a0,482 # 70b8 <malloc+0x13f8>
    2ede:	00003097          	auipc	ra,0x3
    2ee2:	d24080e7          	jalr	-732(ra) # 5c02 <printf>
    exit(1);
    2ee6:	4505                	li	a0,1
    ...
    2ef6:	20e50513          	addi	a0,a0,526 # 7100 <malloc+0x1440>
    2efa:	00003097          	auipc	ra,0x3
    2efe:	d08080e7          	jalr	-760(ra) # 5c02 <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f12:	25a50513          	addi	a0,a0,602 # 7168 <malloc+0x14a8>
    2f16:	00003097          	auipc	ra,0x3
    2f1a:	cec080e7          	jalr	-788(ra) # 5c02 <printf>
    exit(1);
    2f1e:	4505                	li	a0,1
    ...
    2f2e:	2b650513          	addi	a0,a0,694 # 71e0 <malloc+0x1520>
    2f32:	00003097          	auipc	ra,0x3
    2f36:	cd0080e7          	jalr	-816(ra) # 5c02 <printf>
    exit(1);
    2f3a:	4505                	li	a0,1
    ...
    2f4a:	2fa50513          	addi	a0,a0,762 # 7240 <malloc+0x1580>
    2f4e:	00003097          	auipc	ra,0x3
    2f52:	cb4080e7          	jalr	-844(ra) # 5c02 <printf>
    exit(1);
    2f56:	4505                	li	a0,1
    ...
    2f66:	33650513          	addi	a0,a0,822 # 7298 <malloc+0x15d8>
    2f6a:	00003097          	auipc	ra,0x3
    2f6e:	c98080e7          	jalr	-872(ra) # 5c02 <printf>
    exit(1);
    2f72:	4505                	li	a0,1
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	34850513          	addi	a0,a0,840 # 72d0 <malloc+0x1610>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	33450513          	addi	a0,a0,820 # 72d0 <malloc+0x1610>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	36050513          	addi	a0,a0,864 # 7310 <malloc+0x1650>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	37c50513          	addi	a0,a0,892 # 7340 <malloc+0x1680>
    ...
    2fe8:	2f450513          	addi	a0,a0,756 # 72d8 <malloc+0x1618>
    2fec:	00003097          	auipc	ra,0x3
    2ff0:	c16080e7          	jalr	-1002(ra) # 5c02 <printf>
    exit(1);
    2ff4:	4505                	li	a0,1
    ...
    3004:	2f050513          	addi	a0,a0,752 # 72f0 <malloc+0x1630>
    3008:	00003097          	auipc	ra,0x3
    300c:	bfa080e7          	jalr	-1030(ra) # 5c02 <printf>
    exit(1);
    3010:	4505                	li	a0,1
    ...
    3020:	30450513          	addi	a0,a0,772 # 7320 <malloc+0x1660>
    3024:	00003097          	auipc	ra,0x3
    3028:	bde080e7          	jalr	-1058(ra) # 5c02 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    303c:	31050513          	addi	a0,a0,784 # 7348 <malloc+0x1688>
    3040:	00003097          	auipc	ra,0x3
    3044:	bc2080e7          	jalr	-1086(ra) # 5c02 <printf>
    exit(1);
    3048:	4505                	li	a0,1
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3070:	26450513          	addi	a0,a0,612 # 72d0 <malloc+0x1610>
    ...
    3084:	25050513          	addi	a0,a0,592 # 72d0 <malloc+0x1610>
    ...
    3098:	27c50513          	addi	a0,a0,636 # 7310 <malloc+0x1650>
    ...
    30b8:	8c450513          	addi	a0,a0,-1852 # 6978 <malloc+0xcb8>
    30bc:	00003097          	auipc	ra,0x3
    30c0:	b46080e7          	jalr	-1210(ra) # 5c02 <printf>
    exit(1);
    30c4:	4505                	li	a0,1
    ...
    30d4:	20850513          	addi	a0,a0,520 # 72d8 <malloc+0x1618>
    30d8:	00003097          	auipc	ra,0x3
    30dc:	b2a080e7          	jalr	-1238(ra) # 5c02 <printf>
      exit(1);
    30e0:	4505                	li	a0,1
    ...
    30f0:	27450513          	addi	a0,a0,628 # 7360 <malloc+0x16a0>
    30f4:	00003097          	auipc	ra,0x3
    30f8:	b0e080e7          	jalr	-1266(ra) # 5c02 <printf>
      exit(1);
    30fc:	4505                	li	a0,1
    ...
    310c:	21850513          	addi	a0,a0,536 # 7320 <malloc+0x1660>
    3110:	00003097          	auipc	ra,0x3
    3114:	af2080e7          	jalr	-1294(ra) # 5c02 <printf>
      exit(1);
    3118:	4505                	li	a0,1
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	23250513          	addi	a0,a0,562 # 7378 <malloc+0x16b8>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	21e50513          	addi	a0,a0,542 # 7378 <malloc+0x16b8>
  ...
  if(chdir("..") < 0){
    ...
    3172:	22a50513          	addi	a0,a0,554 # 7398 <malloc+0x16d8>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	1f650513          	addi	a0,a0,502 # 7378 <malloc+0x16b8>
    ...
    31a6:	13650513          	addi	a0,a0,310 # 72d8 <malloc+0x1618>
    31aa:	00003097          	auipc	ra,0x3
    31ae:	a58080e7          	jalr	-1448(ra) # 5c02 <printf>
    exit(1);
    31b2:	4505                	li	a0,1
    ...
    31c2:	1c250513          	addi	a0,a0,450 # 7380 <malloc+0x16c0>
    31c6:	00003097          	auipc	ra,0x3
    31ca:	a3c080e7          	jalr	-1476(ra) # 5c02 <printf>
    exit(1);
    31ce:	4505                	li	a0,1
    ...
    31de:	1c650513          	addi	a0,a0,454 # 73a0 <malloc+0x16e0>
    31e2:	00003097          	auipc	ra,0x3
    31e6:	a20080e7          	jalr	-1504(ra) # 5c02 <printf>
    exit(1);
    31ea:	4505                	li	a0,1
    ...
    31fa:	1c250513          	addi	a0,a0,450 # 73b8 <malloc+0x16f8>
    31fe:	00003097          	auipc	ra,0x3
    3202:	a04080e7          	jalr	-1532(ra) # 5c02 <printf>
    exit(1);
    3206:	4505                	li	a0,1
...
0000000000003210 <subdir>:
{
  ...
  unlink("ff");
    ...
    3222:	2e250513          	addi	a0,a0,738 # 7500 <malloc+0x1840>
    3226:	00002097          	auipc	ra,0x2
    322a:	67c080e7          	jalr	1660(ra) # 58a2 <unlink>
  if(mkdir("dd") != 0){
    322e:	00004517          	auipc	a0,0x4
    3232:	1a250513          	addi	a0,a0,418 # 73d0 <malloc+0x1710>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	1aa50513          	addi	a0,a0,426 # 73f0 <malloc+0x1730>
  ...
  write(fd, "ff", 2);
    ...
    3262:	2a258593          	addi	a1,a1,674 # 7500 <malloc+0x1840>
  ...
  if(unlink("dd") >= 0){
    ...
    327c:	15850513          	addi	a0,a0,344 # 73d0 <malloc+0x1710>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	1bc50513          	addi	a0,a0,444 # 7448 <malloc+0x1788>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	1cc50513          	addi	a0,a0,460 # 7470 <malloc+0x17b0>
  ...
  write(fd, "FF", 2);
    ...
    32c0:	1e458593          	addi	a1,a1,484 # 74a0 <malloc+0x17e0>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32dc:	1d050513          	addi	a0,a0,464 # 74a8 <malloc+0x17e8>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	ad858593          	addi	a1,a1,-1320 # bdc8 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330a:	ac274703          	lbu	a4,-1342(a4) # bdc8 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3324:	1d858593          	addi	a1,a1,472 # 74f8 <malloc+0x1838>
    3328:	00004517          	auipc	a0,0x4
    332c:	14850513          	addi	a0,a0,328 # 7470 <malloc+0x17b0>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	13450513          	addi	a0,a0,308 # 7470 <malloc+0x17b0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	11e50513          	addi	a0,a0,286 # 7470 <malloc+0x17b0>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	06a50513          	addi	a0,a0,106 # 73d0 <malloc+0x1710>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	21650513          	addi	a0,a0,534 # 7590 <malloc+0x18d0>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	23250513          	addi	a0,a0,562 # 75c0 <malloc+0x1900>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	24e50513          	addi	a0,a0,590 # 75f0 <malloc+0x1930>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	14050513          	addi	a0,a0,320 # 74f8 <malloc+0x1838>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d4:	9f858593          	addi	a1,a1,-1544 # bdc8 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f6:	07e50513          	addi	a0,a0,126 # 7470 <malloc+0x17b0>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	27650513          	addi	a0,a0,630 # 7680 <malloc+0x19c0>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	28e50513          	addi	a0,a0,654 # 76b0 <malloc+0x19f0>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	f9650513          	addi	a0,a0,-106 # 73d0 <malloc+0x1710>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	f8050513          	addi	a0,a0,-128 # 73d0 <malloc+0x1710>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	f6a50513          	addi	a0,a0,-150 # 73d0 <malloc+0x1710>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347e:	2c658593          	addi	a1,a1,710 # 7740 <malloc+0x1a80>
    3482:	00004517          	auipc	a0,0x4
    3486:	1fe50513          	addi	a0,a0,510 # 7680 <malloc+0x19c0>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349a:	2aa58593          	addi	a1,a1,682 # 7740 <malloc+0x1a80>
    349e:	00004517          	auipc	a0,0x4
    34a2:	21250513          	addi	a0,a0,530 # 76b0 <malloc+0x19f0>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b6:	04658593          	addi	a1,a1,70 # 74f8 <malloc+0x1838>
    34ba:	00004517          	auipc	a0,0x4
    34be:	f3650513          	addi	a0,a0,-202 # 73f0 <malloc+0x1730>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	1b250513          	addi	a0,a0,434 # 7680 <malloc+0x19c0>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	1ce50513          	addi	a0,a0,462 # 76b0 <malloc+0x19f0>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	00250513          	addi	a0,a0,2 # 74f8 <malloc+0x1838>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	1a650513          	addi	a0,a0,422 # 76b0 <malloc+0x19f0>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	16250513          	addi	a0,a0,354 # 7680 <malloc+0x19c0>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	ebe50513          	addi	a0,a0,-322 # 73f0 <malloc+0x1730>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	34a50513          	addi	a0,a0,842 # 7890 <malloc+0x1bd0>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	f9e50513          	addi	a0,a0,-98 # 74f8 <malloc+0x1838>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	e8250513          	addi	a0,a0,-382 # 73f0 <malloc+0x1730>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	e4e50513          	addi	a0,a0,-434 # 73d0 <malloc+0x1710>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	36a50513          	addi	a0,a0,874 # 7900 <malloc+0x1c40>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	e2650513          	addi	a0,a0,-474 # 73d0 <malloc+0x1710>
    ...
    35d0:	e0c50513          	addi	a0,a0,-500 # 73d8 <malloc+0x1718>
    35d4:	00002097          	auipc	ra,0x2
    35d8:	62e080e7          	jalr	1582(ra) # 5c02 <printf>
    exit(1);
    35dc:	4505                	li	a0,1
    ...
    35ec:	e1050513          	addi	a0,a0,-496 # 73f8 <malloc+0x1738>
    35f0:	00002097          	auipc	ra,0x2
    35f4:	612080e7          	jalr	1554(ra) # 5c02 <printf>
    exit(1);
    35f8:	4505                	li	a0,1
    ...
    3608:	e1450513          	addi	a0,a0,-492 # 7418 <malloc+0x1758>
    360c:	00002097          	auipc	ra,0x2
    3610:	5f6080e7          	jalr	1526(ra) # 5c02 <printf>
    exit(1);
    3614:	4505                	li	a0,1
    ...
    3624:	e3050513          	addi	a0,a0,-464 # 7450 <malloc+0x1790>
    3628:	00002097          	auipc	ra,0x2
    362c:	5da080e7          	jalr	1498(ra) # 5c02 <printf>
    exit(1);
    3630:	4505                	li	a0,1
    ...
    3640:	e4450513          	addi	a0,a0,-444 # 7480 <malloc+0x17c0>
    3644:	00002097          	auipc	ra,0x2
    3648:	5be080e7          	jalr	1470(ra) # 5c02 <printf>
    exit(1);
    364c:	4505                	li	a0,1
    ...
    365c:	e6050513          	addi	a0,a0,-416 # 74b8 <malloc+0x17f8>
    3660:	00002097          	auipc	ra,0x2
    3664:	5a2080e7          	jalr	1442(ra) # 5c02 <printf>
    exit(1);
    3668:	4505                	li	a0,1
    ...
    3678:	e6450513          	addi	a0,a0,-412 # 74d8 <malloc+0x1818>
    367c:	00002097          	auipc	ra,0x2
    3680:	586080e7          	jalr	1414(ra) # 5c02 <printf>
    exit(1);
    3684:	4505                	li	a0,1
    ...
    3694:	e7850513          	addi	a0,a0,-392 # 7508 <malloc+0x1848>
    3698:	00002097          	auipc	ra,0x2
    369c:	56a080e7          	jalr	1386(ra) # 5c02 <printf>
    exit(1);
    36a0:	4505                	li	a0,1
    ...
    36b0:	e8450513          	addi	a0,a0,-380 # 7530 <malloc+0x1870>
    36b4:	00002097          	auipc	ra,0x2
    36b8:	54e080e7          	jalr	1358(ra) # 5c02 <printf>
    exit(1);
    36bc:	4505                	li	a0,1
    ...
    36cc:	e8850513          	addi	a0,a0,-376 # 7550 <malloc+0x1890>
    36d0:	00002097          	auipc	ra,0x2
    36d4:	532080e7          	jalr	1330(ra) # 5c02 <printf>
    exit(1);
    36d8:	4505                	li	a0,1
    ...
    36e8:	e9450513          	addi	a0,a0,-364 # 7578 <malloc+0x18b8>
    36ec:	00002097          	auipc	ra,0x2
    36f0:	516080e7          	jalr	1302(ra) # 5c02 <printf>
    exit(1);
    36f4:	4505                	li	a0,1
    ...
    3704:	ea050513          	addi	a0,a0,-352 # 75a0 <malloc+0x18e0>
    3708:	00002097          	auipc	ra,0x2
    370c:	4fa080e7          	jalr	1274(ra) # 5c02 <printf>
    exit(1);
    3710:	4505                	li	a0,1
    ...
    3720:	eb450513          	addi	a0,a0,-332 # 75d0 <malloc+0x1910>
    3724:	00002097          	auipc	ra,0x2
    3728:	4de080e7          	jalr	1246(ra) # 5c02 <printf>
    exit(1);
    372c:	4505                	li	a0,1
    ...
    373c:	ec050513          	addi	a0,a0,-320 # 75f8 <malloc+0x1938>
    3740:	00002097          	auipc	ra,0x2
    3744:	4c2080e7          	jalr	1218(ra) # 5c02 <printf>
    exit(1);
    3748:	4505                	li	a0,1
    ...
    3758:	ebc50513          	addi	a0,a0,-324 # 7610 <malloc+0x1950>
    375c:	00002097          	auipc	ra,0x2
    3760:	4a6080e7          	jalr	1190(ra) # 5c02 <printf>
    exit(1);
    3764:	4505                	li	a0,1
    ...
    3774:	ec050513          	addi	a0,a0,-320 # 7630 <malloc+0x1970>
    3778:	00002097          	auipc	ra,0x2
    377c:	48a080e7          	jalr	1162(ra) # 5c02 <printf>
    exit(1);
    3780:	4505                	li	a0,1
    ...
    3790:	ec450513          	addi	a0,a0,-316 # 7650 <malloc+0x1990>
    3794:	00002097          	auipc	ra,0x2
    3798:	46e080e7          	jalr	1134(ra) # 5c02 <printf>
    exit(1);
    379c:	4505                	li	a0,1
    ...
    37ac:	ee850513          	addi	a0,a0,-280 # 7690 <malloc+0x19d0>
    37b0:	00002097          	auipc	ra,0x2
    37b4:	452080e7          	jalr	1106(ra) # 5c02 <printf>
    exit(1);
    37b8:	4505                	li	a0,1
    ...
    37c8:	efc50513          	addi	a0,a0,-260 # 76c0 <malloc+0x1a00>
    37cc:	00002097          	auipc	ra,0x2
    37d0:	436080e7          	jalr	1078(ra) # 5c02 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e4:	f0050513          	addi	a0,a0,-256 # 76e0 <malloc+0x1a20>
    37e8:	00002097          	auipc	ra,0x2
    37ec:	41a080e7          	jalr	1050(ra) # 5c02 <printf>
    exit(1);
    37f0:	4505                	li	a0,1
    ...
    3800:	f0450513          	addi	a0,a0,-252 # 7700 <malloc+0x1a40>
    3804:	00002097          	auipc	ra,0x2
    3808:	3fe080e7          	jalr	1022(ra) # 5c02 <printf>
    exit(1);
    380c:	4505                	li	a0,1
    ...
    381c:	f0850513          	addi	a0,a0,-248 # 7720 <malloc+0x1a60>
    3820:	00002097          	auipc	ra,0x2
    3824:	3e2080e7          	jalr	994(ra) # 5c02 <printf>
    exit(1);
    3828:	4505                	li	a0,1
    ...
    3838:	f1c50513          	addi	a0,a0,-228 # 7750 <malloc+0x1a90>
    383c:	00002097          	auipc	ra,0x2
    3840:	3c6080e7          	jalr	966(ra) # 5c02 <printf>
    exit(1);
    3844:	4505                	li	a0,1
    ...
    3854:	f2850513          	addi	a0,a0,-216 # 7778 <malloc+0x1ab8>
    3858:	00002097          	auipc	ra,0x2
    385c:	3aa080e7          	jalr	938(ra) # 5c02 <printf>
    exit(1);
    3860:	4505                	li	a0,1
    ...
    3870:	f3450513          	addi	a0,a0,-204 # 77a0 <malloc+0x1ae0>
    3874:	00002097          	auipc	ra,0x2
    3878:	38e080e7          	jalr	910(ra) # 5c02 <printf>
    exit(1);
    387c:	4505                	li	a0,1
    ...
    388c:	f4050513          	addi	a0,a0,-192 # 77c8 <malloc+0x1b08>
    3890:	00002097          	auipc	ra,0x2
    3894:	372080e7          	jalr	882(ra) # 5c02 <printf>
    exit(1);
    3898:	4505                	li	a0,1
    ...
    38a8:	f4450513          	addi	a0,a0,-188 # 77e8 <malloc+0x1b28>
    38ac:	00002097          	auipc	ra,0x2
    38b0:	356080e7          	jalr	854(ra) # 5c02 <printf>
    exit(1);
    38b4:	4505                	li	a0,1
    ...
    38c4:	f4850513          	addi	a0,a0,-184 # 7808 <malloc+0x1b48>
    38c8:	00002097          	auipc	ra,0x2
    38cc:	33a080e7          	jalr	826(ra) # 5c02 <printf>
    exit(1);
    38d0:	4505                	li	a0,1
    ...
    38e0:	f5450513          	addi	a0,a0,-172 # 7830 <malloc+0x1b70>
    38e4:	00002097          	auipc	ra,0x2
    38e8:	31e080e7          	jalr	798(ra) # 5c02 <printf>
    exit(1);
    38ec:	4505                	li	a0,1
    ...
    38fc:	f5850513          	addi	a0,a0,-168 # 7850 <malloc+0x1b90>
    3900:	00002097          	auipc	ra,0x2
    3904:	302080e7          	jalr	770(ra) # 5c02 <printf>
    exit(1);
    3908:	4505                	li	a0,1
    ...
    3918:	f5c50513          	addi	a0,a0,-164 # 7870 <malloc+0x1bb0>
    391c:	00002097          	auipc	ra,0x2
    3920:	2e6080e7          	jalr	742(ra) # 5c02 <printf>
    exit(1);
    3924:	4505                	li	a0,1
    ...
    3934:	f6850513          	addi	a0,a0,-152 # 7898 <malloc+0x1bd8>
    3938:	00002097          	auipc	ra,0x2
    393c:	2ca080e7          	jalr	714(ra) # 5c02 <printf>
    exit(1);
    3940:	4505                	li	a0,1
    ...
    3950:	be450513          	addi	a0,a0,-1052 # 7530 <malloc+0x1870>
    3954:	00002097          	auipc	ra,0x2
    3958:	2ae080e7          	jalr	686(ra) # 5c02 <printf>
    exit(1);
    395c:	4505                	li	a0,1
    ...
    396c:	f5050513          	addi	a0,a0,-176 # 78b8 <malloc+0x1bf8>
    3970:	00002097          	auipc	ra,0x2
    3974:	292080e7          	jalr	658(ra) # 5c02 <printf>
    exit(1);
    3978:	4505                	li	a0,1
    ...
    3988:	f5450513          	addi	a0,a0,-172 # 78d8 <malloc+0x1c18>
    398c:	00002097          	auipc	ra,0x2
    3990:	276080e7          	jalr	630(ra) # 5c02 <printf>
    exit(1);
    3994:	4505                	li	a0,1
    ...
    39a4:	f6850513          	addi	a0,a0,-152 # 7908 <malloc+0x1c48>
    39a8:	00002097          	auipc	ra,0x2
    39ac:	25a080e7          	jalr	602(ra) # 5c02 <printf>
    exit(1);
    39b0:	4505                	li	a0,1
    ...
    39c0:	f6c50513          	addi	a0,a0,-148 # 7928 <malloc+0x1c68>
    39c4:	00002097          	auipc	ra,0x2
    39c8:	23e080e7          	jalr	574(ra) # 5c02 <printf>
    exit(1);
    39cc:	4505                	li	a0,1
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	f5e50513          	addi	a0,a0,-162 # 7940 <malloc+0x1c80>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	f4c50513          	addi	a0,a0,-180 # 7940 <malloc+0x1c80>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	dd250513          	addi	a0,a0,-558 # 67d8 <malloc+0xb18>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	98050513          	addi	a0,a0,-1664 # 7398 <malloc+0x16d8>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	91650513          	addi	a0,a0,-1770 # 7340 <malloc+0x1680>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	f6c50513          	addi	a0,a0,-148 # 79a8 <malloc+0x1ce8>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	f8250513          	addi	a0,a0,-126 # 79d0 <malloc+0x1d10>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	ee050513          	addi	a0,a0,-288 # 7940 <malloc+0x1c80>
    ...
    3a82:	eca50513          	addi	a0,a0,-310 # 7948 <malloc+0x1c88>
    3a86:	00002097          	auipc	ra,0x2
    3a8a:	17c080e7          	jalr	380(ra) # 5c02 <printf>
    exit(1);
    3a8e:	4505                	li	a0,1
    ...
    3a9e:	ec650513          	addi	a0,a0,-314 # 7960 <malloc+0x1ca0>
    3aa2:	00002097          	auipc	ra,0x2
    3aa6:	160080e7          	jalr	352(ra) # 5c02 <printf>
    exit(1);
    3aaa:	4505                	li	a0,1
    ...
    3aba:	ec250513          	addi	a0,a0,-318 # 7978 <malloc+0x1cb8>
    3abe:	00002097          	auipc	ra,0x2
    3ac2:	144080e7          	jalr	324(ra) # 5c02 <printf>
    exit(1);
    3ac6:	4505                	li	a0,1
    ...
    3ad6:	ebe50513          	addi	a0,a0,-322 # 7990 <malloc+0x1cd0>
    3ada:	00002097          	auipc	ra,0x2
    3ade:	128080e7          	jalr	296(ra) # 5c02 <printf>
    exit(1);
    3ae2:	4505                	li	a0,1
    ...
    3af2:	85a50513          	addi	a0,a0,-1958 # 7348 <malloc+0x1688>
    3af6:	00002097          	auipc	ra,0x2
    3afa:	10c080e7          	jalr	268(ra) # 5c02 <printf>
    exit(1);
    3afe:	4505                	li	a0,1
    ...
    3b0e:	ea650513          	addi	a0,a0,-346 # 79b0 <malloc+0x1cf0>
    3b12:	00002097          	auipc	ra,0x2
    3b16:	0f0080e7          	jalr	240(ra) # 5c02 <printf>
    exit(1);
    3b1a:	4505                	li	a0,1
    ...
    3b2a:	eb250513          	addi	a0,a0,-334 # 79d8 <malloc+0x1d18>
    3b2e:	00002097          	auipc	ra,0x2
    3b32:	0d4080e7          	jalr	212(ra) # 5c02 <printf>
    exit(1);
    3b36:	4505                	li	a0,1
    ...
    3b46:	eb650513          	addi	a0,a0,-330 # 79f8 <malloc+0x1d38>
    3b4a:	00002097          	auipc	ra,0x2
    3b4e:	0b8080e7          	jalr	184(ra) # 5c02 <printf>
    exit(1);
    3b52:	4505                	li	a0,1
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b72:	57250513          	addi	a0,a0,1394 # 60e0 <malloc+0x420>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8e:	55650513          	addi	a0,a0,1366 # 60e0 <malloc+0x420>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	eba50513          	addi	a0,a0,-326 # 7a58 <malloc+0x1d98>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	ea250513          	addi	a0,a0,-350 # 7a58 <malloc+0x1d98>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	e8e50513          	addi	a0,a0,-370 # 7a58 <malloc+0x1d98>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	e7a50513          	addi	a0,a0,-390 # 7a58 <malloc+0x1d98>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf6:	e6658593          	addi	a1,a1,-410 # 7a58 <malloc+0x1d98>
    3bfa:	00002517          	auipc	a0,0x2
    3bfe:	6de50513          	addi	a0,a0,1758 # 62d8 <malloc+0x618>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	4d250513          	addi	a0,a0,1234 # 60e0 <malloc+0x420>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	bb450513          	addi	a0,a0,-1100 # 67d8 <malloc+0xb18>
  ...
  fd = open(".", 0);
    ...
    3c3e:	b9e50513          	addi	a0,a0,-1122 # 67d8 <malloc+0xb18>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c52:	56258593          	addi	a1,a1,1378 # 61b0 <malloc+0x4f0>
  ...
  close(fd);
    ...
    3c7e:	d9e50513          	addi	a0,a0,-610 # 7a18 <malloc+0x1d58>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	f80080e7          	jalr	-128(ra) # 5c02 <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	da250513          	addi	a0,a0,-606 # 7a38 <malloc+0x1d78>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	f64080e7          	jalr	-156(ra) # 5c02 <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	db650513          	addi	a0,a0,-586 # 7a68 <malloc+0x1da8>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	f48080e7          	jalr	-184(ra) # 5c02 <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	d9a50513          	addi	a0,a0,-614 # 7a68 <malloc+0x1da8>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	f2c080e7          	jalr	-212(ra) # 5c02 <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	da650513          	addi	a0,a0,-602 # 7a90 <malloc+0x1dd0>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	f10080e7          	jalr	-240(ra) # 5c02 <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	db250513          	addi	a0,a0,-590 # 7ab8 <malloc+0x1df8>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	ef4080e7          	jalr	-268(ra) # 5c02 <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	dbe50513          	addi	a0,a0,-578 # 7ae0 <malloc+0x1e20>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	ed8080e7          	jalr	-296(ra) # 5c02 <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	dca50513          	addi	a0,a0,-566 # 7b08 <malloc+0x1e48>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	ebc080e7          	jalr	-324(ra) # 5c02 <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	dce50513          	addi	a0,a0,-562 # 7b28 <malloc+0x1e68>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	ea0080e7          	jalr	-352(ra) # 5c02 <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	dda50513          	addi	a0,a0,-550 # 7b50 <malloc+0x1e90>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	e84080e7          	jalr	-380(ra) # 5c02 <printf>
    exit(1);
    3d86:	4505                	li	a0,1
...
0000000000003d90 <iref>:
{
    ...
    3dae:	dbea0a13          	addi	s4,s4,-578 # 7b68 <malloc+0x1ea8>
    mkdir("");
    3db2:	00004497          	auipc	s1,0x4
    3db6:	8c648493          	addi	s1,s1,-1850 # 7678 <malloc+0x19b8>
    link("README", "");
    3dba:	00002a97          	auipc	s5,0x2
    3dbe:	51ea8a93          	addi	s5,s5,1310 # 62d8 <malloc+0x618>
    fd = open("xx", O_CREATE);
    3dc2:	00004997          	auipc	s3,0x4
    3dc6:	c9e98993          	addi	s3,s3,-866 # 7a60 <malloc+0x1da0>
    3dca:	a891                	j	3e1e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dcc:	85da                	mv	a1,s6
    3dce:	00004517          	auipc	a0,0x4
    3dd2:	da250513          	addi	a0,a0,-606 # 7b70 <malloc+0x1eb0>
    3dd6:	00002097          	auipc	ra,0x2
    3dda:	e2c080e7          	jalr	-468(ra) # 5c02 <printf>
      exit(1);
    3dde:	4505                	li	a0,1
    ...
    3dee:	d9e50513          	addi	a0,a0,-610 # 7b88 <malloc+0x1ec8>
    3df2:	00002097          	auipc	ra,0x2
    3df6:	e10080e7          	jalr	-496(ra) # 5c02 <printf>
      exit(1);
    3dfa:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e82:	51a98993          	addi	s3,s3,1306 # 7398 <malloc+0x16d8>
    unlink("irefd");
    3e86:	00004917          	auipc	s2,0x4
    3e8a:	ce290913          	addi	s2,s2,-798 # 7b68 <malloc+0x1ea8>
    chdir("..");
    3e8e:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eaa:	49a50513          	addi	a0,a0,1178 # 7340 <malloc+0x1680>
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	cca50513          	addi	a0,a0,-822 # 7ba0 <malloc+0x1ee0>
  ...
  if(pid == 0){
    ...
    3efe:	ca650513          	addi	a0,a0,-858 # 7ba0 <malloc+0x1ee0>
    ...
    3f14:	cb050513          	addi	a0,a0,-848 # 7bc0 <malloc+0x1f00>
    3f18:	00002097          	auipc	ra,0x2
    3f1c:	cea080e7          	jalr	-790(ra) # 5c02 <printf>
      exit(1);
    3f20:	4505                	li	a0,1
    ...
    3f30:	c7c50513          	addi	a0,a0,-900 # 7ba8 <malloc+0x1ee8>
    3f34:	00002097          	auipc	ra,0x2
    3f38:	cce080e7          	jalr	-818(ra) # 5c02 <printf>
    exit(1);
    3f3c:	4505                	li	a0,1
    ...
    3f4c:	a3050513          	addi	a0,a0,-1488 # 6978 <malloc+0xcb8>
    3f50:	00002097          	auipc	ra,0x2
    3f54:	cb2080e7          	jalr	-846(ra) # 5c02 <printf>
    exit(1);
    3f58:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f7a:	c2a50513          	addi	a0,a0,-982 # 7ba0 <malloc+0x1ee0>
    ...
    3f8e:	bde50513          	addi	a0,a0,-1058 # 6b68 <malloc+0xea8>
    3f92:	00002097          	auipc	ra,0x2
    3f96:	c70080e7          	jalr	-912(ra) # 5c02 <printf>
    exit(1);
    3f9a:	4505                	li	a0,1
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	c2050513          	addi	a0,a0,-992 # 7be8 <malloc+0x1f28>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	bf450513          	addi	a0,a0,-1036 # 7be8 <malloc+0x1f28>
  ...
  sleep(10); // one second
    ...
    4030:	b0c50513          	addi	a0,a0,-1268 # 6b38 <malloc+0xe78>
    4034:	00002097          	auipc	ra,0x2
    4038:	bce080e7          	jalr	-1074(ra) # 5c02 <printf>
    exit(1);
    403c:	4505                	li	a0,1
    ...
    404a:	ba248493          	addi	s1,s1,-1118 # 7be8 <malloc+0x1f28>
    404e:	4581                	li	a1,0
    4050:	8526                	mv	a0,s1
...
000000000000408c <killstatus>:
{
  ...
  exit(0);
    ...
    40f2:	88a50513          	addi	a0,a0,-1910 # 6978 <malloc+0xcb8>
    40f6:	00002097          	auipc	ra,0x2
    40fa:	b0c080e7          	jalr	-1268(ra) # 5c02 <printf>
      exit(1);
    40fe:	4505                	li	a0,1
    ...
    4118:	ae450513          	addi	a0,a0,-1308 # 7bf8 <malloc+0x1f38>
    411c:	00002097          	auipc	ra,0x2
    4120:	ae6080e7          	jalr	-1306(ra) # 5c02 <printf>
       exit(1);
    4124:	4505                	li	a0,1
...
000000000000412e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4158:	9e450513          	addi	a0,a0,-1564 # 6b38 <malloc+0xe78>
    415c:	00002097          	auipc	ra,0x2
    4160:	aa6080e7          	jalr	-1370(ra) # 5c02 <printf>
    exit(1);
    4164:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4186:	7f650513          	addi	a0,a0,2038 # 6978 <malloc+0xcb8>
    418a:	00002097          	auipc	ra,0x2
    418e:	a78080e7          	jalr	-1416(ra) # 5c02 <printf>
    exit(1);
    4192:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41ca:	fea58593          	addi	a1,a1,-22 # 61b0 <malloc+0x4f0>
    ...
    41f4:	78850513          	addi	a0,a0,1928 # 6978 <malloc+0xcb8>
    41f8:	00002097          	auipc	ra,0x2
    41fc:	a0a080e7          	jalr	-1526(ra) # 5c02 <printf>
     exit(1);
    4200:	4505                	li	a0,1
    ...
    4210:	a0c50513          	addi	a0,a0,-1524 # 7c18 <malloc+0x1f58>
    4214:	00002097          	auipc	ra,0x2
    4218:	9ee080e7          	jalr	-1554(ra) # 5c02 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4230:	b9c58593          	addi	a1,a1,-1124 # bdc8 <buf>
    ...
    424c:	9e850513          	addi	a0,a0,-1560 # 7c30 <malloc+0x1f70>
    4250:	00002097          	auipc	ra,0x2
    4254:	9b2080e7          	jalr	-1614(ra) # 5c02 <printf>
}
  ...
  printf("kill... ");
    ...
    4278:	9d450513          	addi	a0,a0,-1580 # 7c48 <malloc+0x1f88>
    427c:	00002097          	auipc	ra,0x2
    4280:	986080e7          	jalr	-1658(ra) # 5c02 <printf>
  kill(pid1);
    4284:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    42a6:	9b650513          	addi	a0,a0,-1610 # 7c58 <malloc+0x1f98>
    42aa:	00002097          	auipc	ra,0x2
    42ae:	958080e7          	jalr	-1704(ra) # 5c02 <printf>
  wait(0);
    42b2:	4501                	li	a0,0
...
00000000000042d2 <reparent>:
{
  ...
  exit(0);
    ...
    4326:	65650513          	addi	a0,a0,1622 # 6978 <malloc+0xcb8>
    432a:	00002097          	auipc	ra,0x2
    432e:	8d8080e7          	jalr	-1832(ra) # 5c02 <printf>
      exit(1);
    4332:	4505                	li	a0,1
    ...
    4342:	7c250513          	addi	a0,a0,1986 # 6b00 <malloc+0xe40>
    4346:	00002097          	auipc	ra,0x2
    434a:	8bc080e7          	jalr	-1860(ra) # 5c02 <printf>
        exit(1);
    434e:	4505                	li	a0,1
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b8:	6cc50513          	addi	a0,a0,1740 # 6a80 <malloc+0xdc0>
    43bc:	00002097          	auipc	ra,0x2
    43c0:	846080e7          	jalr	-1978(ra) # 5c02 <printf>
    exit(1);
    43c4:	4505                	li	a0,1
    ...
    43ee:	dc658593          	addi	a1,a1,-570 # 61b0 <malloc+0x4f0>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b2:	7ba50513          	addi	a0,a0,1978 # 7c68 <malloc+0x1fa8>
    44b6:	00001097          	auipc	ra,0x1
    44ba:	74c080e7          	jalr	1868(ra) # 5c02 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	4ae50513          	addi	a0,a0,1198 # 6978 <malloc+0xcb8>
    44d2:	00001097          	auipc	ra,0x1
    44d6:	730080e7          	jalr	1840(ra) # 5c02 <printf>
    exit(1);
    44da:	4505                	li	a0,1
    ...
    451a:	77250513          	addi	a0,a0,1906 # 7c88 <malloc+0x1fc8>
    451e:	00001097          	auipc	ra,0x1
    4522:	6e4080e7          	jalr	1764(ra) # 5c02 <printf>
    exit(1);
    4526:	4505                	li	a0,1
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4562:	762080e7          	jalr	1890(ra) # 5cc0 <malloc>
    ...
    45a2:	71a50513          	addi	a0,a0,1818 # 7cb8 <malloc+0x1ff8>
    45a6:	00001097          	auipc	ra,0x1
    45aa:	65c080e7          	jalr	1628(ra) # 5c02 <printf>
      exit(1);
    45ae:	4505                	li	a0,1
...
00000000000045e0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4676:	66650513          	addi	a0,a0,1638 # 7cd8 <malloc+0x2018>
    467a:	00001097          	auipc	ra,0x1
    467e:	588080e7          	jalr	1416(ra) # 5c02 <printf>
    exit(1);
    4682:	4505                	li	a0,1
    ...
    4692:	67250513          	addi	a0,a0,1650 # 7d00 <malloc+0x2040>
    4696:	00001097          	auipc	ra,0x1
    469a:	56c080e7          	jalr	1388(ra) # 5c02 <printf>
      exit(1);
    469e:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d6:	87e50513          	addi	a0,a0,-1922 # 5f50 <malloc+0x290>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4716:	60e50513          	addi	a0,a0,1550 # 7d20 <malloc+0x2060>
    471a:	00001097          	auipc	ra,0x1
    471e:	4e8080e7          	jalr	1256(ra) # 5c02 <printf>
    exit(1);
    4722:	4505                	li	a0,1
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1228>
  ...
  unlink("sharedfd");
    ...
    4752:	80250513          	addi	a0,a0,-2046 # 5f50 <malloc+0x290>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4778:	5d450513          	addi	a0,a0,1492 # 7d48 <malloc+0x2088>
    477c:	00001097          	auipc	ra,0x1
    4780:	486080e7          	jalr	1158(ra) # 5c02 <printf>
    exit(1);
    4784:	4505                	li	a0,1
...
0000000000004798 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47bc:	5f078793          	addi	a5,a5,1520 # 5da8 <malloc+0xe8>
    47c0:	f6f43823          	sd	a5,-144(s0)
    47c4:	00001797          	auipc	a5,0x1
    47c8:	5ec78793          	addi	a5,a5,1516 # 5db0 <malloc+0xf0>
    47cc:	f6f43c23          	sd	a5,-136(s0)
    47d0:	00001797          	auipc	a5,0x1
    47d4:	5e878793          	addi	a5,a5,1512 # 5db8 <malloc+0xf8>
    47d8:	f8f43023          	sd	a5,-128(s0)
    47dc:	00001797          	auipc	a5,0x1
    47e0:	5e478793          	addi	a5,a5,1508 # 5dc0 <malloc+0x100>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483a:	592a0a13          	addi	s4,s4,1426 # bdc8 <buf>
    483e:	00007a97          	auipc	s5,0x7
    4842:	58ba8a93          	addi	s5,s5,1419 # bdc9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4858:	54450513          	addi	a0,a0,1348 # 6d98 <malloc+0x10d8>
    485c:	00001097          	auipc	ra,0x1
    4860:	3a6080e7          	jalr	934(ra) # 5c02 <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    48d2:	49250513          	addi	a0,a0,1170 # 7d60 <malloc+0x20a0>
    48d6:	00001097          	auipc	ra,0x1
    48da:	32c080e7          	jalr	812(ra) # 5c02 <printf>
        exit(1);
    48de:	4505                	li	a0,1
    ...
    48ec:	48850513          	addi	a0,a0,1160 # 7d70 <malloc+0x20b0>
    48f0:	00001097          	auipc	ra,0x1
    48f4:	312080e7          	jalr	786(ra) # 5c02 <printf>
          exit(1);
    48f8:	4505                	li	a0,1
    ...
    4910:	47c50513          	addi	a0,a0,1148 # 7d88 <malloc+0x20c8>
    4914:	00001097          	auipc	ra,0x1
    4918:	2ee080e7          	jalr	750(ra) # 5c02 <printf>
          exit(1);
    491c:	4505                	li	a0,1
    ...
    4940:	48c78793          	addi	a5,a5,1164 # bdc8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	3fc50513          	addi	a0,a0,1020 # 7d98 <malloc+0x20d8>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	25e080e7          	jalr	606(ra) # 5c02 <printf>
      exit(1);
    49ac:	4505                	li	a0,1
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	3b2b8b93          	addi	s7,s7,946 # 7db0 <malloc+0x20f0>
  for(i = 0; i < N; i++){
    ...
    4a44:	37850513          	addi	a0,a0,888 # 7db8 <malloc+0x20f8>
    4a48:	00001097          	auipc	ra,0x1
    4a4c:	1ba080e7          	jalr	442(ra) # 5c02 <printf>
        exit(1);
    4a50:	4505                	li	a0,1
    ...
    4a62:	35250513          	addi	a0,a0,850 # 7db0 <malloc+0x20f0>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d4250513          	addi	a0,a0,-702 # 67d8 <malloc+0xb18>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac0:	31c50513          	addi	a0,a0,796 # 7dd8 <malloc+0x2118>
    4ac4:	00001097          	auipc	ra,0x1
    4ac8:	13e080e7          	jalr	318(ra) # 5c02 <printf>
        exit(1);
    4acc:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b30:	2cc50513          	addi	a0,a0,716 # 7df8 <malloc+0x2138>
    4b34:	00001097          	auipc	ra,0x1
    4b38:	0ce080e7          	jalr	206(ra) # 5c02 <printf>
        exit(1);
    4b3c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	2bc50513          	addi	a0,a0,700 # 7e20 <malloc+0x2160>
    4b6c:	00001097          	auipc	ra,0x1
    4b70:	096080e7          	jalr	150(ra) # 5c02 <printf>
    exit(1);
    4b74:	4505                	li	a0,1
    ...
    4b84:	df850513          	addi	a0,a0,-520 # 6978 <malloc+0xcb8>
    4b88:	00001097          	auipc	ra,0x1
    4b8c:	07a080e7          	jalr	122(ra) # 5c02 <printf>
      exit(1);
    4b90:	4505                	li	a0,1
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6e:	05e90913          	addi	s2,s2,94 # bdc8 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	0a650513          	addi	a0,a0,166 # 7e58 <malloc+0x2198>
  ...
  if(fd < 0){
    ...
    4dfc:	00094703          	lbu	a4,0(s2) # bdc8 <buf>
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	05250513          	addi	a0,a0,82 # 7e68 <malloc+0x21a8>
    4e1e:	00001097          	auipc	ra,0x1
    4e22:	de4080e7          	jalr	-540(ra) # 5c02 <printf>
    exit(1);
    4e26:	4505                	li	a0,1
    ...
    4e36:	05650513          	addi	a0,a0,86 # 7e88 <malloc+0x21c8>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	dc8080e7          	jalr	-568(ra) # 5c02 <printf>
      exit(1);
    4e42:	4505                	li	a0,1
    ...
    4e52:	05a50513          	addi	a0,a0,90 # 7ea8 <malloc+0x21e8>
    4e56:	00001097          	auipc	ra,0x1
    4e5a:	dac080e7          	jalr	-596(ra) # 5c02 <printf>
    exit(1);
    4e5e:	4505                	li	a0,1
    ...
    4e6e:	05e50513          	addi	a0,a0,94 # 7ec8 <malloc+0x2208>
    4e72:	00001097          	auipc	ra,0x1
    4e76:	d90080e7          	jalr	-624(ra) # 5c02 <printf>
      exit(1);
    4e7a:	4505                	li	a0,1
    ...
    4e8a:	06250513          	addi	a0,a0,98 # 7ee8 <malloc+0x2228>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	d74080e7          	jalr	-652(ra) # 5c02 <printf>
      exit(1);
    4e96:	4505                	li	a0,1
    ...
    4ea6:	05e50513          	addi	a0,a0,94 # 7f00 <malloc+0x2240>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	d58080e7          	jalr	-680(ra) # 5c02 <printf>
      exit(1);
    4eb2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	f8850513          	addi	a0,a0,-120 # 7e58 <malloc+0x2198>
    ...
    4ef8:	02c50513          	addi	a0,a0,44 # 7f20 <malloc+0x2260>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	d06080e7          	jalr	-762(ra) # 5c02 <printf>
    exit(1);
    4f04:	4505                	li	a0,1
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	01450513          	addi	a0,a0,20 # 7f40 <malloc+0x2280>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	cce080e7          	jalr	-818(ra) # 5c02 <printf>
  for(nfiles = 0; ; nfiles++){
    4f3c:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f50:	004c8c93          	addi	s9,s9,4 # 7f50 <malloc+0x2290>
    int total = 0;
    4f54:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f56:	00007a17          	auipc	s4,0x7
    4f5a:	e72a0a13          	addi	s4,s4,-398 # bdc8 <buf>
    name[0] = 'f';
    ...
    4fa8:	c5e080e7          	jalr	-930(ra) # 5c02 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fca:	f9a50513          	addi	a0,a0,-102 # 7f60 <malloc+0x22a0>
    4fce:	00001097          	auipc	ra,0x1
    4fd2:	c34080e7          	jalr	-972(ra) # 5c02 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f4450513          	addi	a0,a0,-188 # 7f80 <malloc+0x22c0>
    5044:	00001097          	auipc	ra,0x1
    5048:	bbe080e7          	jalr	-1090(ra) # 5c02 <printf>
}
    ...
    5090:	ee450513          	addi	a0,a0,-284 # 7f70 <malloc+0x22b0>
    5094:	00001097          	auipc	ra,0x1
    5098:	b6e080e7          	jalr	-1170(ra) # 5c02 <printf>
    close(fd);
    509c:	854a                	mv	a0,s2
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	e7a50513          	addi	a0,a0,-390 # 7f98 <malloc+0x22d8>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	07a58593          	addi	a1,a1,122 # 61b0 <malloc+0x4f0>
    ...
    5150:	e6c50513          	addi	a0,a0,-404 # 7fb8 <malloc+0x22f8>
    5154:	00001097          	auipc	ra,0x1
    5158:	aae080e7          	jalr	-1362(ra) # 5c02 <printf>
    exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	e3a50513          	addi	a0,a0,-454 # 7fa0 <malloc+0x22e0>
    516e:	00001097          	auipc	ra,0x1
    5172:	a94080e7          	jalr	-1388(ra) # 5c02 <printf>
      exit(1);
    5176:	4505                	li	a0,1
    ...
    5184:	e2050513          	addi	a0,a0,-480 # 7fa0 <malloc+0x22e0>
    5188:	00001097          	auipc	ra,0x1
    518c:	a7a080e7          	jalr	-1414(ra) # 5c02 <printf>
    exit(1);
    5190:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a8:	df450513          	addi	a0,a0,-524 # 7f98 <malloc+0x22d8>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	fb690913          	addi	s2,s2,-74 # 61b0 <malloc+0x4f0>
      uint64 a = (uint64) sbrk(4096);
    ...
    5232:	dda50513          	addi	a0,a0,-550 # 8008 <malloc+0x2348>
    5236:	00001097          	auipc	ra,0x1
    523a:	9cc080e7          	jalr	-1588(ra) # 5c02 <printf>
        exit(1);
    523e:	4505                	li	a0,1
    ...
    524c:	d8050513          	addi	a0,a0,-640 # 7fc8 <malloc+0x2308>
    5250:	00001097          	auipc	ra,0x1
    5254:	9b2080e7          	jalr	-1614(ra) # 5c02 <printf>
    exit(1);
    5258:	4505                	li	a0,1
    ...
    5266:	d8650513          	addi	a0,a0,-634 # 7fe8 <malloc+0x2328>
    526a:	00001097          	auipc	ra,0x1
    526e:	998080e7          	jalr	-1640(ra) # 5c02 <printf>
    exit(1);
    5272:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b4:	d7850513          	addi	a0,a0,-648 # 8028 <malloc+0x2368>
    52b8:	00001097          	auipc	ra,0x1
    52bc:	94a080e7          	jalr	-1718(ra) # 5c02 <printf>
      exit(1);
    52c0:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5304:	d4850513          	addi	a0,a0,-696 # 8048 <malloc+0x2388>
    5308:	00001097          	auipc	ra,0x1
    530c:	8fa080e7          	jalr	-1798(ra) # 5c02 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5334:	d4050513          	addi	a0,a0,-704 # 8070 <malloc+0x23b0>
    5338:	00001097          	auipc	ra,0x1
    533c:	8ca080e7          	jalr	-1846(ra) # 5c02 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5358:	d0450513          	addi	a0,a0,-764 # 8058 <malloc+0x2398>
    535c:	00001097          	auipc	ra,0x1
    5360:	8a6080e7          	jalr	-1882(ra) # 5c02 <printf>
    exit(1);
    5364:	4505                	li	a0,1
    ...
    5380:	cfc50513          	addi	a0,a0,-772 # 8078 <malloc+0x23b8>
    5384:	00001097          	auipc	ra,0x1
    5388:	87e080e7          	jalr	-1922(ra) # 5c02 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ca:	dca78793          	addi	a5,a5,-566 # 8190 <malloc+0x24d0>
    53ce:	bd040713          	addi	a4,s0,-1072
    53d2:	00003317          	auipc	t1,0x3
    53d6:	1ae30313          	addi	t1,t1,430 # 8580 <malloc+0x28c0>
  ...
  printf("usertests starting\n");
    ...
    540a:	d2a50513          	addi	a0,a0,-726 # 8130 <malloc+0x2470>
    540e:	00000097          	auipc	ra,0x0
    5412:	7f4080e7          	jalr	2036(ra) # 5c02 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5442:	caa50513          	addi	a0,a0,-854 # 80e8 <malloc+0x2428>
    5446:	00000097          	auipc	ra,0x0
    544a:	7bc080e7          	jalr	1980(ra) # 5c02 <printf>
    exit(1);
    544e:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545e:	c2658593          	addi	a1,a1,-986 # 8080 <malloc+0x23c0>
    ...
    5474:	cf858593          	addi	a1,a1,-776 # 8168 <malloc+0x24a8>
    ...
    5498:	bf450513          	addi	a0,a0,-1036 # 8088 <malloc+0x23c8>
    549c:	00000097          	auipc	ra,0x0
    54a0:	766080e7          	jalr	1894(ra) # 5c02 <printf>
    exit(1);
    54a4:	4505                	li	a0,1
    ...
    54c2:	744080e7          	jalr	1860(ra) # 5c02 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5504:	bd050513          	addi	a0,a0,-1072 # 80d0 <malloc+0x2410>
    5508:	00000097          	auipc	ra,0x0
    550c:	6fa080e7          	jalr	1786(ra) # 5c02 <printf>
    exit(1);
    5510:	4505                	li	a0,1
    ...
    551e:	bfe50513          	addi	a0,a0,-1026 # 8118 <malloc+0x2458>
    5522:	00000097          	auipc	ra,0x0
    5526:	6e0080e7          	jalr	1760(ra) # 5c02 <printf>
    exit(0);
    552a:	4501                	li	a0,0
    ...
    553a:	6cc080e7          	jalr	1740(ra) # 5c02 <printf>
        if(continuous != 2)
    ...
    557c:	c1878793          	addi	a5,a5,-1000 # 8190 <malloc+0x24d0>
    5580:	bd040713          	addi	a4,s0,-1072
    5584:	00003317          	auipc	t1,0x3
    5588:	ffc30313          	addi	t1,t1,-4 # 8580 <malloc+0x28c0>
    ...
    55bc:	b9050513          	addi	a0,a0,-1136 # 8148 <malloc+0x2488>
    55c0:	00000097          	auipc	ra,0x0
    55c4:	642080e7          	jalr	1602(ra) # 5c02 <printf>
        printf("SOME TESTS FAILED\n");
    55c8:	00003a97          	auipc	s5,0x3
    55cc:	b08a8a93          	addi	s5,s5,-1272 # 80d0 <malloc+0x2410>
        if(continuous != 2)
    55d0:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d2:	00003b17          	auipc	s6,0x3
    55d6:	adeb0b13          	addi	s6,s6,-1314 # 80b0 <malloc+0x23f0>
...
putc(int fd, char c)
{
    ...
    5930:	1000                	addi	s0,sp,32
    5932:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5936:	4605                	li	a2,1
    5938:	fef40593          	addi	a1,s0,-17
    593c:	00000097          	auipc	ra,0x0
    5940:	f36080e7          	jalr	-202(ra) # 5872 <write>
}
    5944:	60e2                	ld	ra,24(sp)
    5946:	6442                	ld	s0,16(sp)
    5948:	6105                	addi	sp,sp,32
    594a:	8082                	ret

000000000000594c <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    594c:	7139                	addi	sp,sp,-64
    594e:	fc06                	sd	ra,56(sp)
    5950:	f822                	sd	s0,48(sp)
    5952:	f426                	sd	s1,40(sp)
    5954:	f04a                	sd	s2,32(sp)
    5956:	ec4e                	sd	s3,24(sp)
    5958:	0080                	addi	s0,sp,64
    595a:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    595c:	c299                	beqz	a3,5962 <printint+0x16>
    595e:	0805c863          	bltz	a1,59ee <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5962:	2581                	sext.w	a1,a1
  neg = 0;
    5964:	4881                	li	a7,0
    5966:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    596c:	2601                	sext.w	a2,a2
    596e:	00003517          	auipc	a0,0x3
    5972:	c1a50513          	addi	a0,a0,-998 # 8588 <digits>
    5976:	883a                	mv	a6,a4
    5978:	2705                	addiw	a4,a4,1
    597a:	02c5f7bb          	remuw	a5,a1,a2
    597e:	1782                	slli	a5,a5,0x20
    5980:	9381                	srli	a5,a5,0x20
    5982:	97aa                	add	a5,a5,a0
    5984:	0007c783          	lbu	a5,0(a5)
    5988:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    598c:	0005879b          	sext.w	a5,a1
    5990:	02c5d5bb          	divuw	a1,a1,a2
    5994:	0685                	addi	a3,a3,1
    5996:	fec7f0e3          	bgeu	a5,a2,5976 <printint+0x2a>
  if(neg)
    599a:	00088b63          	beqz	a7,59b0 <printint+0x64>
    buf[i++] = '-';
    599e:	fd040793          	addi	a5,s0,-48
    59a2:	973e                	add	a4,a4,a5
    59a4:	02d00793          	li	a5,45
    59a8:	fef70823          	sb	a5,-16(a4)
    59ac:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    59b0:	02e05863          	blez	a4,59e0 <printint+0x94>
    59b4:	fc040793          	addi	a5,s0,-64
    59b8:	00e78933          	add	s2,a5,a4
    59bc:	fff78993          	addi	s3,a5,-1
    59c0:	99ba                	add	s3,s3,a4
    59c2:	377d                	addiw	a4,a4,-1
    59c4:	1702                	slli	a4,a4,0x20
    59c6:	9301                	srli	a4,a4,0x20
    59c8:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    59cc:	fff94583          	lbu	a1,-1(s2)
    59d0:	8526                	mv	a0,s1
    59d2:	00000097          	auipc	ra,0x0
    59d6:	f58080e7          	jalr	-168(ra) # 592a <putc>
  while(--i >= 0)
    59da:	197d                	addi	s2,s2,-1
    59dc:	ff3918e3          	bne	s2,s3,59cc <printint+0x80>
}
    59e0:	70e2                	ld	ra,56(sp)
    59e2:	7442                	ld	s0,48(sp)
    59e4:	74a2                	ld	s1,40(sp)
    59e6:	7902                	ld	s2,32(sp)
    59e8:	69e2                	ld	s3,24(sp)
    59ea:	6121                	addi	sp,sp,64
    59ec:	8082                	ret
    x = -xx;
    59ee:	40b005bb          	negw	a1,a1
    neg = 1;
    59f2:	4885                	li	a7,1
    x = -xx;
    59f4:	bf8d                	j	5966 <printint+0x1a>

00000000000059f6 <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
    ...
    59fc:	f4a6                	sd	s1,104(sp)
    59fe:	f0ca                	sd	s2,96(sp)
    5a00:	ecce                	sd	s3,88(sp)
    5a02:	e8d2                	sd	s4,80(sp)
    5a04:	e4d6                	sd	s5,72(sp)
    5a06:	e0da                	sd	s6,64(sp)
    5a08:	fc5e                	sd	s7,56(sp)
    5a0a:	f862                	sd	s8,48(sp)
    5a0c:	f466                	sd	s9,40(sp)
    5a0e:	f06a                	sd	s10,32(sp)
    5a10:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    5a14:	0005c903          	lbu	s2,0(a1)
    5a18:	18090f63          	beqz	s2,5bb6 <vprintf+0x1c0>
    5a1c:	8aaa                	mv	s5,a0
    5a1e:	8b32                	mv	s6,a2
    5a20:	00158493          	addi	s1,a1,1
  state = 0;
    5a24:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a26:	02500a13          	li	s4,37
      if(c == 'd'){
    5a2a:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5a2e:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5a32:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5a36:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a3a:	00003b97          	auipc	s7,0x3
    5a3e:	b4eb8b93          	addi	s7,s7,-1202 # 8588 <digits>
    5a42:	a839                	j	5a60 <vprintf+0x6a>
        putc(fd, c);
    5a44:	85ca                	mv	a1,s2
    5a46:	8556                	mv	a0,s5
    5a48:	00000097          	auipc	ra,0x0
    5a4c:	ee2080e7          	jalr	-286(ra) # 592a <putc>
    5a50:	a019                	j	5a56 <vprintf+0x60>
    } else if(state == '%'){
    5a52:	01498f63          	beq	s3,s4,5a70 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a56:	0485                	addi	s1,s1,1
    5a58:	fff4c903          	lbu	s2,-1(s1)
    5a5c:	14090d63          	beqz	s2,5bb6 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a60:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a64:	fe0997e3          	bnez	s3,5a52 <vprintf+0x5c>
      if(c == '%'){
    5a68:	fd479ee3          	bne	a5,s4,5a44 <vprintf+0x4e>
        state = '%';
    5a6c:	89be                	mv	s3,a5
    5a6e:	b7e5                	j	5a56 <vprintf+0x60>
      if(c == 'd'){
    5a70:	05878063          	beq	a5,s8,5ab0 <vprintf+0xba>
      } else if(c == 'l') {
    5a74:	05978c63          	beq	a5,s9,5acc <vprintf+0xd6>
      } else if(c == 'x') {
    5a78:	07a78863          	beq	a5,s10,5ae8 <vprintf+0xf2>
      } else if(c == 'p') {
    5a7c:	09b78463          	beq	a5,s11,5b04 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5a80:	07300713          	li	a4,115
    5a84:	0ce78663          	beq	a5,a4,5b50 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5a88:	06300713          	li	a4,99
    5a8c:	0ee78e63          	beq	a5,a4,5b88 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5a90:	11478863          	beq	a5,s4,5ba0 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5a9c:	e92080e7          	jalr	-366(ra) # 592a <putc>
        putc(fd, c);
    5aa0:	85ca                	mv	a1,s2
    5aa2:	8556                	mv	a0,s5
    5aa4:	00000097          	auipc	ra,0x0
    5aa8:	e86080e7          	jalr	-378(ra) # 592a <putc>
      }
      state = 0;
    5aac:	4981                	li	s3,0
    5aae:	b765                	j	5a56 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5ac2:	e8e080e7          	jalr	-370(ra) # 594c <printint>
    5ac6:	8b4a                	mv	s6,s2
      state = 0;
    5ac8:	4981                	li	s3,0
    5aca:	b771                	j	5a56 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5ade:	e72080e7          	jalr	-398(ra) # 594c <printint>
    5ae2:	8b4a                	mv	s6,s2
      state = 0;
    5ae4:	4981                	li	s3,0
    5ae6:	bf85                	j	5a56 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5afa:	e56080e7          	jalr	-426(ra) # 594c <printint>
    5afe:	8b4a                	mv	s6,s2
      state = 0;
    5b00:	4981                	li	s3,0
    5b02:	bf91                	j	5a56 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5b04:	008b0793          	addi	a5,s6,8
    5b08:	f8f43423          	sd	a5,-120(s0)
    5b0c:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5b10:	03000593          	li	a1,48
    5b14:	8556                	mv	a0,s5
    5b16:	00000097          	auipc	ra,0x0
    5b1a:	e14080e7          	jalr	-492(ra) # 592a <putc>
  putc(fd, 'x');
    5b1e:	85ea                	mv	a1,s10
    5b20:	8556                	mv	a0,s5
    5b22:	00000097          	auipc	ra,0x0
    5b26:	e08080e7          	jalr	-504(ra) # 592a <putc>
    5b2a:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5b2c:	03c9d793          	srli	a5,s3,0x3c
    5b30:	97de                	add	a5,a5,s7
    5b32:	0007c583          	lbu	a1,0(a5)
    5b36:	8556                	mv	a0,s5
    5b38:	00000097          	auipc	ra,0x0
    5b3c:	df2080e7          	jalr	-526(ra) # 592a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b40:	0992                	slli	s3,s3,0x4
    5b42:	397d                	addiw	s2,s2,-1
    5b44:	fe0914e3          	bnez	s2,5b2c <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b48:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b4c:	4981                	li	s3,0
    5b4e:	b721                	j	5a56 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b50:	008b0993          	addi	s3,s6,8
    5b54:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b58:	02090163          	beqz	s2,5b7a <vprintf+0x184>
        while(*s != 0){
    5b5c:	00094583          	lbu	a1,0(s2)
    5b60:	c9a1                	beqz	a1,5bb0 <vprintf+0x1ba>
          putc(fd, *s);
    5b62:	8556                	mv	a0,s5
    5b64:	00000097          	auipc	ra,0x0
    5b68:	dc6080e7          	jalr	-570(ra) # 592a <putc>
          s++;
    5b6c:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b6e:	00094583          	lbu	a1,0(s2)
    5b72:	f9e5                	bnez	a1,5b62 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5b74:	8b4e                	mv	s6,s3
      state = 0;
    5b76:	4981                	li	s3,0
    5b78:	bdf9                	j	5a56 <vprintf+0x60>
          s = "(null)";
    5b7a:	00003917          	auipc	s2,0x3
    5b7e:	a0690913          	addi	s2,s2,-1530 # 8580 <malloc+0x28c0>
        while(*s != 0){
    5b82:	02800593          	li	a1,40
    5b86:	bff1                	j	5b62 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5b88:	008b0913          	addi	s2,s6,8
    5b8c:	000b4583          	lbu	a1,0(s6)
    5b90:	8556                	mv	a0,s5
    5b92:	00000097          	auipc	ra,0x0
    5b96:	d98080e7          	jalr	-616(ra) # 592a <putc>
    5b9a:	8b4a                	mv	s6,s2
      state = 0;
    5b9c:	4981                	li	s3,0
    5b9e:	bd65                	j	5a56 <vprintf+0x60>
        putc(fd, c);
    5ba0:	85d2                	mv	a1,s4
    5ba2:	8556                	mv	a0,s5
    5ba4:	00000097          	auipc	ra,0x0
    5ba8:	d86080e7          	jalr	-634(ra) # 592a <putc>
      state = 0;
    5bac:	4981                	li	s3,0
    5bae:	b565                	j	5a56 <vprintf+0x60>
        s = va_arg(ap, char*);
    5bb0:	8b4e                	mv	s6,s3
      state = 0;
    5bb2:	4981                	li	s3,0
    5bb4:	b54d                	j	5a56 <vprintf+0x60>
    }
  }
}
    5bb6:	70e6                	ld	ra,120(sp)
    5bb8:	7446                	ld	s0,112(sp)
    5bba:	74a6                	ld	s1,104(sp)
    5bbc:	7906                	ld	s2,96(sp)
    5bbe:	69e6                	ld	s3,88(sp)
    5bc0:	6a46                	ld	s4,80(sp)
    5bc2:	6aa6                	ld	s5,72(sp)
    5bc4:	6b06                	ld	s6,64(sp)
    5bc6:	7be2                	ld	s7,56(sp)
    5bc8:	7c42                	ld	s8,48(sp)
    5bca:	7ca2                	ld	s9,40(sp)
    5bcc:	7d02                	ld	s10,32(sp)
    5bce:	6de2                	ld	s11,24(sp)
    5bd0:	6109                	addi	sp,sp,128
    5bd2:	8082                	ret

0000000000005bd4 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5bd4:	715d                	addi	sp,sp,-80
    5bd6:	ec06                	sd	ra,24(sp)
    5bd8:	e822                	sd	s0,16(sp)
    5bda:	1000                	addi	s0,sp,32
    5bdc:	e010                	sd	a2,0(s0)
    5bde:	e414                	sd	a3,8(s0)
    5be0:	e818                	sd	a4,16(s0)
    5be2:	ec1c                	sd	a5,24(s0)
    5be4:	03043023          	sd	a6,32(s0)
    5be8:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bec:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bf0:	8622                	mv	a2,s0
    5bf2:	00000097          	auipc	ra,0x0
    5bf6:	e04080e7          	jalr	-508(ra) # 59f6 <vprintf>
}
    5bfa:	60e2                	ld	ra,24(sp)
    5bfc:	6442                	ld	s0,16(sp)
    5bfe:	6161                	addi	sp,sp,80
    5c00:	8082                	ret

0000000000005c02 <printf>:

void
printf(const char *fmt, ...)
{
    5c02:	711d                	addi	sp,sp,-96
    5c04:	ec06                	sd	ra,24(sp)
    5c06:	e822                	sd	s0,16(sp)
    5c08:	1000                	addi	s0,sp,32
    5c0a:	e40c                	sd	a1,8(s0)
    5c0c:	e810                	sd	a2,16(s0)
    5c0e:	ec14                	sd	a3,24(s0)
    5c10:	f018                	sd	a4,32(s0)
    5c12:	f41c                	sd	a5,40(s0)
    5c14:	03043823          	sd	a6,48(s0)
    5c18:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5c1c:	00840613          	addi	a2,s0,8
    5c20:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5c24:	85aa                	mv	a1,a0
    5c26:	4505                	li	a0,1
    5c28:	00000097          	auipc	ra,0x0
    5c2c:	dce080e7          	jalr	-562(ra) # 59f6 <vprintf>
}
    5c30:	60e2                	ld	ra,24(sp)
    5c32:	6442                	ld	s0,16(sp)
    5c34:	6125                	addi	sp,sp,96
    5c36:	8082                	ret

0000000000005c38 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5c38:	1141                	addi	sp,sp,-16
    5c3a:	e422                	sd	s0,8(sp)
    5c3c:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c3e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c42:	00003797          	auipc	a5,0x3
    5c46:	9667b783          	ld	a5,-1690(a5) # 85a8 <freep>
    5c4a:	a805                	j	5c7a <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c4c:	4618                	lw	a4,8(a2)
    5c4e:	9db9                	addw	a1,a1,a4
    5c50:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c54:	6398                	ld	a4,0(a5)
    5c56:	6318                	ld	a4,0(a4)
    5c58:	fee53823          	sd	a4,-16(a0)
    5c5c:	a091                	j	5ca0 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c5e:	ff852703          	lw	a4,-8(a0)
    5c62:	9e39                	addw	a2,a2,a4
    5c64:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c66:	ff053703          	ld	a4,-16(a0)
    5c6a:	e398                	sd	a4,0(a5)
    5c6c:	a099                	j	5cb2 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c6e:	6398                	ld	a4,0(a5)
    5c70:	00e7e463          	bltu	a5,a4,5c78 <free+0x40>
    5c74:	00e6ea63          	bltu	a3,a4,5c88 <free+0x50>
{
    5c78:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c7a:	fed7fae3          	bgeu	a5,a3,5c6e <free+0x36>
    5c7e:	6398                	ld	a4,0(a5)
    5c80:	00e6e463          	bltu	a3,a4,5c88 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c84:	fee7eae3          	bltu	a5,a4,5c78 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5c88:	ff852583          	lw	a1,-8(a0)
    5c8c:	6390                	ld	a2,0(a5)
    5c8e:	02059713          	slli	a4,a1,0x20
    5c92:	9301                	srli	a4,a4,0x20
    5c94:	0712                	slli	a4,a4,0x4
    5c96:	9736                	add	a4,a4,a3
    5c98:	fae60ae3          	beq	a2,a4,5c4c <free+0x14>
    bp->s.ptr = p->s.ptr;
    5c9c:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5ca0:	4790                	lw	a2,8(a5)
    5ca2:	02061713          	slli	a4,a2,0x20
    5ca6:	9301                	srli	a4,a4,0x20
    5ca8:	0712                	slli	a4,a4,0x4
    5caa:	973e                	add	a4,a4,a5
    5cac:	fae689e3          	beq	a3,a4,5c5e <free+0x26>
  } else
    p->s.ptr = bp;
    5cb0:	e394                	sd	a3,0(a5)
  freep = p;
    5cb2:	00003717          	auipc	a4,0x3
    5cb6:	8ef73b23          	sd	a5,-1802(a4) # 85a8 <freep>
}
    5cba:	6422                	ld	s0,8(sp)
    5cbc:	0141                	addi	sp,sp,16
    5cbe:	8082                	ret

0000000000005cc0 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5ccc:	e852                	sd	s4,16(sp)
    5cce:	e456                	sd	s5,8(sp)
    5cd0:	e05a                	sd	s6,0(sp)
    5cd2:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5cd4:	02051493          	slli	s1,a0,0x20
    5cd8:	9081                	srli	s1,s1,0x20
    5cda:	04bd                	addi	s1,s1,15
    5cdc:	8091                	srli	s1,s1,0x4
    5cde:	0014899b          	addiw	s3,s1,1
    5ce2:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5ce4:	00003517          	auipc	a0,0x3
    5ce8:	8c453503          	ld	a0,-1852(a0) # 85a8 <freep>
    5cec:	c515                	beqz	a0,5d18 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cee:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cf0:	4798                	lw	a4,8(a5)
    5cf2:	02977f63          	bgeu	a4,s1,5d30 <malloc+0x70>
    5cf6:	8a4e                	mv	s4,s3
    5cf8:	0009871b          	sext.w	a4,s3
    5cfc:	6685                	lui	a3,0x1
    5cfe:	00d77363          	bgeu	a4,a3,5d04 <malloc+0x44>
    5d02:	6a05                	lui	s4,0x1
    5d04:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5d08:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5d0c:	00003917          	auipc	s2,0x3
    5d10:	89c90913          	addi	s2,s2,-1892 # 85a8 <freep>
  if(p == (char*)-1)
    5d14:	5afd                	li	s5,-1
    5d16:	a88d                	j	5d88 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5d18:	00009797          	auipc	a5,0x9
    5d1c:	0b078793          	addi	a5,a5,176 # edc8 <base>
    5d20:	00003717          	auipc	a4,0x3
    5d24:	88f73423          	sd	a5,-1912(a4) # 85a8 <freep>
    5d28:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d2a:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d2e:	b7e1                	j	5cf6 <malloc+0x36>
      if(p->s.size == nunits)
    5d30:	02e48b63          	beq	s1,a4,5d66 <malloc+0xa6>
        p->s.size -= nunits;
    5d34:	4137073b          	subw	a4,a4,s3
    5d38:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d3a:	1702                	slli	a4,a4,0x20
    5d3c:	9301                	srli	a4,a4,0x20
    5d3e:	0712                	slli	a4,a4,0x4
    5d40:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d42:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d46:	00003717          	auipc	a4,0x3
    5d4a:	86a73123          	sd	a0,-1950(a4) # 85a8 <freep>
      return (void*)(p + 1);
    5d4e:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5d52:	70e2                	ld	ra,56(sp)
    5d54:	7442                	ld	s0,48(sp)
    5d56:	74a2                	ld	s1,40(sp)
    5d58:	7902                	ld	s2,32(sp)
    5d5a:	69e2                	ld	s3,24(sp)
    5d5c:	6a42                	ld	s4,16(sp)
    5d5e:	6aa2                	ld	s5,8(sp)
    5d60:	6b02                	ld	s6,0(sp)
    5d62:	6121                	addi	sp,sp,64
    5d64:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d66:	6398                	ld	a4,0(a5)
    5d68:	e118                	sd	a4,0(a0)
    5d6a:	bff1                	j	5d46 <malloc+0x86>
  hp->s.size = nu;
    5d6c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d70:	0541                	addi	a0,a0,16
    5d72:	00000097          	auipc	ra,0x0
    5d76:	ec6080e7          	jalr	-314(ra) # 5c38 <free>
  return freep;
    5d7a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d7e:	d971                	beqz	a0,5d52 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d80:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d82:	4798                	lw	a4,8(a5)
    5d84:	fa9776e3          	bgeu	a4,s1,5d30 <malloc+0x70>
    if(p == freep)
    5d88:	00093703          	ld	a4,0(s2)
    5d8c:	853e                	mv	a0,a5
    5d8e:	fef719e3          	bne	a4,a5,5d80 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5d92:	8552                	mv	a0,s4
    5d94:	00000097          	auipc	ra,0x0
    5d98:	b46080e7          	jalr	-1210(ra) # 58da <sbrk>
  if(p == (char*)-1)
    5d9c:	fd5518e3          	bne	a0,s5,5d6c <malloc+0xac>
        return 0;
    5da0:	4501                	li	a0,0
    5da2:	bf45                	j	5d52 <malloc+0x92>
