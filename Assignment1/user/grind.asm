 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1d464>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <__global_pointer$+0x22ee>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd633>
...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	31e50513          	addi	a0,a0,798 # 13b8 <malloc+0xe4>
      a2:	00001097          	auipc	ra,0x1
      a6:	e2c080e7          	jalr	-468(ra) # ece <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	30e50513          	addi	a0,a0,782 # 13b8 <malloc+0xe4>
      b2:	00001097          	auipc	ra,0x1
      b6:	e24080e7          	jalr	-476(ra) # ed6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	30450513          	addi	a0,a0,772 # 13c0 <malloc+0xec>
  ...
  chdir("/");
      ...
      da:	30a50513          	addi	a0,a0,778 # 13e0 <malloc+0x10c>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	30a98993          	addi	s3,s3,778 # 13f0 <malloc+0x11c>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2f898993          	addi	s3,s3,760 # 13e8 <malloc+0x114>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     100:	5d4a0a13          	addi	s4,s4,1492 # 16d0 <buf.1255>
     104:	a825                	j	13c <go+0xc4>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     106:	20200593          	li	a1,514
     10a:	00001517          	auipc	a0,0x1
     10e:	2ee50513          	addi	a0,a0,750 # 13f8 <malloc+0x124>
    ...
    if(what == 1){
     ...
     2a2:	3d258593          	addi	a1,a1,978 # 1670 <malloc+0x39c>
     ...
     2c6:	3b650513          	addi	a0,a0,950 # 1678 <malloc+0x3a4>
     ...
     2e4:	12850513          	addi	a0,a0,296 # 1408 <malloc+0x134>
     ...
     36c:	0c050513          	addi	a0,a0,192 # 1428 <malloc+0x154>
     ...
     38e:	0ae50513          	addi	a0,a0,174 # 1438 <malloc+0x164>
     ...
     3c6:	03650513          	addi	a0,a0,54 # 13f8 <malloc+0x124>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	b04080e7          	jalr	-1276(ra) # ece <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	07a50513          	addi	a0,a0,122 # 1450 <malloc+0x17c>
     ...
     4b8:	00450513          	addi	a0,a0,4 # 14b8 <malloc+0x1e4>
     ...
     506:	fb650513          	addi	a0,a0,-74 # 14b8 <malloc+0x1e4>
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.1255+0xab>
     ...
     566:	f6e50513          	addi	a0,a0,-146 # 14d0 <malloc+0x1fc>
     ...
     592:	f0a50513          	addi	a0,a0,-246 # 1498 <malloc+0x1c4>
     ...
     5b4:	f0850513          	addi	a0,a0,-248 # 14b8 <malloc+0x1e4>
     5b8:	00001097          	auipc	ra,0x1
     5bc:	c5e080e7          	jalr	-930(ra) # 1216 <printf>
        exit(1);
     5c0:	4505                	li	a0,1
     ...
     5ce:	f1650513          	addi	a0,a0,-234 # 14e0 <malloc+0x20c>
     5d2:	00001097          	auipc	ra,0x1
     5d6:	c44080e7          	jalr	-956(ra) # 1216 <printf>
        exit(1);
     5da:	4505                	li	a0,1
     ...
     61c:	ea050513          	addi	a0,a0,-352 # 14b8 <malloc+0x1e4>
     620:	00001097          	auipc	ra,0x1
     624:	bf6080e7          	jalr	-1034(ra) # 1216 <printf>
        exit(1);
     628:	4505                	li	a0,1
     ...
     678:	e8450513          	addi	a0,a0,-380 # 14f8 <malloc+0x224>
     67c:	00001097          	auipc	ra,0x1
     680:	b9a080e7          	jalr	-1126(ra) # 1216 <printf>
        exit(1);
     684:	4505                	li	a0,1
     ...
     6a4:	e7058593          	addi	a1,a1,-400 # 1510 <malloc+0x23c>
     ...
     7a6:	d1650513          	addi	a0,a0,-746 # 14b8 <malloc+0x1e4>
     7aa:	00001097          	auipc	ra,0x1
     7ae:	a6c080e7          	jalr	-1428(ra) # 1216 <printf>
        exit(1);
     7b2:	4505                	li	a0,1
     ...
     7c0:	d9c50513          	addi	a0,a0,-612 # 1558 <malloc+0x284>
     7c4:	00000097          	auipc	ra,0x0
     7c8:	6f2080e7          	jalr	1778(ra) # eb6 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7cc:	20200593          	li	a1,514
     7d0:	00001517          	auipc	a0,0x1
     7d4:	d8850513          	addi	a0,a0,-632 # 1558 <malloc+0x284>
     ...
     7ec:	d2858593          	addi	a1,a1,-728 # 1510 <malloc+0x23c>
     ...
     832:	d2a50513          	addi	a0,a0,-726 # 1558 <malloc+0x284>
     836:	00000097          	auipc	ra,0x0
     83a:	680080e7          	jalr	1664(ra) # eb6 <unlink>
     83e:	b0d5                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     840:	00001517          	auipc	a0,0x1
     844:	d2050513          	addi	a0,a0,-736 # 1560 <malloc+0x28c>
     848:	00001097          	auipc	ra,0x1
     84c:	9ce080e7          	jalr	-1586(ra) # 1216 <printf>
        exit(1);
     850:	4505                	li	a0,1
     ...
     85e:	d1e50513          	addi	a0,a0,-738 # 1578 <malloc+0x2a4>
     862:	00001097          	auipc	ra,0x1
     866:	9b4080e7          	jalr	-1612(ra) # 1216 <printf>
        exit(1);
     86a:	4505                	li	a0,1
     ...
     878:	d1c50513          	addi	a0,a0,-740 # 1590 <malloc+0x2bc>
     87c:	00001097          	auipc	ra,0x1
     880:	99a080e7          	jalr	-1638(ra) # 1216 <printf>
        exit(1);
     884:	4505                	li	a0,1
     ...
     894:	d1850513          	addi	a0,a0,-744 # 15a8 <malloc+0x2d4>
     898:	00001097          	auipc	ra,0x1
     89c:	97e080e7          	jalr	-1666(ra) # 1216 <printf>
        exit(1);
     8a0:	4505                	li	a0,1
     ...
     8ae:	d2650513          	addi	a0,a0,-730 # 15d0 <malloc+0x2fc>
     8b2:	00001097          	auipc	ra,0x1
     8b6:	964080e7          	jalr	-1692(ra) # 1216 <printf>
        exit(1);
     8ba:	4505                	li	a0,1
     ...
     8c8:	c3458593          	addi	a1,a1,-972 # 14f8 <malloc+0x224>
     8cc:	4509                	li	a0,2
     8ce:	00001097          	auipc	ra,0x1
     8d2:	91a080e7          	jalr	-1766(ra) # 11e8 <fprintf>
        exit(1);
     8d6:	4505                	li	a0,1
     ...
     8e4:	c1858593          	addi	a1,a1,-1000 # 14f8 <malloc+0x224>
     8e8:	4509                	li	a0,2
     8ea:	00001097          	auipc	ra,0x1
     8ee:	8fe080e7          	jalr	-1794(ra) # 11e8 <fprintf>
        exit(1);
     8f2:	4505                	li	a0,1
     ...
     940:	cbc58593          	addi	a1,a1,-836 # 15f8 <malloc+0x324>
     944:	4509                	li	a0,2
     ...
     9b4:	b0858593          	addi	a1,a1,-1272 # 14b8 <malloc+0x1e4>
     9b8:	4509                	li	a0,2
     9ba:	00001097          	auipc	ra,0x1
     9be:	82e080e7          	jalr	-2002(ra) # 11e8 <fprintf>
        exit(3);
     9c2:	450d                	li	a0,3
     ...
     a00:	bfc58593          	addi	a1,a1,-1028 # 15f8 <malloc+0x324>
     a04:	4509                	li	a0,2
     a06:	00000097          	auipc	ra,0x0
     a0a:	7e2080e7          	jalr	2018(ra) # 11e8 <fprintf>
          exit(4);
     a0e:	4511                	li	a0,4
     ...
     a44:	bb858593          	addi	a1,a1,-1096 # 15f8 <malloc+0x324>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	79e080e7          	jalr	1950(ra) # 11e8 <fprintf>
          exit(5);
     a52:	4515                	li	a0,5
     ...
     a6c:	be078793          	addi	a5,a5,-1056 # 1648 <malloc+0x374>
     a70:	faf43423          	sd	a5,-88(s0)
     a74:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a78:	fa840593          	addi	a1,s0,-88
     a7c:	00001517          	auipc	a0,0x1
     a80:	bd450513          	addi	a0,a0,-1068 # 1650 <malloc+0x37c>
     a84:	00000097          	auipc	ra,0x0
     a88:	41a080e7          	jalr	1050(ra) # e9e <exec>
        fprintf(2, "grind: cat: not found\n");
     a8c:	00001597          	auipc	a1,0x1
     a90:	bcc58593          	addi	a1,a1,-1076 # 1658 <malloc+0x384>
     a94:	4509                	li	a0,2
     a96:	00000097          	auipc	ra,0x0
     a9a:	752080e7          	jalr	1874(ra) # 11e8 <fprintf>
        exit(6);
     a9e:	4519                	li	a0,6
     ...
     aac:	a1058593          	addi	a1,a1,-1520 # 14b8 <malloc+0x1e4>
     ab0:	4509                	li	a0,2
     ab2:	00000097          	auipc	ra,0x0
     ab6:	736080e7          	jalr	1846(ra) # 11e8 <fprintf>
        exit(7);
     aba:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     ad4:	9c850513          	addi	a0,a0,-1592 # 1498 <malloc+0x1c4>
     ad8:	00000097          	auipc	ra,0x0
     adc:	3de080e7          	jalr	990(ra) # eb6 <unlink>
  unlink("b");
     ae0:	00001517          	auipc	a0,0x1
     ae4:	96850513          	addi	a0,a0,-1688 # 1448 <malloc+0x174>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     b06:	baf73f23          	sd	a5,-1090(a4) # 16c0 <rand_next>
    go(0);
     b0a:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b18:	9a450513          	addi	a0,a0,-1628 # 14b8 <malloc+0x1e4>
     b1c:	00000097          	auipc	ra,0x0
     b20:	6fa080e7          	jalr	1786(ra) # 1216 <printf>
    exit(1);
     b24:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b3e:	6789                	lui	a5,0x2
     b40:	c0978793          	addi	a5,a5,-1015 # 1c09 <__BSS_END__+0x141>
     b44:	00001717          	auipc	a4,0x1
     b48:	b6f73e23          	sd	a5,-1156(a4) # 16c0 <rand_next>
    go(1);
     b4c:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     b5a:	96250513          	addi	a0,a0,-1694 # 14b8 <malloc+0x1e4>
     b5e:	00000097          	auipc	ra,0x0
     b62:	6b8080e7          	jalr	1720(ra) # 1216 <printf>
    exit(1);
     b66:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f86:	72650513          	addi	a0,a0,1830 # 16a8 <digits>
     f8a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1052:	65ab8b93          	addi	s7,s7,1626 # 16a8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1192:	51290913          	addi	s2,s2,1298 # 16a0 <malloc+0x3cc>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    125a:	4727b783          	ld	a5,1138(a5) # 16c8 <freep>
    ...
    1288:	00e6ea63          	bltu	a3,a4,129c <free+0x50>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    12a2:	02059713          	slli	a4,a1,0x20
    12a6:	9301                	srli	a4,a4,0x20
    12a8:	0712                	slli	a4,a4,0x4
  ...
  if(p + p->s.size == bp){
    ...
    12b6:	02061713          	slli	a4,a2,0x20
    12ba:	9301                	srli	a4,a4,0x20
    12bc:	0712                	slli	a4,a4,0x4
  ...
  freep = p;
    ...
    12ca:	40f73123          	sd	a5,1026(a4) # 16c8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12fc:	3d053503          	ld	a0,976(a0) # 16c8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1324:	3a890913          	addi	s2,s2,936 # 16c8 <freep>
  if(p == (char*)-1)
    1328:	5afd                	li	s5,-1
    132a:	a88d                	j	139c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    132c:	00000797          	auipc	a5,0x0
    1330:	78c78793          	addi	a5,a5,1932 # 1ab8 <base>
    1334:	00000717          	auipc	a4,0x0
    1338:	38f73a23          	sd	a5,916(a4) # 16c8 <freep>
    ...
    1342:	b7e1                	j	130a <malloc+0x36>
      if(p->s.size == nunits)
    1344:	02e48b63          	beq	s1,a4,137a <malloc+0xa6>
        p->s.size -= nunits;
    1348:	4137073b          	subw	a4,a4,s3
    134c:	c798                	sw	a4,8(a5)
        p += p->s.size;
    134e:	1702                	slli	a4,a4,0x20
    1350:	9301                	srli	a4,a4,0x20
    1352:	0712                	slli	a4,a4,0x4
    1354:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1356:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    135a:	00000717          	auipc	a4,0x0
    135e:	36a73723          	sd	a0,878(a4) # 16c8 <freep>
      return (void*)(p + 1);
    1362:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    1366:	70e2                	ld	ra,56(sp)
    1368:	7442                	ld	s0,48(sp)
    136a:	74a2                	ld	s1,40(sp)
    136c:	7902                	ld	s2,32(sp)
    136e:	69e2                	ld	s3,24(sp)
    1370:	6a42                	ld	s4,16(sp)
    1372:	6aa2                	ld	s5,8(sp)
    1374:	6b02                	ld	s6,0(sp)
    1376:	6121                	addi	sp,sp,64
    1378:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    137a:	6398                	ld	a4,0(a5)
    137c:	e118                	sd	a4,0(a0)
    137e:	bff1                	j	135a <malloc+0x86>
  hp->s.size = nu;
    1380:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1384:	0541                	addi	a0,a0,16
    1386:	00000097          	auipc	ra,0x0
    138a:	ec6080e7          	jalr	-314(ra) # 124c <free>
  return freep;
    138e:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1392:	d971                	beqz	a0,1366 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1394:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1396:	4798                	lw	a4,8(a5)
    1398:	fa9776e3          	bgeu	a4,s1,1344 <malloc+0x70>
    if(p == freep)
    139c:	00093703          	ld	a4,0(s2)
    13a0:	853e                	mv	a0,a5
    13a2:	fef719e3          	bne	a4,a5,1394 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    13a6:	8552                	mv	a0,s4
    13a8:	00000097          	auipc	ra,0x0
    13ac:	b46080e7          	jalr	-1210(ra) # eee <sbrk>
  if(p == (char*)-1)
    13b0:	fd5518e3          	bne	a0,s5,1380 <malloc+0xac>
        return 0;
    13b4:	4501                	li	a0,0
    13b6:	bf45                	j	1366 <malloc+0x92>
