...
000000000000011a <grep>:
{
 ...
 144:	998b0b13          	addi	s6,s6,-1640 # ad8 <buf>
    p = buf;
 148:	8d5a                	mv	s10,s6
        *q = '\n';
 14a:	4aa9                	li	s5,10
...
00000000000001ee <main>:
{
 ...
 262:	81a58593          	addi	a1,a1,-2022 # a78 <malloc+0xe6>
 266:	4509                	li	a0,2
 268:	00000097          	auipc	ra,0x0
 26c:	63e080e7          	jalr	1598(ra) # 8a6 <fprintf>
    exit(1);
 270:	4505                	li	a0,1
 ...
 298:	80450513          	addi	a0,a0,-2044 # a98 <malloc+0x106>
 29c:	00000097          	auipc	ra,0x0
 2a0:	638080e7          	jalr	1592(ra) # 8d4 <printf>
      exit(1);
 2a4:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 630:	0805c863          	bltz	a1,6c0 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 644:	47850513          	addi	a0,a0,1144 # ab8 <digits>
 648:	883a                	mv	a6,a4
 ...
 668:	fec7f0e3          	bgeu	a5,a2,648 <printint+0x2a>
  if(neg)
 66c:	00088b63          	beqz	a7,682 <printint+0x64>
    buf[i++] = '-';
 670:	fd040793          	addi	a5,s0,-48
 674:	973e                	add	a4,a4,a5
 676:	02d00793          	li	a5,45
 67a:	fef70823          	sb	a5,-16(a4)
 67e:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
 682:	02e05863          	blez	a4,6b2 <printint+0x94>
 686:	fc040793          	addi	a5,s0,-64
 68a:	00e78933          	add	s2,a5,a4
 68e:	fff78993          	addi	s3,a5,-1
 ...
 6a8:	f58080e7          	jalr	-168(ra) # 5fc <putc>
  while(--i >= 0)
 6ac:	197d                	addi	s2,s2,-1
 6ae:	ff3918e3          	bne	s2,s3,69e <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ea:	18090f63          	beqz	s2,888 <vprintf+0x1c0>
 6ee:	8aaa                	mv	s5,a0
 6f0:	8b32                	mv	s6,a2
 ...
 704:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
 708:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 70c:	00000b97          	auipc	s7,0x0
 710:	3acb8b93          	addi	s7,s7,940 # ab8 <digits>
 714:	a839                	j	732 <vprintf+0x6a>
        putc(fd, c);
 716:	85ca                	mv	a1,s2
 718:	8556                	mv	a0,s5
 71a:	00000097          	auipc	ra,0x0
 71e:	ee2080e7          	jalr	-286(ra) # 5fc <putc>
 722:	a019                	j	728 <vprintf+0x60>
    } else if(state == '%'){
 724:	01498f63          	beq	s3,s4,742 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 728:	0485                	addi	s1,s1,1
 72a:	fff4c903          	lbu	s2,-1(s1)
 72e:	14090d63          	beqz	s2,888 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
 732:	0009079b          	sext.w	a5,s2
    if(state == 0){
 736:	fe0997e3          	bnez	s3,724 <vprintf+0x5c>
      if(c == '%'){
 73a:	fd479ee3          	bne	a5,s4,716 <vprintf+0x4e>
        state = '%';
 73e:	89be                	mv	s3,a5
 740:	b7e5                	j	728 <vprintf+0x60>
      if(c == 'd'){
 742:	05878063          	beq	a5,s8,782 <vprintf+0xba>
      } else if(c == 'l') {
 746:	05978c63          	beq	a5,s9,79e <vprintf+0xd6>
      } else if(c == 'x') {
 74a:	07a78863          	beq	a5,s10,7ba <vprintf+0xf2>
      } else if(c == 'p') {
 74e:	09b78463          	beq	a5,s11,7d6 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
 752:	07300713          	li	a4,115
 756:	0ce78663          	beq	a5,a4,822 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 75e:	0ee78e63          	beq	a5,a4,85a <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
 762:	11478863          	beq	a5,s4,872 <vprintf+0x1aa>
        putc(fd, c);
      } else {
 ...
 76e:	e92080e7          	jalr	-366(ra) # 5fc <putc>
        putc(fd, c);
 772:	85ca                	mv	a1,s2
 774:	8556                	mv	a0,s5
 776:	00000097          	auipc	ra,0x0
 77a:	e86080e7          	jalr	-378(ra) # 5fc <putc>
      }
      state = 0;
 77e:	4981                	li	s3,0
 780:	b765                	j	728 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
 ...
 794:	e8e080e7          	jalr	-370(ra) # 61e <printint>
 798:	8b4a                	mv	s6,s2
      state = 0;
 79a:	4981                	li	s3,0
 79c:	b771                	j	728 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 7b0:	e72080e7          	jalr	-398(ra) # 61e <printint>
 7b4:	8b4a                	mv	s6,s2
      state = 0;
 7b6:	4981                	li	s3,0
 7b8:	bf85                	j	728 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
 ...
 7cc:	e56080e7          	jalr	-426(ra) # 61e <printint>
 7d0:	8b4a                	mv	s6,s2
      state = 0;
 7d2:	4981                	li	s3,0
 7d4:	bf91                	j	728 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
 ...
 7ec:	e14080e7          	jalr	-492(ra) # 5fc <putc>
  putc(fd, 'x');
 7f0:	85ea                	mv	a1,s10
 7f2:	8556                	mv	a0,s5
 7f4:	00000097          	auipc	ra,0x0
 7f8:	e08080e7          	jalr	-504(ra) # 5fc <putc>
 7fc:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 80e:	df2080e7          	jalr	-526(ra) # 5fc <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 812:	0992                	slli	s3,s3,0x4
 814:	397d                	addiw	s2,s2,-1
 816:	fe0914e3          	bnez	s2,7fe <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
 81a:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 81e:	4981                	li	s3,0
 820:	b721                	j	728 <vprintf+0x60>
        s = va_arg(ap, char*);
 822:	008b0993          	addi	s3,s6,8
 826:	000b3903          	ld	s2,0(s6)
        if(s == 0)
 82a:	02090163          	beqz	s2,84c <vprintf+0x184>
        while(*s != 0){
 82e:	00094583          	lbu	a1,0(s2)
 832:	c9a1                	beqz	a1,882 <vprintf+0x1ba>
          putc(fd, *s);
 834:	8556                	mv	a0,s5
 836:	00000097          	auipc	ra,0x0
 83a:	dc6080e7          	jalr	-570(ra) # 5fc <putc>
          s++;
 83e:	0905                	addi	s2,s2,1
        while(*s != 0){
 840:	00094583          	lbu	a1,0(s2)
 844:	f9e5                	bnez	a1,834 <vprintf+0x16c>
        s = va_arg(ap, char*);
 846:	8b4e                	mv	s6,s3
      state = 0;
 848:	4981                	li	s3,0
 84a:	bdf9                	j	728 <vprintf+0x60>
          s = "(null)";
 84c:	00000917          	auipc	s2,0x0
 850:	26490913          	addi	s2,s2,612 # ab0 <malloc+0x11e>
        while(*s != 0){
 854:	02800593          	li	a1,40
 858:	bff1                	j	834 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
 85a:	008b0913          	addi	s2,s6,8
 85e:	000b4583          	lbu	a1,0(s6)
 862:	8556                	mv	a0,s5
 864:	00000097          	auipc	ra,0x0
 868:	d98080e7          	jalr	-616(ra) # 5fc <putc>
 86c:	8b4a                	mv	s6,s2
      state = 0;
 86e:	4981                	li	s3,0
 870:	bd65                	j	728 <vprintf+0x60>
        putc(fd, c);
 872:	85d2                	mv	a1,s4
 874:	8556                	mv	a0,s5
 876:	00000097          	auipc	ra,0x0
 87a:	d86080e7          	jalr	-634(ra) # 5fc <putc>
      state = 0;
 87e:	4981                	li	s3,0
 880:	b565                	j	728 <vprintf+0x60>
        s = va_arg(ap, char*);
 882:	8b4e                	mv	s6,s3
      state = 0;
 884:	4981                	li	s3,0
 886:	b54d                	j	728 <vprintf+0x60>
    }
  }
}
 888:	70e6                	ld	ra,120(sp)
 88a:	7446                	ld	s0,112(sp)
 88c:	74a6                	ld	s1,104(sp)
 88e:	7906                	ld	s2,96(sp)
 890:	69e6                	ld	s3,88(sp)
 892:	6a46                	ld	s4,80(sp)
 894:	6aa6                	ld	s5,72(sp)
 896:	6b06                	ld	s6,64(sp)
 898:	7be2                	ld	s7,56(sp)
 89a:	7c42                	ld	s8,48(sp)
 89c:	7ca2                	ld	s9,40(sp)
 89e:	7d02                	ld	s10,32(sp)
 8a0:	6de2                	ld	s11,24(sp)
 8a2:	6109                	addi	sp,sp,128
 8a4:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 8c8:	e04080e7          	jalr	-508(ra) # 6c8 <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 8fe:	dce080e7          	jalr	-562(ra) # 6c8 <vprintf>
}
...
free(void *ap)
{
 ...
 918:	1bc7b783          	ld	a5,444(a5) # ad0 <freep>
 ...
 946:	00e6ea63          	bltu	a3,a4,95a <free+0x50>
{
 ...
 988:	14f73623          	sd	a5,332(a4) # ad0 <freep>
}
 98c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9ba:	11a53503          	ld	a0,282(a0) # ad0 <freep>
 ...
 9e2:	0f290913          	addi	s2,s2,242 # ad0 <freep>
  if(p == (char*)-1)
 9e6:	5afd                	li	s5,-1
 ...
 9f6:	0cf73f23          	sd	a5,222(a4) # ad0 <freep>
 9fa:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a1c:	0aa73c23          	sd	a0,184(a4) # ad0 <freep>
      return (void*)(p + 1);
 ...
 a6a:	b46080e7          	jalr	-1210(ra) # 5ac <sbrk>
  if(p == (char*)-1)
