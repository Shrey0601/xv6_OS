...
fmtname(char *path)
{
  ...
  6a:	ad298993          	addi	s3,s3,-1326 # b38 <buf.1125>
...
ls(char *path)
{
 ...
 130:	7ce080e7          	jalr	1998(ra) # 8fa <printf>
      }
 ...
 170:	760080e7          	jalr	1888(ra) # 8cc <fprintf>
    return;
 ...
 186:	74a080e7          	jalr	1866(ra) # 8cc <fprintf>
    close(fd);
 18a:	8526                	mv	a0,s1
 ...
 1f4:	908a0a13          	addi	s4,s4,-1784 # af8 <malloc+0x140>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	8c0a8a93          	addi	s5,s5,-1856 # ab8 <malloc+0x100>
 ...
 20c:	6f2080e7          	jalr	1778(ra) # 8fa <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 210:	4641                	li	a2,16
 ...
 274:	68a080e7          	jalr	1674(ra) # 8fa <printf>
...
main(int argc, char *argv[])
{
 ...
 2be:	84e50513          	addi	a0,a0,-1970 # b08 <malloc+0x150>
...
free(void *ap)
{
 ...
 93e:	1f67b783          	ld	a5,502(a5) # b30 <freep>
 ...
 96c:	00e6ea63          	bltu	a3,a4,980 <free+0x50>
{
 ...
 9ae:	18f73323          	sd	a5,390(a4) # b30 <freep>
}
 9b2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9e0:	15453503          	ld	a0,340(a0) # b30 <freep>
 ...
 a08:	12c90913          	addi	s2,s2,300 # b30 <freep>
  if(p == (char*)-1)
 a0c:	5afd                	li	s5,-1
 a0e:	a88d                	j	a80 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a10:	00000797          	auipc	a5,0x0
 a14:	13878793          	addi	a5,a5,312 # b48 <base>
 a18:	00000717          	auipc	a4,0x0
 a1c:	10f73c23          	sd	a5,280(a4) # b30 <freep>
 a20:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a42:	0ea73923          	sd	a0,242(a4) # b30 <freep>
      return (void*)(p + 1);
