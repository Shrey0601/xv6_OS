...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	31058593          	addi	a1,a1,784 # 1320 <malloc+0xe8>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2ca58593          	addi	a1,a1,714 # 1328 <malloc+0xf0>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	29850513          	addi	a0,a0,664 # 1330 <malloc+0xf8>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	36c70713          	addi	a4,a4,876 # 1430 <malloc+0x1f8>
    ...
    panic("runcmd");
      ...
      e2:	25a50513          	addi	a0,a0,602 # 1338 <malloc+0x100>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	24058593          	addi	a1,a1,576 # 1340 <malloc+0x108>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	20458593          	addi	a1,a1,516 # 1350 <malloc+0x118>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	17e50513          	addi	a0,a0,382 # 1360 <malloc+0x128>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	fb4080e7          	jalr	-76(ra) # 1238 <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	f6a080e7          	jalr	-150(ra) # 1238 <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	f10080e7          	jalr	-240(ra) # 1238 <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	eca080e7          	jalr	-310(ra) # 1238 <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	e88080e7          	jalr	-376(ra) # 1238 <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	08e98993          	addi	s3,s3,142 # 1488 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	02a98993          	addi	s3,s3,42 # 1488 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	fc098993          	addi	s3,s3,-64 # 1488 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	fb0a8a93          	addi	s5,s5,-80 # 1480 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	f5698993          	addi	s3,s3,-170 # 1488 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	de6b8b93          	addi	s7,s7,-538 # 1388 <malloc+0x150>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	db450513          	addi	a0,a0,-588 # 1368 <malloc+0x130>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	cf460613          	addi	a2,a2,-780 # 1390 <malloc+0x158>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	ce4b0b13          	addi	s6,s6,-796 # 13b0 <malloc+0x178>
  ...
  return ret;
     ...
     70a:	c9250513          	addi	a0,a0,-878 # 1398 <malloc+0x160>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c3850513          	addi	a0,a0,-968 # 13a0 <malloc+0x168>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c1660613          	addi	a2,a2,-1002 # 13b8 <malloc+0x180>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	baea0a13          	addi	s4,s4,-1106 # 13c0 <malloc+0x188>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	b8060613          	addi	a2,a2,-1152 # 13c8 <malloc+0x190>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	ae260613          	addi	a2,a2,-1310 # 1390 <malloc+0x158>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b0260613          	addi	a2,a2,-1278 # 13e0 <malloc+0x1a8>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	ab050513          	addi	a0,a0,-1360 # 13d0 <malloc+0x198>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	ab850513          	addi	a0,a0,-1352 # 13e8 <malloc+0x1b0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	aec70713          	addi	a4,a4,-1300 # 1448 <malloc+0x210>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	9f860613          	addi	a2,a2,-1544 # 1400 <malloc+0x1c8>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	9ca58593          	addi	a1,a1,-1590 # 1408 <malloc+0x1d0>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	704080e7          	jalr	1796(ra) # 114c <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	94850513          	addi	a0,a0,-1720 # 1398 <malloc+0x160>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9a648493          	addi	s1,s1,-1626 # 1418 <malloc+0x1e0>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a0048493          	addi	s1,s1,-1536 # 1498 <buf.1151>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9f3a0a13          	addi	s4,s4,-1549 # 149b <buf.1151+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	970a8a93          	addi	s5,s5,-1680 # 1420 <malloc+0x1e8>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2c:	624080e7          	jalr	1572(ra) # 114c <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	96650513          	addi	a0,a0,-1690 # 1498 <buf.1151>
...
putc(int fd, char c)
{
     ...
     ea4:	ec06                	sd	ra,24(sp)
     ea6:	e822                	sd	s0,16(sp)
     ea8:	1000                	addi	s0,sp,32
     eaa:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     eae:	4605                	li	a2,1
     eb0:	fef40593          	addi	a1,s0,-17
     eb4:	00000097          	auipc	ra,0x0
     eb8:	f36080e7          	jalr	-202(ra) # dea <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     ed4:	c299                	beqz	a3,eda <printint+0x16>
     ed6:	0805c863          	bltz	a1,f66 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     eda:	2581                	sext.w	a1,a1
  neg = 0;
     edc:	4881                	li	a7,0
     ede:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ee4:	2601                	sext.w	a2,a2
     ee6:	00000517          	auipc	a0,0x0
     eea:	58250513          	addi	a0,a0,1410 # 1468 <digits>
     eee:	883a                	mv	a6,a4
     ef0:	2705                	addiw	a4,a4,1
     ef2:	02c5f7bb          	remuw	a5,a1,a2
     ef6:	1782                	slli	a5,a5,0x20
     ef8:	9381                	srli	a5,a5,0x20
     efa:	97aa                	add	a5,a5,a0
     efc:	0007c783          	lbu	a5,0(a5)
     f00:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     f04:	0005879b          	sext.w	a5,a1
     f08:	02c5d5bb          	divuw	a1,a1,a2
     f0c:	0685                	addi	a3,a3,1
     f0e:	fec7f0e3          	bgeu	a5,a2,eee <printint+0x2a>
  if(neg)
     f12:	00088b63          	beqz	a7,f28 <printint+0x64>
    buf[i++] = '-';
     f16:	fd040793          	addi	a5,s0,-48
     f1a:	973e                	add	a4,a4,a5
     f1c:	02d00793          	li	a5,45
     f20:	fef70823          	sb	a5,-16(a4)
     f24:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     f28:	02e05863          	blez	a4,f58 <printint+0x94>
    ...
    putc(fd, buf[i]);
     ...
     f4e:	f58080e7          	jalr	-168(ra) # ea2 <putc>
  while(--i >= 0)
     f52:	197d                	addi	s2,s2,-1
     f54:	ff3918e3          	bne	s2,s3,f44 <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     f9e:	02500a13          	li	s4,37
      if(c == 'd'){
     fa2:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
     fa6:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
     faa:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
     fae:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fb2:	00000b97          	auipc	s7,0x0
     fb6:	4b6b8b93          	addi	s7,s7,1206 # 1468 <digits>
     fba:	a839                	j	fd8 <vprintf+0x6a>
        putc(fd, c);
     fbc:	85ca                	mv	a1,s2
     fbe:	8556                	mv	a0,s5
     fc0:	00000097          	auipc	ra,0x0
     fc4:	ee2080e7          	jalr	-286(ra) # ea2 <putc>
     fc8:	a019                	j	fce <vprintf+0x60>
    } else if(state == '%'){
     fca:	01498f63          	beq	s3,s4,fe8 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     fce:	0485                	addi	s1,s1,1
     fd0:	fff4c903          	lbu	s2,-1(s1)
     fd4:	14090d63          	beqz	s2,112e <vprintf+0x1c0>
    c = fmt[i] & 0xff;
     fd8:	0009079b          	sext.w	a5,s2
    if(state == 0){
     fdc:	fe0997e3          	bnez	s3,fca <vprintf+0x5c>
      if(c == '%'){
     fe0:	fd479ee3          	bne	a5,s4,fbc <vprintf+0x4e>
        state = '%';
     fe4:	89be                	mv	s3,a5
     fe6:	b7e5                	j	fce <vprintf+0x60>
      if(c == 'd'){
     fe8:	05878063          	beq	a5,s8,1028 <vprintf+0xba>
      } else if(c == 'l') {
     fec:	05978c63          	beq	a5,s9,1044 <vprintf+0xd6>
      } else if(c == 'x') {
     ff0:	07a78863          	beq	a5,s10,1060 <vprintf+0xf2>
      } else if(c == 'p') {
     ff4:	09b78463          	beq	a5,s11,107c <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
     ff8:	07300713          	li	a4,115
     ffc:	0ce78663          	beq	a5,a4,10c8 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1000:	06300713          	li	a4,99
    1004:	0ee78e63          	beq	a5,a4,1100 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    1008:	11478863          	beq	a5,s4,1118 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    1014:	e92080e7          	jalr	-366(ra) # ea2 <putc>
        putc(fd, c);
    1018:	85ca                	mv	a1,s2
    101a:	8556                	mv	a0,s5
    101c:	00000097          	auipc	ra,0x0
    1020:	e86080e7          	jalr	-378(ra) # ea2 <putc>
      }
      state = 0;
    1024:	4981                	li	s3,0
    ...
    103a:	e8e080e7          	jalr	-370(ra) # ec4 <printint>
    103e:	8b4a                	mv	s6,s2
      state = 0;
    1040:	4981                	li	s3,0
    ...
    1056:	e72080e7          	jalr	-398(ra) # ec4 <printint>
    105a:	8b4a                	mv	s6,s2
      state = 0;
    105c:	4981                	li	s3,0
    ...
    1072:	e56080e7          	jalr	-426(ra) # ec4 <printint>
    1076:	8b4a                	mv	s6,s2
      state = 0;
    1078:	4981                	li	s3,0
    107a:	bf91                	j	fce <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    107c:	008b0793          	addi	a5,s6,8
    1080:	f8f43423          	sd	a5,-120(s0)
    1084:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    1088:	03000593          	li	a1,48
    108c:	8556                	mv	a0,s5
    108e:	00000097          	auipc	ra,0x0
    1092:	e14080e7          	jalr	-492(ra) # ea2 <putc>
  putc(fd, 'x');
    1096:	85ea                	mv	a1,s10
    1098:	8556                	mv	a0,s5
    109a:	00000097          	auipc	ra,0x0
    109e:	e08080e7          	jalr	-504(ra) # ea2 <putc>
    10a2:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    10a4:	03c9d793          	srli	a5,s3,0x3c
    10a8:	97de                	add	a5,a5,s7
    10aa:	0007c583          	lbu	a1,0(a5)
    10ae:	8556                	mv	a0,s5
    10b0:	00000097          	auipc	ra,0x0
    10b4:	df2080e7          	jalr	-526(ra) # ea2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10b8:	0992                	slli	s3,s3,0x4
    10ba:	397d                	addiw	s2,s2,-1
    10bc:	fe0914e3          	bnez	s2,10a4 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10c0:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10c4:	4981                	li	s3,0
    10c6:	b721                	j	fce <vprintf+0x60>
        s = va_arg(ap, char*);
    10c8:	008b0993          	addi	s3,s6,8
    10cc:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    10d0:	02090163          	beqz	s2,10f2 <vprintf+0x184>
        while(*s != 0){
    10d4:	00094583          	lbu	a1,0(s2)
    10d8:	c9a1                	beqz	a1,1128 <vprintf+0x1ba>
          putc(fd, *s);
    10da:	8556                	mv	a0,s5
    10dc:	00000097          	auipc	ra,0x0
    10e0:	dc6080e7          	jalr	-570(ra) # ea2 <putc>
          s++;
    10e4:	0905                	addi	s2,s2,1
        while(*s != 0){
    10e6:	00094583          	lbu	a1,0(s2)
    10ea:	f9e5                	bnez	a1,10da <vprintf+0x16c>
        s = va_arg(ap, char*);
    10ec:	8b4e                	mv	s6,s3
      state = 0;
    10ee:	4981                	li	s3,0
    10f0:	bdf9                	j	fce <vprintf+0x60>
          s = "(null)";
    10f2:	00000917          	auipc	s2,0x0
    10f6:	36e90913          	addi	s2,s2,878 # 1460 <malloc+0x228>
        while(*s != 0){
    10fa:	02800593          	li	a1,40
    10fe:	bff1                	j	10da <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    1100:	008b0913          	addi	s2,s6,8
    1104:	000b4583          	lbu	a1,0(s6)
    1108:	8556                	mv	a0,s5
    110a:	00000097          	auipc	ra,0x0
    110e:	d98080e7          	jalr	-616(ra) # ea2 <putc>
    1112:	8b4a                	mv	s6,s2
      state = 0;
    1114:	4981                	li	s3,0
    1116:	bd65                	j	fce <vprintf+0x60>
        putc(fd, c);
    1118:	85d2                	mv	a1,s4
    111a:	8556                	mv	a0,s5
    111c:	00000097          	auipc	ra,0x0
    1120:	d86080e7          	jalr	-634(ra) # ea2 <putc>
      state = 0;
    1124:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11be:	2d67b783          	ld	a5,726(a5) # 1490 <freep>
    11c2:	a805                	j	11f2 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11c4:	4618                	lw	a4,8(a2)
    11c6:	9db9                	addw	a1,a1,a4
    11c8:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11cc:	6398                	ld	a4,0(a5)
    11ce:	6318                	ld	a4,0(a4)
    11d0:	fee53823          	sd	a4,-16(a0)
    11d4:	a091                	j	1218 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    11d6:	ff852703          	lw	a4,-8(a0)
    11da:	9e39                	addw	a2,a2,a4
    11dc:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    11de:	ff053703          	ld	a4,-16(a0)
    11e2:	e398                	sd	a4,0(a5)
    11e4:	a099                	j	122a <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11e6:	6398                	ld	a4,0(a5)
    11e8:	00e7e463          	bltu	a5,a4,11f0 <free+0x40>
    11ec:	00e6ea63          	bltu	a3,a4,1200 <free+0x50>
{
    11f0:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11f2:	fed7fae3          	bgeu	a5,a3,11e6 <free+0x36>
    11f6:	6398                	ld	a4,0(a5)
    11f8:	00e6e463          	bltu	a3,a4,1200 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11fc:	fee7eae3          	bltu	a5,a4,11f0 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    1200:	ff852583          	lw	a1,-8(a0)
    1204:	6390                	ld	a2,0(a5)
    1206:	02059713          	slli	a4,a1,0x20
    120a:	9301                	srli	a4,a4,0x20
    120c:	0712                	slli	a4,a4,0x4
    120e:	9736                	add	a4,a4,a3
    1210:	fae60ae3          	beq	a2,a4,11c4 <free+0x14>
    bp->s.ptr = p->s.ptr;
    1214:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1218:	4790                	lw	a2,8(a5)
    121a:	02061713          	slli	a4,a2,0x20
    121e:	9301                	srli	a4,a4,0x20
    1220:	0712                	slli	a4,a4,0x4
    1222:	973e                	add	a4,a4,a5
    1224:	fae689e3          	beq	a3,a4,11d6 <free+0x26>
  } else
    p->s.ptr = bp;
    1228:	e394                	sd	a3,0(a5)
  freep = p;
    122a:	00000717          	auipc	a4,0x0
    122e:	26f73323          	sd	a5,614(a4) # 1490 <freep>
}
...
malloc(uint nbytes)
{
    ...
    1244:	e852                	sd	s4,16(sp)
    1246:	e456                	sd	s5,8(sp)
    1248:	e05a                	sd	s6,0(sp)
  ...
  if((prevp = freep) == 0){
    ...
    1260:	23453503          	ld	a0,564(a0) # 1490 <freep>
    1264:	c515                	beqz	a0,1290 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    126a:	02977f63          	bgeu	a4,s1,12a8 <malloc+0x70>
    126e:	8a4e                	mv	s4,s3
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1284:	00000917          	auipc	s2,0x0
    1288:	20c90913          	addi	s2,s2,524 # 1490 <freep>
  if(p == (char*)-1)
    128c:	5afd                	li	s5,-1
    128e:	a88d                	j	1300 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1290:	00000797          	auipc	a5,0x0
    1294:	27078793          	addi	a5,a5,624 # 1500 <base>
    1298:	00000717          	auipc	a4,0x0
    129c:	1ef73c23          	sd	a5,504(a4) # 1490 <freep>
    12a0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12a2:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12a6:	b7e1                	j	126e <malloc+0x36>
      if(p->s.size == nunits)
    12a8:	02e48b63          	beq	s1,a4,12de <malloc+0xa6>
        p->s.size -= nunits;
    12ac:	4137073b          	subw	a4,a4,s3
    12b0:	c798                	sw	a4,8(a5)
        p += p->s.size;
    ...
    12c2:	1ca73923          	sd	a0,466(a4) # 1490 <freep>
      return (void*)(p + 1);
    ...
    12ce:	74a2                	ld	s1,40(sp)
    12d0:	7902                	ld	s2,32(sp)
    12d2:	69e2                	ld	s3,24(sp)
    12d4:	6a42                	ld	s4,16(sp)
    12d6:	6aa2                	ld	s5,8(sp)
    12d8:	6b02                	ld	s6,0(sp)
    12da:	6121                	addi	sp,sp,64
    12dc:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    12de:	6398                	ld	a4,0(a5)
    12e0:	e118                	sd	a4,0(a0)
    12e2:	bff1                	j	12be <malloc+0x86>
  hp->s.size = nu;
    12e4:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12e8:	0541                	addi	a0,a0,16
    12ea:	00000097          	auipc	ra,0x0
    12ee:	ec6080e7          	jalr	-314(ra) # 11b0 <free>
  return freep;
    12f2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12f6:	d971                	beqz	a0,12ca <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12f8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12fa:	4798                	lw	a4,8(a5)
    12fc:	fa9776e3          	bgeu	a4,s1,12a8 <malloc+0x70>
    if(p == freep)
    1300:	00093703          	ld	a4,0(s2)
    1304:	853e                	mv	a0,a5
    1306:	fef719e3          	bne	a4,a5,12f8 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    130a:	8552                	mv	a0,s4
    130c:	00000097          	auipc	ra,0x0
    1310:	b46080e7          	jalr	-1210(ra) # e52 <sbrk>
  if(p == (char*)-1)
    1314:	fd5518e3          	bne	a0,s5,12e4 <malloc+0xac>
        return 0;
    1318:	4501                	li	a0,0
    131a:	bf45                	j	12ca <malloc+0x92>
