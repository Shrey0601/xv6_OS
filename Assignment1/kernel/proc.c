...
pinfo(int pid, uint64 pst){
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    // printf("state=%s ", state);
    // printf("cmd=%s", p->name);
    // printf("ctime=%l", p->ctime);
    // printf("stime=%l", p->stime);
    if(p->stime!=p->etime)
    {
    // printf("etime=%l", p->name);
    pstat->etime = p->etime;
    }
    else{
      uint xticks;
    ...
    pstat->size = p->sz;
/////////////////////////////////////////////////////////////////////////
    // printf("pid=%d ", pstat->pid);
    // printf("state=%s ", state);
    // printf("cmd=%s ", pstat->command);
    // printf("ctime=%d ", pstat->ctime);
    // printf("stime=%d ", pstat->stime);
    // if(p->stime!=p->etime)
    // {
    // printf("etime=%d ", pstat->etime);
    // }
    // else{
    //   uint xticks;
    ...
    //   xticks = ticks;
    //  release(&tickslock);
    //   printf("etime=%d ", xticks - pstat->stime);
    // }
